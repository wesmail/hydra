...
//-Modified for clearing : 05/12/98 D.B
...
TIterator *HCategorySplit::MakeIterator(Bool_t dir) {
  //see HCategory
...
TObject *&HCategorySplit::getNewSlot(HLocation &aLoc) {
  //see HCategory
  Int_t la,i;
  TClonesArray *table;
  la=aLoc[0];
...
TObject *&HCategorySplit::getSlot(HLocation &aLoc) {
  //see HCategory
  Int_t la,i;
  TClonesArray *table;
  la=aLoc[0];
