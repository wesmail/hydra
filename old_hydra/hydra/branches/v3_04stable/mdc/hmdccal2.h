...
class HMdcCal2 : public HDataObject {
protected:
  Int_t nHits;      // number of hits in this cell
  Float_t dist1;    // distance to the wire of first hit
  Float_t dist2;    // distance to the wire of second hit
  Float_t errDist1; // error of distance for first hit
  Float_t errDist2; // error of distance for second hit
