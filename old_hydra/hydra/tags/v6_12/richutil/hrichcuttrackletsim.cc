// $Id: hrichcuttrackletsim.cc,v 1.3 2003-04-04 13:13:47 eberl Exp $
// Last update by Thomas Eberl: 03/03/10 13:27:58
//
...
Bool_t HRichCutTrackletSim::switchTo(const char *s,Bool_t clear)
{
    TString state(s);
