...
inline Float_t HRichLocalMaxCal::sumcharge(Int_t nRow, Int_t nCol, Int_t nSector) {
...
inline Bool_t HRichLocalMaxCal::checkIsolation(Int_t nRow, Int_t nCol, Int_t nSector,Int_t padNum) {
