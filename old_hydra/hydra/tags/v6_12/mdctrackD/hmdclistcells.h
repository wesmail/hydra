...
inline Bool_t HMdcListCells::test(Int_t cell) const { 
...
Int_t HMdcListCells::getCell(Int_t idx) const {
  return HMdcTBArray::position(arr,arr+AEND,idx);
}

Int_t HMdcListCells::getFirstCell(void) const {
  return HMdcTBArray::first(arr,arr+AEND);
} 

Int_t HMdcListCells::getLastCell(void) const {
  return HMdcTBArray::last(arr,arr+AEND);
}

Int_t HMdcListCells::next(Int_t prCell) const {
  return HMdcTBArray::next(arr,arr+AEND,prCell);
}

Int_t HMdcListCells::previous(Int_t prCell) const {
  return HMdcTBArray::previous(arr,arr+AEND,prCell);
}


UChar_t HMdcListCells::getTime(Int_t cell) const {
