...
#define PID_NTUPLE_VARS_25 "p_n_lepton_candidates:p_mdc_combined_dedx:p_mdc_combined_dedxsigma"
...
class HPidPerformaceTest : public HSUDummyRec{
    ...
    private:
	  ...
	  p_n_lepton_candidates,p_mdc_combined_dedx,p_mdc_combined_dedxsigma
        };
