//@(#)$Id: draw3Sim.C,v 1.2 2003-03-05 14:36:57 jaskula Exp $
...
int iSysMax = 1;
    ...
    strcpy(sDraw, "HPidParticleSimExt.fData.P()*HPidParticleSimExt.fData.charge()"
    ":HPidParticleSimExt.fData.getBetaExp()"
    ":((HPidParticleSimExt.fData.nPid%20)+20*HPidParticleSimExt.fData.getSystem())"
    ">>h3");
