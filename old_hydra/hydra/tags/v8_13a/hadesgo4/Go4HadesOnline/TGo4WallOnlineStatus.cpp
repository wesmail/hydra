...
TGo4WallOnlineStatus::TGo4WallOnlineStatus(Text_t *Name, Text_t * Title)
			:TGo4Status(Name)
{
	...
	TGo4WallOnlineStatus::~TGo4WallOnlineStatus()
{

}
TObject* TGo4WallOnlineStatus::OverWriteLocalObject(TNamed * fxData_Local)
{
 	TGo4LockGuard Global;
...
TObjArray *TGo4WallOnlineStatus::GetLocalListStatus()
{
  	TGo4LockGuard Global;	
  	return(LocalListContent);
}

TObject* TGo4WallOnlineStatus::GetObjectfromLocalList(const char *Object)
{
  	TGo4LockGuard Global;
  	return(LocalListContent->FindObject(Object));
	
}
ClassImp(TGo4WallOnlineStatus)
