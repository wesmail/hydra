...
Bool_t analysisDSTLowField(TString inputFile,Int_t nEvents=0,Int_t startEvt =0) {
...
//---------------  Set batch (needed for TCanvas's) ------------------
  ...
  TString outDirQA    = "/u/hadesdst/web-docs/nov01/lowfieldgen2/";
//---------------  Parameter input file for real data ----------------
  TString rootParFile1 = "/u/hadesdst/nov01/gen2/params/align_nov01_pre2.root";
  TString rootParFile2 = "/u/hadesdst/nov01/gen2/params/allParamTest341LowField.root";
...
//------------ Do not write these categories to the Tree -------------
  ...
  Cat_t notPersistentCat[20] = {
       ...
       catMdcRaw, catShowerRaw, catStartRaw, catTofRaw, catTofinoRaw
        ,catMdcCal1,catMdcCal2,catShowerCal
...
// ----- See the html documentation for the H***TaskSet options ------
  ...
  HTask *richTasks   = HRichTaskSet::make("real","",kTRUE);
  ...
  HTask *mdcTasks    = HMdcTaskSet::make("","nostartandcal,magneton,dubna,chamberclusters");//read cal parameters from file
