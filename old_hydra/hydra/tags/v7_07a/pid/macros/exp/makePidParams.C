int makePidParams()
{
  TFile *f = new TFile("/net/disk14/otwinow/hydra_nov02/params/pid/pidParams_RichTofShowerTofino_Nov02.root");
  f->cd();
  HPidHistogramsCont *pRichPar = (HPidHistogramsCont*)f->Get("richpar");
  HPidHistogramsCont *pBetaPar = (HPidHistogramsCont*)f->Get("betaexp");
  HPidHistogramsCont *pShowerPar = (HPidHistogramsCont*)f->Get("showsim");
  f->Close();

  // input and output data files
  TString outParFile = "/net/disk14/otwinow/hydra_dev/params/pidParams_HardCuts_Nov02.root"; 
