...
//
// This function displays highlighted histogram.
//
//---------------------------------------------------------------------
...
void HOnlObjBrowser::displayHisto() {
  ...
  if(pHisto->isConditioned() && pHisto->getDim() == 2 && 
  ...
  if(pSet) {
    ...
    if(pHisto->isCount()) {
      addCounterPar(fHiPar1CB);
      if(pHisto->getCountIdx() == 1) highlight(fHiPar1CB,"Count_1");
      if(pHisto->getCountIdx() == 2) highlight(fHiPar1CB,"Count_2");
      if(pHisto->getCountIdx() == 3) highlight(fHiPar1CB,"Count_3");
    }
  ...
  if(pSet && !fHiMulRB->GetState()) {
    ...
    highlight(fHiPar2CB,pHisto->getParameter(2)->GetName());
  }
  else {
    clearCB(fHiDS2CB);
    clearCB(fHiPar2CB);
...
//
// This function displays highlighted local condition.
//
//---------------------------------------------------------------------
...
//
// This function displays highlighted global condition.
//
//---------------------------------------------------------------------
...
// corresponding to the category of the detector set. Used for histogram
// subpanel.
//
//---------------------------------------------------------------------
...
// corresponding to the category of the detector set. Used for local
// conditions subpanel.
//
//---------------------------------------------------------------------
...
//
// This function clears combo box.
//
//---------------------------------------------------------------------
...
//
// This function highlights entry in the combo box.
//
//---------------------------------------------------------------------
...
//
// This function highlights entry in the list box.
//
//---------------------------------------------------------------------
...
void HOnlObjBrowser::controlHiGui(TGFrame *p) {
  ...
  if(p == fHiDS1CB) {
    ...
    if(pEntry) {
      ...
      if(pSet) {
	createParList(fHiPar1CB, pSet);
	if(fHi1dRB->GetState() && fHiLocalRB->GetState()) 
	  addCounterPar(fHiPar1CB);
	fHiFrom1->SetState(kFALSE);
	fHiTo1->SetState(kFALSE);
	fHiChan1->SetState(kFALSE);
  ...
  if(p == fHiPar1CB) {
	...
	fHiChan1->SetState(kTRUE);
      ...
      if(!strcmp("Count_true",pEntry->GetText()->GetString()) ||
	 !strcmp("Count_false",pEntry->GetText()->GetString()) ||
	 !strcmp("Count_sum",pEntry->GetText()->GetString())) {
	fHiFrom1->SetState(kTRUE);
	fHiTo1->SetState(kTRUE);
	fHiChan1->SetState(kTRUE);
      }
...
HHistogram* HOnlObjBrowser::createHisto() {
  ...
  if(pHisto->getDim() == 1) {
	...
	pHisto->setParameter(pPar,1);
      ...
      if(!strcmp(pEntry->GetText()->GetString(),"Count_true")) {
	pHisto->setCount(kTRUE);
	pHisto->setCountIdx(1);
      }
      if(!strcmp(pEntry->GetText()->GetString(),"Count_false")) {
	pHisto->setCount(kTRUE);
	pHisto->setCountIdx(2);
      }
      if(!strcmp(pEntry->GetText()->GetString(),"Count_sum")) {
	pHisto->setCount(kTRUE);
	pHisto->setCountIdx(3);
      }
    }
  }
...
//
// This function extracts det set indicated in fLCDSCB and calculates
// category.
//
//---------------------------------------------------------------------
...
//
// This function creates list fGCListPar.
//
//---------------------------------------------------------------------
...
//
// This function handles GUI widgets in TOF DS subpanel.
//
//---------------------------------------------------------------------
...
//
// This function handles GUI widgets in MDC DS subpanel.
//
//---------------------------------------------------------------------
...
//
// This function handles GUI widgets in SHOWER DS subpanel.
//
//---------------------------------------------------------------------
...
//
// This function creates list of chosen MDC modules.
//
//---------------------------------------------------------------------
...
//
// This function creates list of chosen RICH modules.
//
//---------------------------------------------------------------------
...
//
// This function creates list of chosen SHOWER modules.
//
//---------------------------------------------------------------------
...
//
// This function displays buttons in the subpanel step1.
//
//---------------------------------------------------------------------
...
//
// This function displays buttons in the subpanel step2.
//
//---------------------------------------------------------------------
...
//
// This function displays buttons in the TOF subpanel.
//
//---------------------------------------------------------------------
