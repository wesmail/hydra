...
void HHistoVisual::userDraw() {
  ...
  HHistogram *pHisto = gOnline->getHisto()->at(idx);
  if(!pHisto) return;
...
//
// This function checks if display layout is set. 
//
//---------------------------------------------------------------------
...
//
// This function returns text in the highlighted entry of the combo box.
//
//---------------------------------------------------------------------
...
//
// This function updates list of histogrammes.
//
//---------------------------------------------------------------------
...
//
// This function calculates dimensions (x1,y1,x2,y2) of pad for the histogram
// with idx = index.
//
//---------------------------------------------------------------------
...
//
// This function creates display canvas if necessary.
//
//---------------------------------------------------------------------
...
//
// This function saves to a buffer current drawing options.
//
//---------------------------------------------------------------------
