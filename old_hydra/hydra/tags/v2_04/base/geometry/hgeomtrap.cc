...
HGeomBasicShape* HGeomTrap::calcVoluParam(HGeomVolume* volu) {
  ...
  a=TMath::ATan(((*(volu->getPoint(5)))(0)
               - (*(volu->getPoint(4)))(0)
               + (*(volu->getPoint(6)))(0)
               - (*(volu->getPoint(7)))(0))/40./param->At(3))*raddeg;
...
HGeomBasicShape* HGeomTrap::calcVoluPosition(HGeomVolume* volu,
