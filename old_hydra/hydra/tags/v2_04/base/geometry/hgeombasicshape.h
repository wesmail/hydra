...
public:
  ...
  virtual HGeomBasicShape* calcVoluParam(HGeomVolume*) {return 0;} 
  virtual HGeomBasicShape* calcVoluPosition(HGeomVolume*,
              const HGeomTransform&,const HGeomTransform&) {return 0;}
  void printParam();
protected:
