...
public:
  ...
  void setHit(Float_t ae, Float_t ax, Float_t atof);
  void setAddress (Char_t s, Char_t m, Char_t c);
  inline Int_t getTrack(void) {return trackNumber;}
  void getHit(Float_t& ae, Float_t& ax, Float_t& atof);
  ...
  ClassDef(HGeantTof,1) // Geant TOF event data class
};
