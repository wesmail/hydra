...
public:
  HQAScaler() {;}
  inline HQAScaler(const char *name, const char *title);
  virtual ~HQAScaler() {;}
  ...
  ClassDef(HQAScaler,1) // TObject wrapper for double
};

inline HQAScaler::HQAScaler(const char *name,const char *title)
  : TNamed(name,title) {
...
public:
  HQAScaler6() {;}
  inline HQAScaler6(const char *name, const char *title);
  virtual ~HQAScaler6() {;}
...
inline HQAScaler6::HQAScaler6(const char *name,const char *title)
  : TNamed(name,title) {
