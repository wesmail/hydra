// $Id: hpidsingleleptoneff.cc,v 1.7 2006-11-30 13:36:57 eberl Exp $
...
void HPidSingleLeptonEff::calculateTrackProperties(HPairSim *pair,Float_t& th,Float_t& ph,Float_t& p,Int_t cpF){
  ...
  if(pg.getParentTrackNumber1()==0){
    ...
    // !!! Modification by T. Eberl, 2006-11-08, to adapt to new pid code
    if (!pd.getClosestLepIsFitted2() && pd.getAngleWithClosestLep2()<9.)
    {
	cpF=1; 
    }
    else cpF=0;
