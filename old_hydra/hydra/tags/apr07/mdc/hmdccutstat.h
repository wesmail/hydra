...
protected:
  ...
  Int_t Calibrater1All;     // Cut 6:  all
  Int_t Calibrater1cutAll;  // Cut 7:  cut all
...
protected:
  ...
  HMdcCutStat(const char* name="MdcCutStat",
              const char* title="Statistic  on Cuts on time1, time2 & time2-time1 and wires<4",
              const char* context="",
