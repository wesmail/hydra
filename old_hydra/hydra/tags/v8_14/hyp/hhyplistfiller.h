...
public:
  ...
  // end debugging
	...
	Bool_t is_valid[HYP_MAX_PARTICLES];
...
private:
  ...
  Bool_t				flagDoFilter;		//! switch for "Double track rejection"
  ...
  Bool_t DoFilter(void);// trackcleaner, fill is_valid[PidParticle_index] with true/false
