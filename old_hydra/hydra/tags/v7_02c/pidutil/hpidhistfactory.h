// $Id:
// Last update by Thomas Eberl: 03/02/24 18:28:32
//
#ifndef HPIDHISTFACTORY_H
#define HPIDHISTFACTORY_H
#include <TObject.h>
#include <TObjArray.h>
#include <TCanvas.h>
#include <TH1.h>
#include <TH2.h>
class HPidHistFactory : public TObject {
public:
    ...
    static Char_t* getHMassvsBetaBasename(){return "Mass.vs.Beta_";};
    //
...
private:
    ...
    ClassDef(HPidHistFactory,1)
};

#endif //HPIDHISTFACTORY_H
