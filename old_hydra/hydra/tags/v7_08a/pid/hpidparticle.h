// @(#)$Id: hpidparticle.h,v 1.14 2005-09-21 22:05:59 christ Exp $
...
public:
  ...
  ~HPidParticle(void) {}
    ...
    HPidHitData*    getHitData(void)   const { return getTrackCand()->getHitData();}
    HPidTrackData*  getTrackData(void) const { return getTrackCand()->getTrackData();}
