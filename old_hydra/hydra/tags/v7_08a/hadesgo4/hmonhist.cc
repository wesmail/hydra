...
void HMonHistAddon::draw(Bool_t allowHiddenZero)  {Error("HMonHistAddon::draw()" ,"virtual function called!");}
...
TH1* HMonHistAddon::getP(Int_t s,Int_t m)         {Error("HMonHistAddon::getP()" ,"virtual function called!"); return(0);}
