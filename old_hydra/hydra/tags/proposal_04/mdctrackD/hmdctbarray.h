...
inline Int_t HMdcTBArray::next(const UChar_t *pF, const UChar_t *pL, Int_t prPos) {
  // prPos <0 eq. first
...
inline Int_t HMdcTBArray::previous(const UChar_t *pF,const  UChar_t *pL, Int_t prPos) {
  // prPos >size eq. last
