...
class HMdcClosePairCutsPar : public HParSet {
 ...
 public:
  ...
  HMdcClosePairCutsPar(const char* name="MdcClosePairCutsPar",const char* title="close pair rejection  parameters for Mdc-Rich",const char* context="",Int_t h=3,Int_t l=8,Int_t m=3,Int_t n=4);
