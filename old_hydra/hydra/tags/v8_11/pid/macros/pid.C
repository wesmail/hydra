// @(#)$Id: pid.C,v 1.3 2003-03-05 14:36:57 jaskula Exp $
// The macro to make HPidParticle from HPidCandidate
// Usage:
// .L pid.C
// ana()
...
HPidParticleFiller *pPartFiller = new HPidParticleFiller("MAKEART", "HPidParticleHit");

  pPartFiller->setCondition(5, 0.1, ">=");
