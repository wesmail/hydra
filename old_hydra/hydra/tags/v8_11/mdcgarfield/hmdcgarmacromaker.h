...
protected:
    ...
    Int_t argon;                   //! fraction of argon in gas mixture (in %)
    Int_t helium;                  //! fraction of helium in gas mixture (in %)
    Int_t ibutane;                 //! fraction of iso-butan in gas mixture (in %)
    ...
    void   printKeyWords();
public:
    HMdcGarMacroMaker(const char* name="",const char* title="");
    ~HMdcGarMacroMaker();
