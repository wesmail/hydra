...
//    HMdcSizesCells* fSizesCells;
    ...
    TH1F* zVerDscH[6][6][10]; // [sec][comb][DownscalingFlag||trigger cond.]
    Int_t histsMode;          // =0 - one hist., =1 - 2 hist downsc.flag
                              // =2 - trigger cond.
    ...
    Stat_t stat;
    Bool_t sumOfFiles;        // =kTRUE - add all runs in one hist.
                              // =kFALSE - do figures for each run
  ...
  public:
    ...
    void addToCanvasName(char* add)     {addCnName=add;}
