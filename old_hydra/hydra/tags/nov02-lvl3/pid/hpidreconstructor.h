// @(#)$Id: hpidreconstructor.h,v 1.3 2002-11-04 23:19:49 jaskula Exp $
...
protected:
    ...
    virtual void        merge(const HPidTrackCand *pTrack,
                                        HPidCandidate *pCand);

    virtual void        mergePdf(const HPidTrackCand *pTrack,
                                        HPidCandidate *pCand);
    virtual void        mergeBayes(const HPidTrackCand *pTrack,
                                        HPidCandidate *pCand);
    virtual void        mergeCl(const HPidTrackCand *pTrack,
                                        HPidCandidate *pCand);
