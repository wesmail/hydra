...
void   HRichHistFiller::putRichParams(HParamList* l,TList* histpool)
{
    ...
    // HParamList (which ist used by the io);
       ...
       l->add("hRichPulseDist"         ,mytemp,500);

       hRichMultiplicityAddon->getText(mytemp);
       l->add("hRichMultiplicity"      , mytemp,500);
       hRichPulseheightAddon->getText(mytemp);
       l->add("hRichPulseheight"       ,mytemp,500);
       hRichChargedParticlesAddon->getText(mytemp);
       l->add("hRichChargedParticles"  ,mytemp,500);
       sprintf(mytemp,"%s","s");
       l->add("hRichFancy"             ,mytemp,500);
       sprintf(mytemp,"%s","s");
       l->add("hRichPattern"           ,mytemp,500);
       hRichmult_rawA->getText(mytemp);
       l->add("hRichmult_raw"          ,mytemp,500);
       hRichmulttemp_rawA->getText(mytemp);
       l->add("hRichmulttemp_raw"      ,mytemp,500);
       hRichmulttrend_rawA->getText(mytemp);
       l->add("hRichmulttrend_raw"     ,mytemp,500);
