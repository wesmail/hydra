  ...
  if(gHades) 
    {
     ...
     // HMdcTrackGSpline *Spline=new HMdcTrackGSpline;
      nt4 = new TNtuple("nt4","nt4","theta:phi:pGeant:pRecon");
      nt3 = new TNtuple("nt3","nt3","theta:phi:pGeant:pRecon");
...
//   cout<<"again"<<endl;
	...
	{	  
	  pRecon=Spline->calcMomentum(POINT,kFALSE,-20.,4);
	  
	  //POINT[3]=POINT3Cham; 
	    calcChamber3Mode(POINT);
	    POINT[3]=POINT3Cham;
	    POINT[0]*=0.1;     
	  pRecon3Cham=Spline->calcMomentum(POINT,kFALSE,-20.,3);
	  ...
	  nt4->Fill(theta,phi,pGeant,pRecon);
	  nt3->Fill(theta,phi,pGeant,pRecon3Cham);
