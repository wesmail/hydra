...
HMdcLowLevelQA::HMdcLowLevelQA(Text_t* name,Text_t* title)
...
void HMdcLowLevelQA::setOutputRoot(Char_t *c)
{
...
TDirectory *HMdcLowLevelQA::Mkdir(TDirectory *dirOld, Char_t *c, Int_t i, Int_t p)    //! Makes new Dir, changes to Dir, returns pointer to new Dir
{
