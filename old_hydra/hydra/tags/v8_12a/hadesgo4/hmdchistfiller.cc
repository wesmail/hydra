...
void   HMdcHistFiller::putMdcParams(HParamList* l,TList* histpool)
{
    ...
    // HParamList (which ist used by the io);
       ...
       l->add("hcal1hitstemp"              ,mytemp,500);
       hCal1HitsTrendA->getText(mytemp);
       l->add("hcal1hitstrend"         ,mytemp,500);
       ...
       l->add("htime1Cal1MeanTrendMod0"    ,mytemp,500);
       htime1Cal1MeanTrendMod1A->getText(mytemp);
       l->add("htime1Cal1MeanTrendMod1"    ,mytemp,500);
       htime1Cal1MeanTrendMod2A->getText(mytemp);
       l->add("htime1Cal1MeanTrendMod2"    ,mytemp,500);
       htime1Cal1MeanTrendMod3A->getText(mytemp);
       l->add("htime1Cal1MeanTrendMod3"    ,mytemp,500);
       htime1Cal1MeanTrendMod0tempA->getText(mytemp);
       l->add("htime1Cal1MeanTrendMod0temp",mytemp,500);
       htime1Cal1MeanTrendMod1tempA->getText(mytemp);
       l->add("htime1Cal1MeanTrendMod1temp",mytemp,500);
       htime1Cal1MeanTrendMod2tempA->getText(mytemp);
       l->add("htime1Cal1MeanTrendMod2temp",mytemp,500);
       htime1Cal1MeanTrendMod3tempA->getText(mytemp);
       l->add("htime1Cal1MeanTrendMod3temp",mytemp,500);
