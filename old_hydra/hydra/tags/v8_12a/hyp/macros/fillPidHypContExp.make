...
CXXFLAGS += -g -I$(ADSM_BASE)/Linux \
		-I$(HADDIR_HYP)

LIBS+=$(ROOTLIBS) -lProof -lTreePlayer -lMinuit 
LIBS+=$(ROOTGLIBS) 

RPATH=`echo "$(HADDIR_HYP_LIB):\
	$(HADDIR_RICH_LIB):\
	$(HADDIR_RICHUTIL_LIB):\
	$(HADDIR_MDC_LIB):\
	$(ROOTSYS)/lib:\
...
fillPidHypContExp_h: fillPidHypContExp_h.cc
	$(CXX) fillPidHypContExp_h.cc $(CXXFLAGS) -c -o fillPidHypContExp_h.o
	$(LD) fillPidHypContExp_h.o -Wl,-rpath,$(RPATH)\
	 -L.  \
	-L$(HADDIR_HYP_LIB) -lHyp \
	-L$(HADDIR_MDCTRACKD_LIB) -lMdcTrackD \
	-L$(HADDIR_MDC_LIB) -lMdc \
