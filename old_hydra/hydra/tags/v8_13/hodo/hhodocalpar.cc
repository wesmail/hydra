...
HHodoCalPar::HHodoCalPar(const char* name,const char* title,
                           const char* context)
...
void HHodoCalPar::readline(const char *buf, Int_t *set)
{
...
Bool_t HHodoCalPar::writeline(char *buf, Int_t mod, Int_t strip)
{
