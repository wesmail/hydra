...
HCategory* HMdcGetContainers::pMdcCal1Cat   = 0;
HCategory* HMdcGetContainers::pGeantKineCat = 0;
HCategory* HMdcGetContainers::pGeantMdcCat  = 0;

void HMdcGetContainers::setCatMdcCal1(HCategory* cat) {
  if(cat) pMdcCal1Cat=cat;
  else if(gHades) pMdcCal1Cat =
      gHades->getCurrentEvent()->getCategory(catMdcCal1);
}

void HMdcGetContainers::setCatGeantKine(HCategory* cat) {
  if(cat) pGeantKineCat=cat;
  else if(gHades) pGeantKineCat =
      gHades->getCurrentEvent()->getCategory(catGeantKine);
}

void HMdcGetContainers::setCatGeantMdc(HCategory* cat) {
  if(cat) pGeantMdcCat=cat;
  else if(gHades) pGeantMdcCat=
    gHades->getCurrentEvent()->getCategory(catMdcGeantRaw);
}
...
Bool_t HMdcGetContainers::isGeant() {
  if(getCatMdcCal1()) return 
    (getCatMdcCal1()->getClass()!=HMdcCal1Sim::Class()) ? kFALSE:kTRUE;
  if(getCatMdcClus()) return 
    (getCatMdcClus()->getClass()!=HMdcClusSim::Class()) ? kFALSE:kTRUE;
