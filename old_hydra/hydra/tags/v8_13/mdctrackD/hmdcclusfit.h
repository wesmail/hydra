...
public:
  ...
  Int_t   getClustIndex(void) const      {return clustIndex;}
  ...
  inline void    getClustAddress(Int_t& sc, Int_t& sg, Int_t& ind) const;
...
inline void HMdcClusFit::getClustAddress(Int_t& sc,Int_t& sg,Int_t& ind) const {
  sc=sec;
  sg=(seg==3) ? 0:seg; 
  ind=clustIndex;
}
