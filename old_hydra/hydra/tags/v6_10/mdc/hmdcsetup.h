...
public:
	...
	noiseRangeLoDigi[0]=rLo0;
        noiseRangeLoDigi[1]=rLo0;
        noiseRangeLoDigi[2]=rLo0;
        noiseRangeLoDigi[3]=rLo0;
	noiseRangeHiDigi[0]=rHi0;
        noiseRangeHiDigi[1]=rHi0;
        noiseRangeHiDigi[2]=rHi0;
        noiseRangeHiDigi[3]=rHi0;
    }
...
public:
    HMdcCalibrater1Setup(const char* name="",const char* title="",HMdcSetup* set=0);
...
public:
    HMdcTrackFinderSetup(const char* name="",const char* title="",HMdcSetup* set=0);
...
public:
    HMdcClusterToHitSetup(const char* name="",const char* title="",HMdcSetup* set=0);
...
public:
    HMdc12FitSetup(const char* name="",const char* title="",HMdcSetup* set=0);
    ~HMdc12FitSetup();
...
public:
    HMdcCommonSetup(const char* name="",const char* title="",HMdcSetup* set=0);
    ~HMdcCommonSetup();
...
public:
    HMdcSetup(const char* name   ="MdcSetup",
	      const char* title  ="parameters for MdcTaskSet",
	      const char* context="MdcSetupProduction");
    ~HMdcSetup();
