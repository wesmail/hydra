...
// Last update by Thomas Eberl: 01/06/18 17:20:51
//
...
HRichUnpackerRaw99::HRichUnpackerRaw99(int rId,int strtEvt=0,Bool_t isPed=kFALSE,Bool_t verbose=kFALSE,Int_t iSloppyL=0) {
    richId = rId;
    startEvt=strtEvt;
    isPedestal=isPed;
    kverbose=verbose;
