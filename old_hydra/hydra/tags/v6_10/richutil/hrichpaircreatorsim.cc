// File: hrichpaircreatorsim.cc
//
// Author: Thomas Eberl <Thomas.Eberl@physik.tu-muenchen.de>
// Last update by Thomas Eberl: 02/04/22 20:57:38
//
...
HRichPairCreatorSim::HRichPairCreatorSim(Text_t *name,Text_t *title, char* filename) :
