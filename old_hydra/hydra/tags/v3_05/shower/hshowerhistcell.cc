...
void HShowerHistCell::calculate(Int_t nRow, Int_t nCol,
  ...
  *pfSlope = 1.0;
  ...
  fMean1 = getMean(m_nDataSize, m_pData, 0, fMean, nMax/2);

  fMean2 = getMean(m_nDataSize, m_pData, fMean, nBins, nMax/2);
  ...
  m_pSlopeHist->Fill(nRow, nCol, *pfSlope - 1);
  m_pOffsetHist->Fill(nRow, nCol, -*pfOffset);
}
