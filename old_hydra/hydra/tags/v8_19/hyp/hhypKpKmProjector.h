...
class HHypKpKmProjector:public HHypBaseAlgorithm
{
...
public:
  ...
  HHypKpKmProjector(Char_t *name_i = NULL, Option_t par[] = NULL);
  
  virtual ~ HHypKpKmProjector(void);
  ...
  ClassDef(HHypKpKmProjector, 0)  // creates ntuples for PP reactions
};
