...
//*-- Modified : 27/07/2005 by Marco Destefanis
//_HADES_CLASS_DESCRIPTION 
////////////////////////////////////////////////////////////////////////
//
// HHypPPPipPimMiss0Projector
//
...
ClassImp(HHypPPKpPimMiss0Projector)
  
  HHypPPKpPimMiss0Projector::HHypPPKpPimMiss0Projector(Char_t *name_i, Option_t par[]) : HHypBaseAlgorithm(name_i, par)
{
  simuflag = 0;
}


HHypPPKpPimMiss0Projector::~HHypPPKpPimMiss0Projector()
{
}


Bool_t HHypPPKpPimMiss0Projector::execute()
{
...
Bool_t HHypPPKpPimMiss0Projector::init()
{
...
Bool_t HHypPPKpPimMiss0Projector::reinit()
{
  return kTRUE;
}

Bool_t HHypPPKpPimMiss0Projector::finalize()
{
  miss->Write();
  return kTRUE;
}
