// $Id: hrichcorrcounter.h,v 1.6 2008-09-18 13:05:35 halo Exp $
// Last update by Thomas Eberl: 02/09/25 18:07:44
//
...
public:
    ...
    HRichCorrCounter(Text_t *name,Text_t *title, Char_t* filename);
	~HRichCorrCounter();
