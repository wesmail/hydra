...
//  HMdcSegSim
//
// This class is derived from HMdcSim for simulated events.
...
void HMdcSegSim::print(void) {
  printf("Sec.%i Seg.%i, %i tracks: ",getSec(),getIOSeg(),nTracks);
  for(Int_t n=0; n<nTracks; n++) printf("%i(%i) ",listTracks[n],nTimes[n]);
  printf("[trNum(NOfTimes)]\n   ");
//  HMdcSeg::print(); // not implemented yet
}
