...
public:
  HMdcTimeCut(const char* name="MdcTimeCut",
              const char* title="cut on time1, time2 & time2-time1",
              const char* context="MdcTimeCutProduction",
