...
class HMdcTrackFitter : public TObject {
  ...
  public:
    ...
    void setFLayerPlane (Double_t a, Double_t b, Double_t d)
        {parA1=a; parB1=b; parD1=d;}
    void setLLayerPlane (Double_t a, Double_t b, Double_t d)
        {parA2=a; parB2=b; parD2=d;}
