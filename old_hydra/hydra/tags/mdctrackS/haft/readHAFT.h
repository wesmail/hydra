...
extern "C" Float_t getpairmatrixval_(Int_t*, Int_t*, Int_t*);
extern "C" void getlimits_(Float_t*, Float_t*, Float_t*,
                           Float_t*, Float_t*, Float_t*,
                           Float_t*, Float_t*, Float_t*);
extern "C" void getpairlimits_(Float_t*, Float_t*, Float_t*,
                               Float_t*, Float_t*, Float_t*,
                               Float_t*, Float_t*, Float_t*);
extern "C" void getdimensions_(Int_t*, Int_t*, Int_t*);
extern "C" void getpairdimensions_(Int_t*, Int_t*, Int_t*);
