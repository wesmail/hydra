...
{
  // copy values from fuseralg to c_fuseralg
  //         and from fvaluealg to c_fuseralg
...
Int_t HHypList::getOrder(void)
{
  ...
  // 1 - for the combination with the lowest probability
...
{
  // returns probability given by algotrythm for combination 
  // iterate over combination
