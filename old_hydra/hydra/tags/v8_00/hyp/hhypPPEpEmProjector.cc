...
Bool_t HHypPPEpEmProjector::init()
{
  ...
  TString st_base("pp_miss:miss4:epem_invmass:fProbAlg:opang:ppmiss_theta:epem_alpha");
  TString st_trigger(":downscalingFlag:triggerDecision:triggerBits");
  ...
  miss = new TNtuple(input + TString("_proj"), "Masses", st_base);
