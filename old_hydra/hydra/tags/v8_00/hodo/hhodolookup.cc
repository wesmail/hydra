...
HHodoLookup::HHodoLookup(const char* name,const char* title,
                       const char* context,
...
void HHodoLookup::readline(const char *buf, Int_t *set) {
...
Bool_t HHodoLookup::writeline(char *buf, Int_t crate, Int_t slot, Int_t chan) {
