...
Float_t anglewithclosestleptoncandidate = pTrackData->fAngleWithClosestLeptonCandidate;
Float_t anglewithclosesthadroncandidate = pTrackData->fAngleWithClosestHadronCandidate;
...
Int_t   i;
	...
	*/
    ...
    for(i = 0; i < pRec->particlesNumber(); i++)
    {
	  ...
	  if(isLepInMdc(iId,pHitData,pTrackData) != 0) bMdc=kTRUE; 
