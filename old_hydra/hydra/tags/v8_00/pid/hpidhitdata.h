// @(#)$Id: hpidhitdata.h,v 1.15 2006-08-16 16:13:35 halo Exp $
...
class HPidHitData: public TObject
{
 public:
  ...
  Bool_t  hasRingCorrelation[nMomAlgs]; 
  Bool_t  hasMetaTrackCorrelation[nMomAlgs]; 
  ...
  Int_t   getMdcClsSize0() const   {return iMdcClsSize0;}
  Int_t   getMdcNWires0() const    {return iMdcNWires0;}
  Int_t   getMdcLevelCls0() const  {return iMdcLevelCls0;}
  Int_t   getMdcClsSize1() const   {return iMdcClsSize1;}
  Int_t   getMdcNWires1() const    {return iMdcNWires1;}
  Int_t   getMdcLevelCls1() const  {return iMdcLevelCls1;}
  ...
  Int_t   getMdcClsSize2() const   {return iMdcClsSize2;}
  Int_t   getMdcNWires2() const    {return iMdcNWires2;}
  Int_t   getMdcLevelCls2() const  {return iMdcLevelCls2;}
  Int_t   getMdcClsSize3() const   {return iMdcClsSize3;}
  Int_t   getMdcNWires3() const    {return iMdcNWires3;}
  Int_t   getMdcLevelCls3() const  {return iMdcLevelCls3;}
  ...
  ClassDef(HPidHitData, 7)  // Store data for HPidParticle from Hits
    };
