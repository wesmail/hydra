...
fillPidHypContSim_h: fillPidHypContSim_h.cc
	$(CXX) fillPidHypContSim_h.cc $(CXXFLAGS) -c -o fillPidHypContSim_h.o
	$(LD) fillPidHypContSim_h.o -Wl,-rpath,$(RPATH)\
	 -L.  \
	-L$(HADDIR_HYP_LIB) -lHyp \
	-L$(HADDIR_MDCTRACKD_LIB) -lMdcTrackD \
	-L$(HADDIR_MDC_LIB) -lMdc \
