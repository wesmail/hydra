...
public:
    ...
    Bool_t  GetHodoChanged()           {return hodoChanged;}
    void    SetHodoChanged(Bool_t b)   {hodoChanged=b;}
    Bool_t  GetWallChanged()           {return wallChanged;}
    void    SetWallChanged(Bool_t b)   {wallChanged=b;}
    Bool_t  GetShowerChanged()         {return showerChanged;}
    void    SetShowerChanged(Bool_t b) {showerChanged=b;}
    Bool_t  GetPhysicsChanged()        {return physicsChanged;}
    void    SetPhysicsChanged(Bool_t b){physicsChanged=b;}
