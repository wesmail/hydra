// $Id: htimelvl1evtfilter.cc,v 1.2 2007-08-03 09:56:16 jurkovic Exp $
...
HTimeLvl1EvtFilter::HTimeLvl1EvtFilter(Text_t *name,Text_t *title,TString opt,Int_t m,Float_t timecut, Float_t MultSmearing) :
