// @(#)$Id: hpidtrackcand.h,v 1.10 2007-12-12 17:32:32 kempter Exp $
...
class HPidTrackCand : public TObject
{
 public:
  ...
  Int_t flags;                   // stored flags for double hits, best hits etc (bitwise) . See enum definition for the bit masks
