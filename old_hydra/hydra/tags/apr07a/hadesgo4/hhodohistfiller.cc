...
HMonHist*      HHodoHistFiller::hProf3=0;
HMonHist*      HHodoHistFiller::hProf4=0;
...
/*	if(!(l->fill("hHodohits_raw",mytemp,500))) {return kFALSE;}
	...
	else
	{
		...
		{
			activeHists->Add(hProf3=new HMonHist(*hProf3A));
		}
	}
	...
	else
	{
		...
		{
			activeHists->Add(hProf4=new HMonHist(*hProf4A));
		}
	}
