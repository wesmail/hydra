...
{                                                                
  ...
  if(fVertChi2 > -1.0){                                                             
    ...
    if(hvertex_xz) hvertex_yz->getP()->Fill(fVertZ,fVertY);                                                        
  }                                                                                 
}                                                                                   
...
*/
	...
	l->add("hvertex_xy"             ,mytemp,500);
	hvertex_xzA->getText(mytemp);
	l->add("hvertex_xz"             ,mytemp,500);
	hvertex_yzA->getText(mytemp);
	l->add("hvertex_yz"             ,mytemp,500);
}
