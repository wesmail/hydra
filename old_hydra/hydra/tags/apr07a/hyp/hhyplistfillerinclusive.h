...
public:
  ...
  HHypListFillerInclusive(Text_t * name, Text_t * title);
  ~HHypListFillerInclusive();
 ...
 private:
  ...
  Int_t           nHadronPlus, nHadronMinus, nLeptonMinus, nLeptonPlus, numberOfParticles;
  ...
  Int_t           PosHadronIdx[20];
  Int_t           NegHadronIdx[20];
  Int_t           PositronIdx[20];
  Int_t           ElectronIdx[20];
  ...
  Int_t fill_pid_idx_singiel_part(HHypComb * hypcomb, Int_t nTracks, Int_t iParPosition,
