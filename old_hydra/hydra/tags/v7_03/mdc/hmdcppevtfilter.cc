...
HMdcPPEvtFilter::HMdcPPEvtFilter(Text_t *name, Text_t *title, Int_t flagcat) : HReconstructor(name,title) {
...
void HMdcPPEvtFilter::setHistFile(char* dir,char* suf,char* option) {
...
TFile* HMdcPPEvtFilter::openHistFile(const char* flag) {
