...
//    HMdcSizesCellsSec* pToLayer; // Pointer to corresponding layer
  public:
...
class HMdcSizesCellsLayer : public HMdcPlane {
  ...
  protected:
    ...
    Double_t halfCatDist;     // half of distance between cathode layers
    Double_t pitch;           // distance between wires in layer
