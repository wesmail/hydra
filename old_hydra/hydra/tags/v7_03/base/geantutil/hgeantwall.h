...
private:
  ...
  Short_t cell;           // cell number (0-136)
public:
  HGeantWall(void);
  ...
  inline void setAddress (Char_t m, Short_t c);
  ...
  inline Short_t getCell(void) {return cell;}
...
inline void HGeantWall::setAddress(Char_t m, Short_t c) {
  module = m;
  cell = c;
}
