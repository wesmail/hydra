...
void HMdcTrackGCorrections::Streamer(TBuffer &R__b)
{
   ...
   if (R__b.IsReading()) {
      ...
      R__b.ReadStaticArray((double*)corrE);
      R__b.ReadStaticArray((double*)corrP);
     
      if(R__v==2)
      {
      R__b.ReadStaticArray((double*)corrE1);
      R__b.ReadStaticArray((double*)corrP1);
      }
      ...
      R__b.WriteArray((double*)corrE, 32640);
      R__b.WriteArray((double*)corrP, 32640);
      R__b.WriteArray((double*)corrE1, 32640);
      R__b.WriteArray((double*)corrP1, 32640);
