...
Bool_t HMdcFunc1::passCprPdfCuts(HPidDilepton* pDil,Float_t prob,Char_t * name_of_pdf_file,Int_t mode_rs,Option_t *rej_condition){ 
...
Bool_t HMdcFunc1::passCprPdfCuts(HPidParticle* pPart,Float_t prob,Char_t * name_of_pdf_file,Int_t mode_rs,Option_t *rej_condition){
