...
HTask*
HRichDetector::buildTask(Text_t* name, Option_t* opt)
{
...
HCategory*
HRichDetector::buildLinearCat(Text_t* classname, Int_t size)
{
...
HCategory*
HRichDetector::buildMatrixCat(Text_t* classname,
                              Float_t fillRate)
{
   Int_t            maxSector = 0;
   Int_t            i;
...
HCategory*
HRichDetector::buildSimMatrixCat(Text_t* classname,
                                 Float_t fillRate,
                                 Int_t   size       )
{
