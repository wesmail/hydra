...
#ifndef HHYP_P_EP_EM_X_H
#define HHYP_P_EP_EM_X_H
...
class  HHypPEpEmXAlg:public HHypBaseAlgorithm
{
...
public:
  ...
  HHypPEpEmXAlg(Char_t *name_i = NULL, Option_t par[] = NULL);

  virtual ~ HHypPEpEmXAlg(void);
  ...
  ClassDef(HHypPEpEmXAlg, 0)  // The PP Ep Em plus X Filler
};
