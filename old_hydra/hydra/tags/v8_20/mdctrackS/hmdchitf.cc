...
Int_t HMdcHitF :: find(Int_t listPlanes[6], Int_t nWantedHits, Int_t seg){ 
  ...
  //   - looks for hits Int_t listPlanes[4] and/or listPlanes[5] (depending 
...
// builds a Double_t linked list with the cal data. 
 
#if DEBUG_LEVEL>2 
  gDebuger->enterFunc("HMdcHitF::buildList"); 
#endif 
// transforms cal2 data into calhit, and 
// builds a Double_t linked list with the calhit data. 
