...
public:
  ...
  Float_t getMPV1(Char_t* aset="all") { return (aset=="lep")? mL1lep:mL1all; }
  Float_t getSigma1(Char_t* aset="all") { return (aset=="lep")? sL1lep:sL1all; }
  Float_t getMPV2(Char_t* aset="all") { return (aset=="lep")? mL2lep:mL2all; }
  Float_t getSigma2(Char_t* aset="all") { return (aset=="lep")? sL2lep:sL2all; }
  Float_t getConstRatio(Char_t* aset="all") { return (aset=="lep")? ratClep1:ratCall1; }
