// @(#)$Id: hpidhitdata.cc,v 1.29 2008-09-18 13:06:21 halo Exp $
...
void HPidHitData::fillFromMetaMatch(HMetaMatch *pMatch, Int_t iMatchIndex)
{
  ...
  if(pTrackCand!=NULL) //object exists
	...
	{
	  iIndClusInf2=HPidMdcFunc::getMdcClusInfoIndexBySegment(pOuterMdcSeg,0);
	  iIndClusInf3=HPidMdcFunc::getMdcClusInfoIndexBySegment(pOuterMdcSeg,1);
