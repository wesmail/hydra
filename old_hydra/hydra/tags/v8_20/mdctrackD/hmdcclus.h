...
protected:
  ...
  Float_t sigma2M1;     // sigma1 - Long_t axis, sigma2 - Short_t axis
  Float_t alphaM1;      // angle (deg.) of Long_t axis and X axis
  ...
  Float_t sigma2M2;     // sigma1 - Long_t axis, sigma2 - Short_t axis
  Float_t alphaM2;      // angle (deg.) of Long_t axis and X axis
