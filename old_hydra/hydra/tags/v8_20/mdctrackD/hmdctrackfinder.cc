...
Int_t HMdcTrackFinder::execute(void) {
  ...
  if(geantEvent) sortTracksInClusters();
  return 0;
}
...
void HMdcTrackFinder::printStatus(void) {
  ...
  Char_t* hCoil ="0 = MagnetOn,  1 = MagnetOff";
  Char_t* hType ="0 = combined chamber clusters, 1 = single cham. cl., 2 = mixed cl.(0+1)";
  Char_t* hLevS1="max. occupancy of MDC for level of cl.finding 4 & 5 layers";
  Char_t* hLevS2="max. occupancy of MDC for level of cl.finding 4 & 5 layers";
