// @(#)$Id: hpidmdcfunc.cc,v 1.5 2007-07-19 19:56:27 jurkovic Exp $
...
HMdcClusInf* HPidMdcFunc::getMdcClusInfoBySegment(HMdcSeg* pSeg,Int_t module)
{
  Int_t clsindex=getMdcClusInfoIndexBySegment(pSeg, module);
  return getClusInfObj(clsindex);
  return NULL;
}

Int_t HPidMdcFunc::getMdcClusInfoIndexBySegment(HMdcSeg* pSeg,Int_t module)
{
  HMdcHit *hit;
  Int_t clsindex = -1;
  hit=getMdcHit(pSeg,module);
  if(hit) 
    {
