...
const Char_t *bnames[] = { "/", "*", "+", "-", "ln", "exp", "^", "sqrt" };
...
const Char_t *bnames2[] = { "sin", "cos", "tan", "asin", "acos", "atan" };
...
//---------------------------------------------------------------------
//******  void HOnlObjBrowser::highlight(TGComboBox *p, const Char_t* name)
//
...
//---------------------------------------------------------------------
//******  void HOnlObjBrowser::highlight(TGlistBox *p, const Char_t* name)
//
...
//---------------------------------------------------------------------
//******  Int_t HOnlObjBrowser::extractCountIdx(const Char_t *name)
//
...
//---------------------------------------------------------------------
//******  const Char_t* HOnlObjBrowser::getBeforeUnderline(const Char_t *word)
//
...
//---------------------------------------------------------------------
//******  const Char_t* HOnlObjBrowser::getAfterUnderline(const Char_t *word)
//
