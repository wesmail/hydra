...
class HMdcSizesCellsCell : public TObject {
  ...
  protected:
    ...
    Char_t      readOutSide; // Wire readout side (first letter in Mbo name)
...
class HMdcSizesCellsLayer : public HMdcPlane {
  ...
  protected:
    ...
    Double_t             zGeantHit;        // z posit. of geant hits in lay.sys.
  ...
  public:
    ...
    void            addSecondPart(Int_t c,Float_t shift);
