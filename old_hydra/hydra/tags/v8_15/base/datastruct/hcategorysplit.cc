...
// Last modified 20/07/01 D.Magestro (HDataObject --> TObject)
...
const Text_t *HCategorySplit::getClassName(void) {
...
void HCategorySplit::Clear(Option_t *) {
...
TObject *HCategorySplit::getObject(HLocation &aLoc) {
  //see HCategory
#if DEBUG_LEVEL>2
