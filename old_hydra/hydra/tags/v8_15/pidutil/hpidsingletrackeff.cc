...
// -----------------------------------------------------------------------------
HPidSingleTrackEff::HPidSingleTrackEff(char * file)
...
// -----------------------------------------------------------------------------
HPidSingleTrackEff::HPidSingleTrackEff(Text_t name[], Text_t title[],Char_t * file)
...
Int_t HPidSingleTrackEff::execute(void){
    ...
    for(int i = 0;i<WHITE_TRACKS_NUMBER;i++) partIndex[i] = 0;
    Int_t aCount = 0;
