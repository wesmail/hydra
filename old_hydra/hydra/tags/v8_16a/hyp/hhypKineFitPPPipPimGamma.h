...
#ifndef HHYP_KINE_FIT_PPPIPPIMGAMMA_H
#define HHYP_KINE_FIT_PPPIPPIMGAMMA_H
...
class HHypKineFitPPPipPimGamma:public HHypKineFit
{
protected:
...
// No (De)Constructor needed
	...
	ClassDef(HHypKineFitPPPipPimGamma,0);// Fitting Alg for PP->PPPipPimGamma
};
