...
TObject *&HMatrixCategorySplit::getNewSlot(HLocation &aLoc) {
  //see HCategory
  Int_t la,i;
  HClonesTable *table;
  la=aLoc[0];
...
TObject *&HMatrixCategorySplit::getSlot(HLocation &aLoc) {
  //see HCategory
...
HDataObject *HMatrixCategorySplit::getObject(HLocation &aLoc) {
  //See HCategory
  Int_t la,i;
  HClonesTable *table;
  HDataObject *r=NULL;
