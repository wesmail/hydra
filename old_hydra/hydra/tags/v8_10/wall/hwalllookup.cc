...
HWallLookup::HWallLookup(const char* name,const char* title,
                       const char* context,
...
void HWallLookup::readline(const char *buf, Int_t *set) {
...
Bool_t HWallLookup::writeline(char *buf, Int_t crate, Int_t slot, Int_t chan) {
