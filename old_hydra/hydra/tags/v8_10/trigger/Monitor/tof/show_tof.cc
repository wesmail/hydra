...
void show_tof(TString infile)
{
	...
	TCanvas *c1;
	c1=new TCanvas("tof_corr","tof_corr");
	c1->SetBorderMode(0);
	c1->SetBorderSize(0);
...
{
        TROOT app("show_tof_corr","compiled tof_rich correlation macro");
