...
void TGo4HodoOnline::init()
{
   ...
   /* Get the pointer for the Status Object */
    ...
    //########################### REGISTER HISTS ###################################
    fxTGo4GUIRegistry->ReDirectObject("hHodoProf1",fxTGo4HodoOnlineSlots, true,HodofxQtRootCanvas1);
    fxTGo4GUIRegistry->ReDirectObject("hHodoProf2",fxTGo4HodoOnlineSlots, true,HodofxQtRootCanvas2);
    fxTGo4GUIRegistry->ReDirectObject("hHodoSpot",fxTGo4HodoOnlineSlots, true,HodofxQtRootCanvas3);
    fxTGo4GUIRegistry->ReDirectObject("hHodoRawTime",fxTGo4HodoOnlineSlots, true,HodofxQtRootCanvas4);
    fxTGo4GUIRegistry->ReDirectObject("hHodoRawWidth",fxTGo4HodoOnlineSlots, true,HodofxQtRootCanvas7);
    fxTGo4GUIRegistry->ReDirectObject("hHodoCrT1",fxTGo4HodoOnlineSlots, true,HodofxQtRootCanvas5);
    fxTGo4GUIRegistry->ReDirectObject("hHodoCrT2",fxTGo4HodoOnlineSlots, true,HodofxQtRootCanvas6);
    fxTGo4GUIRegistry->ReDirectObject("hHodoTDCMult",fxTGo4HodoOnlineSlots, true,HodofxQtRootCanvas8);
    fxTGo4GUIRegistry->ReDirectObject("hHodoFib1Mult",fxTGo4HodoOnlineSlots, true,HodofxQtRootCanvas9);
    fxTGo4GUIRegistry->ReDirectObject("hHodoFib2Mult",fxTGo4HodoOnlineSlots, true,HodofxQtRootCanvas10);
}
...
void TGo4HodoOnline::destroy()
{
    ...
    fxTGo4GUIRegistry->RemoveRedirectEntry("hHodoRawTime",fxTGo4HodoOnlineSlots);
    fxTGo4GUIRegistry->RemoveRedirectEntry("hHodoRawWidth",fxTGo4HodoOnlineSlots);
