...
void HQAHistograms::bookHistPid()
{
  ...
  histList->Add(hNTrackCandLepPerSecRK,"pidtrackcand--gridx"); 
    ...
    for(Int_t i=0;i<6;i++){
      ...
      sprintf(buffer2,"hpidtrk_kick_theta_sec%i charge=-1 mom>300",i);
    ...
    hpidtrk_kick_neg_phi = new TH1F("hpidtrk_kick_neg_phi","hpidtrk_kick_phi charge=-1 mom>300",120,0,360);
    ...
    for(Int_t i=0;i<6;i++){
      ...
      sprintf(buffer2,"hpidtrk_rk_theta_sec%i charge=-1 mom>300",i);
    ...
    hpidtrk_rk_neg_phi = new TH1F("hpidtrk_rk_neg_phi","hpidtrk_rk_phi charge=-1 mom>300",120,0,360);
