// @(#)$Id: hpidtrackfiller.h,v 1.18 2005-08-07 09:25:28 christ Exp $
...
public:
                ...
                HPidTrackFiller(Text_t name[], Text_t title[],Option_t pOpt[] = "");
...
protected:
    ...
    Bool_t      bAnalyzeLVL2Only;  //Skip all non-2nd-level-triggered events
