...
TGo4PhysicsOnlineStatus::TGo4PhysicsOnlineStatus(Text_t *Name, Text_t * Title)
			:TGo4Status(Name)
{
	...
	TGo4PhysicsOnlineStatus::~TGo4PhysicsOnlineStatus()
{

}
TObject* TGo4PhysicsOnlineStatus::OverWriteLocalObject(TNamed * fxData_Local)
{
    	TGo4LockGuard Global;
...
TObjArray *TGo4PhysicsOnlineStatus::GetLocalListStatus()
{
  	TGo4LockGuard Global;	
  	return(LocalListContent);
}

TObject* TGo4PhysicsOnlineStatus::GetObjectfromLocalList(const char *Object)
{
  	TGo4LockGuard Global;
  	return(LocalListContent->FindObject(Object));
	
}
ClassImp(TGo4PhysicsOnlineStatus)
