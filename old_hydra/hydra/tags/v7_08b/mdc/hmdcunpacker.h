...
class HMdcUnpacker: public HldUnpack {
 ...
 public:
  ...
  Bool_t checkMdcSetup(Int_t sector, Int_t module, UInt_t dataword);
  Bool_t checkMboRawStructBounds(Int_t sector,Int_t module, Int_t mbo, Int_t tdc , UInt_t dataword);
  ...
  void setExcludeBlackList(Bool_t b=kTRUE){excludeBlackList=b;};
 ...
 protected:
  ...
  void WarningExcludeDataWords(Int_t subEvtId, UInt_t data, UInt_t mask, UInt_t adress);
