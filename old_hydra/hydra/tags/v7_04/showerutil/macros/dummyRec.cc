// @(#)$Id: dummyRec.cc,v 1.1 2002-12-01 02:12:44 jaskula Exp $
// -----------------------------------------------------------------------------
...
public:
    ...
    HDummyRec(const char *pOutFileName);
...
HDummyRec::HDummyRec(const char *pOutFileName)
{
...
lab_Ok:
        ...
        if((fM = HPidPhysicsConstants::mass(iPid)) <= 0.0f)
            continue;
