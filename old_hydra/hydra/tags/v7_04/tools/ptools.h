...
class PTools 
{
 ...
 public:
  ...
  static TH2D*                getTH2D(TString name, TString title, 
				      ...
				      Int_t ybin, Double_t ymin, Double_t ymax, 
				      TString xtitle, TString ytitle, TString ztitle="");
  static TH2D*                getTH2D(const char* name, const char* title, 
				      Int_t xbin, Double_t xmin, Double_t xmax, 
				      Int_t ybin, Double_t ymin, Double_t ymax, 
				      const char* xtitle, const char*  ytitle, const char* ztitle="")
    {
  ...
  static TH3D*                getTH3D(TString name, TString title, 
				      ...
				      Int_t zbin, Double_t zmin, Double_t zmax, 
				      TString xtitle, TString ytitle, TString ztitle);
  static TH3D*                getTH3D(const char* name, const char* title, 
				      Int_t xbin, Double_t xmin, Double_t xmax, 
				      Int_t ybin, Double_t ymin, Double_t ymax, 
				      Int_t zbin, Double_t zmin, Double_t zmax, 
				      const char* xtitle, const char*  ytitle, const char*  ztitle)
  ...
  static TLatex*              drawLatexWC(const char* text, Double_t x, Double_t y, 
					  Int_t color = 1, Float_t size = 0.1, Int_t align = 11, Int_t font = 62, Float_t angle = 0.);
  ...
  static TLatex*              drawLatexPadCoords(TString text, Double_t x, Double_t y, 
					Int_t color = 1, Float_t size = 0.1, Int_t align = 11, Int_t font = 62, Float_t angle = 0.);
  static TLatex*              drawLatexPadCoords(const char* text, Double_t x, Double_t y, 
					Int_t color = 1, Float_t size = 0.1, Int_t align = 11, Int_t font = 62, Float_t angle = 0.);
  static TLatex*              drawLatexNDC(TString text, Double_t x, Double_t y, 
					   Int_t color = 1, Float_t size = 0.1, Int_t align = 11, Int_t font = 62, Float_t angle = 0.);
  static TLatex*              drawLatexNDC(const char* text, Double_t x, Double_t y, 
					   Int_t color = 1, Float_t size = 0.1, Int_t align = 11, Int_t font = 62, Float_t angle = 0.);
  ...
  static TH1D*                getBinContentDistribution(TH1* hist, Int_t binning=-1);
  ...
  static Int_t                findEndOfDistribution(TH1* hist, Int_t min, Double_t threshold);
