...
class HMdcDataWord : public TObject {
 ...
 public:
  ...
  inline Bool_t checkConsistency(UInt_t version=0, UInt_t data=0);
  inline Bool_t checkConsistencyRocHeader(UInt_t version=0);
  ...
  inline void print(UInt_t version);
  ...
  ClassDef(HMdcDataWord, 2)	// a mdc data word  
    ...
    inline Bool_t HMdcDataWord::checkConsistency(UInt_t version, UInt_t data)
{
