// $Id: hpaircutpar.cc,v 1.8 2005-05-24 19:53:06 jacek Exp $
// Author: Thomas.Eberl@ph.tum.de, last modified : 2005-05-23 00:08:58
//
// ---------------------------------------------------------------------------
///////////////////////////////////////////////////////////////////////////////
//                                                                           
...
Bool_t HPairCutPar::checkRecursive(HIterator* pIter)
{
	...
	if(nPairOpeningAngleFlag)
	{
	  ...
	  {
	    isNewIndex(p->getIndexParticle1(),nOpang,nMaxNbGuiltyParticles);
	    isNewIndex(p->getIndexParticle2(),nOpang,nMaxNbGuiltyParticles);
	  }
	}
	...
	if(nDoubleDetectorHitFlag)
	{
	  ...
	  {
	    isNewIndex(p->getIndexParticle1(),nDouble,nMaxNbGuiltyParticles);
	    isNewIndex(p->getIndexParticle2(),nDouble,nMaxNbGuiltyParticles);
	  }
	}
...
Bool_t HPairCutPar::isNewIndex(Int_t i,Int_t* iarr,Int_t max)
{
