...
fillPidNtupleSim_h: fillPidNtupleSim_h.cc
	$(CXX) fillPidNtupleSim_h.cc $(CXXFLAGS) -c -o fillPidNtupleSim_h.o
	$(LD) fillPidNtupleSim_h.o -Wl,-rpath,$(RPATH)\
	 -L.  \
	-L$(HADDIR_MDCTRACKD_LIB) -lMdcTrackD \
	-L$(HADDIR_MDC_LIB) -lMdc \
	-L$(HADDIR_MDCUTIL_LIB) -lMdcUtil \
