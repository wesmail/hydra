//@(#)$Id: makeAllPidContainers_Sim_Nov01_gen6_3D.C,v 1.1 2004-04-30 16:22:25 christ Exp $
...
char   sOutputFile[] = "~/hades/hydra/macros/PID/RESULTS/NOV01_GEN6_2/AllSimPidContainersNov01_gen6_3D.root";
...
void makeAllPidContainers_Sim(void)
{
  ...
  new TFile("~/hades/PID_PARAMS/CURRENT_VERSION/SIM/pidpar_tof_relint_cc2gen4_260503.root");
  setRelInt(1, pRecPar);
  
  new TFile("~/hades/PID_PARAMS/CURRENT_VERSION/SIM/pidpar_tofino_relint_cc2gen4sim_out150503_010603.root");
  setRelInt(0, pRecPar);
  ...
  new TFile("~/hades/PID_PARAMS/CURRENT_VERSION/SIM/pidpar_tof_pdf_cc2gen4_260503.root");
  
  // try to renormalize the pol2 distributions
  getAndRenormalize(1);
  setPdf(1, pMomVsBeta);
  
  new TFile("~/hades/PID_PARAMS/CURRENT_VERSION/SIM/pidpar_tofino_pdf_cc2gen4sim_out150503_010603.root");
  getAndRenormalize(0);
  setPdf(0, pMomVsBeta);
  ...
  new TFile("~/hades/PID_PARAMS/CURRENT_VERSION/SIM/pidpar_elosspdf_sim_nov01_gen4_tof_050603.root");
  setPdf(1, pMomVsEloss);

  new TFile("~/hades/PID_PARAMS/CURRENT_VERSION/SIM/pidpar_elosspdf_sim_nov01_gen4_tofino_050603.root");
  setPdf(0, pMomVsEloss);
  pMomVsEloss->print();
  
  
  HPidElossMPVShiftPar *pElossMPVShift = (HPidElossMPVShiftPar *) rtdb->getContainer("PidElossMPVShiftPar");
  new TFile("~/hades/PID_PARAMS/CURRENT_VERSION/SIM/pidpar_elossmpvshift_sim_nov01_gen4_tof_050603.root");
  setPdf(1, pElossMPVShift);
  new TFile("~/hades/PID_PARAMS/CURRENT_VERSION/SIM/pidpar_elossmpvshift_sim_nov01_gen4_tofino_050603.root");
  ...
  TFile* rich_pdfs= new TFile("~/hades/hydra/macros/PID/RESULTS/NOV01_GEN6_2/RICH_PID_PDFs_sim_nov01_gen6_3D.root");
