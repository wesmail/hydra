...
// Last update by Thomas Eberl: 02/04/16 18:41:58
//
...
//  		    cout<<"xmirr: "<<xMirrPhotCM<<" ymirr: "<<yMirrPhotCM<<" sec: "<<sec<<" phot: "<<phot<<" "<<aTrk<<" "<<aID<<endl;
//  		    cout<<"xring: "<<xRing<<" yring: "<<yRing<<" sec: "<<sec<<" "<<t1<<" "<<t2<<" "<<t3<<" "<<p1<<" "<<p2<<" "<<p3<<endl;
//  	    cout<<"*********************************"<<endl;
