//*-- AUTHOR : Ilse Koenig
//*-- Modified : 17/06/99 by Ilse Koenig
...
//     GEANT name   ROOT name    class
//    ------------------------------------ 
//        BOX        TBRIK      HGeomBrik
//        TRAP       TTRAP      HGeomTrap
//        TRD1       TTRD1      HGeomTrd1
//        PGON       TPGON      HGeomPgon
//        PCON       TPCON      HGeomPcon
//        TUBE       TTUBE      HGeomTube
//        TUBS       TTUBS      HGeomTubs
//        CONE       TCONE      HGeomCone
//        CONS       TCONS      HGeomCons
//        SPHE       TSPHE      HGeomSphe
//        ELTU       TELTU      HGeomEltu
//
///////////////////////////////////////////////////////////////////////////////
...
HGeomBasicShape* HGeomShapes::selectShape(const TString& name) {
  ...
  if (s) return s;
  Int_t no=-1;
  for(Int_t i=0;i<11;i++) {if (name.CompareTo(allShapes[i])==0) no=i;}
  switch(no) {
    ...
    default: {
      cerr<<"shape "<<name<<" not implemented"<<endl;
    }
  }
  if (s) shapes->Add(s);
  return s;
