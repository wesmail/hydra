...
class HMdcTrackDSet {
  ...
  protected: 
    ...
    static Int_t distTimeVer; // 0=calc. time by polinom., 1=by J.Market's func.
  ...
  public:
    ...
    static Int_t getClHtModForSeg1(void) {return modForSeg1;}
    static Int_t getClHtModForSeg2(void) {return modForSeg2;}
