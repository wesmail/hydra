...
//*-- Version: $Id: htriggersetup.cc,v 1.1 2005-07-15 09:00:24 wuestenf Exp $
...
// Due to hardware desing, the address of the RICH IPU, that is coded into the
...
void HTriggerSetup::printParam(void)
{
  ...
  gHades->getMsg()->info(10,HMessageMgr::DET_TRIGGER,GetName(),"%s %i","RICH hits   : ",muRichHits);
