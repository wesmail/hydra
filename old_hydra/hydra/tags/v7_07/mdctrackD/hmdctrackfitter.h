...
class HMdcTrackFitInOut : public TObject {
  ...
  public:
    ...
    HCategory* getGeantKineCut(void)         {return fGeantKineCut;}
    HCategory* getGeantMdcCut(void)          {return fGeantMdcCut;}
...
class HMdcTrackFitter : public TObject {
  ...
  public:
    ...
    virtual Int_t minimize(Double_t threshold, Int_t iter=0) {return 0;}
    ...
    const HMdcTrackParam * getFinalParam(void) const {return &finalParam;}
