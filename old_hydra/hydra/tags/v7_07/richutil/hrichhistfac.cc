// $Id: hrichhistfac.cc,v 1.14 2005-03-14 14:21:13 jurkovic Exp $
...
TH1F* HRichHistFac::getHOpeningAngleVarBin(const char * c,const char *b)
{
    TString *s=0;
    if (b==NULL) s=new TString(getHOpeningAngleBasename());
    else s=new TString(b);
...
TH1F* HRichHistFac::getHInvMassVarBin(const char * c,const char *b)
{
    TString *s=0;
    if (b==NULL) s=new TString(getHInvMassBasename());
    else s=new TString(b);
