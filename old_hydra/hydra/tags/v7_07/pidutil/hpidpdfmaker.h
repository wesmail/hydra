...
#define AUX_NTUPLE_VARS "i_geant_corrflag:i_geant_pid:n_sector:f_kick_mom_exp:f_spline_mom_exp:f_track_theta:b_corrRingKick:b_corrRingSpline:f_deltatheta:f_deltaphi:f_track_qspline:f_track_chi2_out:b_is_cp_cand:f_angle_with_cp_candidate"
