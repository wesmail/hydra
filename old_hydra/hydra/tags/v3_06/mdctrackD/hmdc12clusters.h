...
public: 
  ...
  void setXmid(Double_t x){xmid=x;}
  void setYmid(Double_t y){ymid=y;}
  void setZmid(Double_t z){zmid=z;}
  void setErrXmid(Double_t dX){dXmid=dX;}
  void setErrYmid(Double_t dY){dYmid=dY;}
  void setErrZmid(Double_t dZ){dZmid=dZ;}
  ...
  Double_t getXmid(){return xmid;}
  Double_t getYmid(){return ymid;}
  Double_t getZmid(){return zmid;}
  Double_t getErrXmid(){return dXmid;}
  Double_t getErrYmid(){return dYmid;}
  Double_t getErrZmid(){return dZmid;}
