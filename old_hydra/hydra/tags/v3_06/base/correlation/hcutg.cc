...
#warning do poprawienia
   ...
   Float_t xcut = ((HTreeFormula*)GetFormulaX())->EvalInstance(pInstancesIndex);
   Float_t ycut = ((HTreeFormula*)GetFormulaY())->EvalInstance(pInstancesIndex);
...
*/
      ...
      ((HTreeFormula*)GetFormulaX())->GroupLeaves();
      ((HTreeFormula*)GetFormulaY())->GroupLeaves();
}
