// @(#)$Id: hpidhitdata.cc,v 1.27 2007-01-11 13:40:52 pachmay Exp $
...
HPidHitData::HPidHitData(const HPidHitData& source):TObject(source)
{
  ...
  */
  ...
  fCombinedMdcdEdx=source.getCombinedMdcdEdx();
  fCombinedMdcdEdxSigma=source.getCombinedMdcdEdxSigma();
  ...
  iIndClusInf0=source.getIndClusInf(0);
  iIndClusInf1=source.getIndClusInf(1);
  iIndClusInf2=source.getIndClusInf(2);  
  iIndClusInf3=source.getIndClusInf(3);
...
Short_t HPidHitData::getIndClusInf(Int_t i) const
{
  switch (i)
    {
    case 0:
    ...
    case 3:
      ...
      break;
    default:
      Error("HPidHitdata::getIndClusInf","Requested invalid ClusInf index: %d",i);
      return -1;
    }
...
Int_t HPidHitData::getMdcNWires(Int_t i) const
{
  ...
  if(iIndInnerSeg>=0)
    {
      pInnerMdcSeg = HPidFL::getMdcSeg(iIndInnerSeg);
    }

  if(iIndOuterSeg>=0)
    {
      pOuterMdcSeg = HPidFL::getMdcSeg(iIndOuterSeg);
    }
  ...
  switch(i)
    ...
    case 0:
      if(pInnerMdcSeg)
	{
	  return HPidMdcFunc::getMdcNWires(pInnerMdcSeg,0);
	}
      else 
	{
	  Error("HPidHitData::getMdcNWires","Pointer to inner segment is NULL");
	  return -1;
	}
      break;
    ...
    case 1:
      if(pInnerMdcSeg)
	{
	  return HPidMdcFunc::getMdcNWires(pInnerMdcSeg,1);
	}
      else 
	{
	  Error("HPidHitData::getMdcNWires","Pointer to inner segment is NULL");
    ...
    case 2:
      if(pOuterMdcSeg)
	{
	  return HPidMdcFunc::getMdcNWires(pOuterMdcSeg,0);
	}
      else 
	{
	  Error("HPidHitData::getMdcNWires","Pointer to outer segment is NULL");
	  return -1;
	}
      break;
    ...
    case 3:
      if(pOuterMdcSeg)
	{
	  return HPidMdcFunc::getMdcNWires(pOuterMdcSeg,1);
	}
      else 
	{
	  Error("HPidHitData::getMdcNWires","Pointer to outer segment is NULL");
...
Int_t HPidHitData::getMdcClsSize(Int_t i) const
{
  HMdcSeg* pInnerMdcSeg=NULL;
  HMdcSeg* pOuterMdcSeg=NULL;
  ...
  switch(i)
    ...
    case 0:
      if(pInnerMdcSeg)
	{
	  return HPidMdcFunc::getMdcClsSize(pInnerMdcSeg,0);
	}
      else 
	{
	  Error("HPidHitData::getMdcClsSize","Pointer to inner segment is NULL");
	  return -1;
	}
      break;
    ...
    case 1:
      if(pInnerMdcSeg)
	{
	  return HPidMdcFunc::getMdcClsSize(pInnerMdcSeg,1);
	}
      else 
	{
	  Error("HPidHitData::getMdcClsSize","Pointer to inner segment is NULL");
    ...
    case 2:
      if(pOuterMdcSeg)
	{
	  return HPidMdcFunc::getMdcClsSize(pOuterMdcSeg,0);
	}
      else 
	{
	  Error("HPidHitData::getMdcClsSize","Pointer to outer segment is NULL");
	  return -1;
	}
      break;
    ...
    case 3:
      if(pOuterMdcSeg)
	{
	  return HPidMdcFunc::getMdcClsSize(pOuterMdcSeg,1);
	}
      else 
	{
	  Error("HPidHitData::getMdcClsSize","Pointer to outer segment is NULL");
...
Int_t HPidHitData::getMdcLevelCls(Int_t i) const
{
  HMdcSeg* pInnerMdcSeg=NULL;
  HMdcSeg* pOuterMdcSeg=NULL;
  ...
  switch(i)
    ...
    case 0:
      if(pInnerMdcSeg)
	{
	  return HPidMdcFunc::getMdcLevelCls(pInnerMdcSeg,0);
	}
      else 
	{
	  Error("HPidHitData::getMdcLevelCls","Pointer to inner segment is NULL");
	  return -1;
	}
      break;
    ...
    case 1:
      if(pInnerMdcSeg)
	{
	  return HPidMdcFunc::getMdcLevelCls(pInnerMdcSeg,1);
	}
      else 
	{
	  Error("HPidHitData::getMdcLevelCls","Pointer to inner segment is NULL");
    ...
    case 2:
      if(pOuterMdcSeg)
	{
	  return HPidMdcFunc::getMdcLevelCls(pOuterMdcSeg,0);
	}
      else 
	{
	  Error("HPidHitData::getMdcLevelCls","Pointer to outer segment is NULL");
	  return -1;
	}
      break;
    ...
    case 3:
      if(pOuterMdcSeg)
	{
	  return HPidMdcFunc::getMdcLevelCls(pOuterMdcSeg,1);
	}
      else 
	{
	  Error("HPidHitData::getMdcLevelCls","Pointer to outer segment is NULL");
...
void HPidHitData::fillFromMetaMatch(HMetaMatch *pMatch, Int_t iMatchIndex)
{
  ...
  if(pTrackCand!=NULL) //object exists
    {
      fCombinedMdcdEdx=pTrackCand->getdedxCombinedSeg();
      fCombinedMdcdEdxSigma=pTrackCand->getSigmadedxCombinedSeg();
      ...
      if (pInnerMdcSeg != NULL) 
	{
	  ...
	  iIndClusInf0=HPidMdcFunc::getMdcClusInfoIndexBySegment(pInnerMdcSeg,0);
	  iIndClusInf1=HPidMdcFunc::getMdcClusInfoIndexBySegment(pInnerMdcSeg,1);
	...
	{
	  iIndClusInf0=HPidMdcFunc::getMdcClusInfoIndexBySegment(pOuterMdcSeg,0);
	  iIndClusInf1=HPidMdcFunc::getMdcClusInfoIndexBySegment(pOuterMdcSeg,1);
...
Float_t HPidHitData::getDeltaThetaRKRICH(Float_t fRKTheta) const
{
  return fRichTheta -fRKTheta;
}

Float_t HPidHitData::getDeltaPhiRKRICH(Float_t fRKPhi,Float_t fRKTheta) const
{
  return ( fRichPhi- fRKPhi )*TMath::Sin(TMath::DegToRad()*fRKTheta);
}
...
void HPidHitData::print(void) const
{
    ...
    */
    ...
    printf("iIndTOF: %d\n",iIndTOF);
    printf("iIndMatch: %d\n",iIndMatch);
    printf("iIndClusInf0: %d\n",iIndClusInf0);
    printf("iIndClusInf1: %d\n",iIndClusInf1);
    printf("iIndClusInf2: %d\n",iIndClusInf2);
    printf("iIndClusInf3: %d\n",iIndClusInf3);
}
