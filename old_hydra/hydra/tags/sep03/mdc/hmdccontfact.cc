...
void HMdcContFact::setAllContainers() {
  ...
  // the list of containers for the MDC library.
    ...
    HContainer* lookupSubevtId = new HContainer("MdcLookupSubEvtId",
						"Lookup table for subeventId to sector module matching", "MdcLookupSubEvtIdProduction");
    containers->Add(lookupSubevtId);
}
