...
Bool_t HMdcListLayCells::test(Int_t cell) const {
  return (cell>=0 && cell < NCELLS) ? kTRUE : kFALSE;
}

void HMdcListLayCells::clear(void) {
  HMdcTBArray::clear(arr,arr+AEND);
}

void HMdcListLayCells::setTime(Int_t cell,UChar_t time) {
  if(test(cell)) HMdcTBArray::set(arr,cell,time);
}

void HMdcListLayCells::delTime(Int_t cell,UChar_t time) {
  if(test(cell)) HMdcTBArray::unset(arr,cell,time);
}

Int_t HMdcListLayCells::getNCells(void) const {
  return HMdcTBArray::getNSet(arr,arr+AEND);
}

Int_t HMdcListLayCells::getCell(Int_t idx) const {
  return HMdcTBArray::position(arr,arr+AEND,idx);
}

Int_t HMdcListLayCells::getFirstCell(void) const {
  return HMdcTBArray::first(arr,arr+AEND);
}

Int_t HMdcListLayCells::getLastCell(void) const {
  return HMdcTBArray::last(arr,arr+AEND);
}

Int_t HMdcListLayCells::next(Int_t prCell) const {
  return HMdcTBArray::next(arr,arr+AEND,prCell);
}

Int_t HMdcListLayCells::previous(Int_t prCell) const {
  return HMdcTBArray::previous(arr,arr+AEND,prCell);
}


UChar_t HMdcListLayCells::getTime(Int_t cell) const {
...
void HMdcListCells::clear(void) {
  for(Int_t l=0;l<6;l++) list[l].clear();
}

void HMdcListCells::setTime(Int_t lay, Int_t cell, UChar_t time) {
  if(lay>=0&&lay<6) list[lay].setTime(cell,time);
}

void HMdcListCells::delTime(Int_t lay, Int_t cell, UChar_t time) {
  if(lay>=0&&lay<6) list[lay].delTime(cell,time);
}

Int_t HMdcListCells::getNCells(void) const {
  Int_t nCells=0;
  for(Int_t l=0;l<6;l++) nCells+=list[l].getNCells();
  return nCells;
}

UChar_t HMdcListCells::getTime(Int_t lay, Int_t cell) const {
  return (lay>=0&&lay<6) ? list[lay].getTime(cell):0;
}

Bool_t HMdcListCells::test(Int_t lay, Int_t cell) const {
  return (lay>=0&&lay<6) ? list[lay].test(cell):kFALSE;
}

Int_t HMdcListCells::getNLayers(void) const {
  Int_t nLay=0;
...
void HMdcListGroupCells::clear(void) {
  HMdcTBArray::clear(arr,arr+AEND);
  firstCell=0;
}
...
Int_t HMdcListGroupCells::getNCells(void) const {
  return HMdcTBArray::getNSet(arr,arr+AEND);
}

Int_t HMdcListGroupCells::getCell(Int_t idx) const {
...
Int_t HMdcListGroupCells::getFirstCell(void) const {
...
Int_t HMdcListGroupCells::getLastCell(void) const {
...
Int_t HMdcListGroupCells::next(Int_t prCell) const {
  Int_t cell=HMdcTBArray::next(arr,arr+AEND,prCell-firstCell);
  if(cell>=0) cell+=firstCell;
  return cell;
}

Int_t HMdcListGroupCells::previous(Int_t prCell) const {
  Int_t cell=HMdcTBArray::previous(arr,arr+AEND,prCell-firstCell);
  if(cell>=0) cell+=firstCell;
  return cell;
}

UChar_t HMdcListGroupCells::getTime(Int_t cell) const {
  Int_t pos=cell-firstCell;
...
void HMdcList12GroupCells::clear(void) {
...
Int_t HMdcList12GroupCells::getNCells(Int_t lay, Int_t layEnd) const {
...
Int_t HMdcList12GroupCells::getNCells(void) const {
  return HMdcTBArray::getNSet(arr,arr+NLAY*SIZE-1);
}

Int_t HMdcList12GroupCells::getNDrTimes(void) const {
  return HMdcBArray::getNSet(arr,arr+NLAY*SIZE-1);
}

Int_t HMdcList12GroupCells::getNDrTimes(Int_t lay) const {
  if(lay<0 || lay>NLAY) return -1;
  return HMdcBArray::getNSet(arr+lay*SIZE,arr+lay*SIZE+AEND);
}

Int_t HMdcList12GroupCells::getNDrTimes(Int_t lay1,Int_t lay2) const {
  if(lay1<0 || lay2>NLAY) return -1;
  return HMdcBArray::getNSet(arr+lay1*SIZE,arr+lay2*SIZE+AEND);
}

Int_t HMdcList12GroupCells::getCell(Int_t lay, Int_t idx) const {
  // return: -1 - idx <0 or >num.cells
...
Int_t HMdcList12GroupCells::getFirstCell(Int_t lay) const {
  // return: -1 - num.cells=0
...
Int_t HMdcList12GroupCells::get4FirstCells(Int_t lay, Int_t* list) const {
...
Int_t HMdcList12GroupCells::getNLayers(void) const {
  Int_t nLayers=0;
  for(Int_t lay=0; lay<NLAY; lay++) if(getFirstCell(lay)>=0) nLayers++;
  return nLayers;
}

Int_t HMdcList12GroupCells::getNLayersMod(Int_t mod) const {
...
Int_t HMdcList12GroupCells::getLastCell(Int_t lay) const {
  // return: -2 - num.cells=0
...
Int_t HMdcList12GroupCells::next(Int_t lay, Int_t prCell) const {
  Int_t cell=
...
Int_t HMdcList12GroupCells::previous(Int_t lay, Int_t prCell) const {
  Int_t cell=
...
UChar_t HMdcList12GroupCells::getTime(Int_t lay, Int_t cell) const {
  Int_t pos=cell-firstCell[lay];
  if(pos<0 || pos>=NCELLS) return 0;
