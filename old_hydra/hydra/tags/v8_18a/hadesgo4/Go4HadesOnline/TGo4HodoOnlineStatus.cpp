...
TGo4HodoOnlineStatus::TGo4HodoOnlineStatus(Text_t *Name, Text_t * Title)
			:TGo4Status(Name)
{
	...
	TGo4HodoOnlineStatus::~TGo4HodoOnlineStatus()
{

}
TObject* TGo4HodoOnlineStatus::OverWriteLocalObject(TNamed * fxData_Local)
{
 	TGo4LockGuard Global;
...
TObjArray *TGo4HodoOnlineStatus::GetLocalListStatus()
{
  	TGo4LockGuard Global;	
  	return(LocalListContent);
}

TObject* TGo4HodoOnlineStatus::GetObjectfromLocalList(const char *Object)
{
  	TGo4LockGuard Global;
  	return(LocalListContent->FindObject(Object));
	
}
ClassImp(TGo4HodoOnlineStatus)
