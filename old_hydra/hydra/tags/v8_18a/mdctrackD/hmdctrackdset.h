...
class HMdcTrackDSet {
  ...
  public:
    static HReconstructor* hMdcTrackFinder(Char_t* name, Char_t* title);
    static HReconstructor* hMdcTrackFinder(Char_t* name, Char_t* title, 
        Bool_t coil,Int_t type);
    static void useThisTrackFinder(HMdcTrackFinder* trFndr);
    static HReconstructor* hMdcClusterToHit(Char_t* name, Char_t* title);
    static HReconstructor* hMdcClusterToHit(Char_t* name, Char_t* title,
        Int_t mSeg1, Int_t mSeg2);
    static HReconstructor* hMdc12Fit(Char_t* name, Char_t* title);
    static HReconstructor* hMdc12Fit(Char_t* name, Char_t* title, 
  ...
  protected:
    static void exitSetup(Char_t* funNm, Int_t npar, Char_t* use, Int_t inst);
    static void exitSetup(Char_t* funNm,Char_t* className);
  private:
    HMdcTrackDSet(void) {}
