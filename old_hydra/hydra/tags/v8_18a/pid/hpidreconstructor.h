// @(#)$Id: hpidreconstructor.h,v 1.10 2006-09-06 14:45:08 christ Exp $
...
{
public:
                        HPidReconstructor(Option_t par[] = DEFAULT_OPTIONS, Float_t HadronBias = 1.0);
                        HPidReconstructor(Text_t name[], Text_t title[],
                                        Option_t par[] = DEFAULT_OPTIONS, Float_t HadronBias = 1.0);
