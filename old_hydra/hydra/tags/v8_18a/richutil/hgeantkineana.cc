// $Id: hgeantkineana.cc,v 1.12 2008-05-09 16:16:32 halo Exp $
...
HGeantKineAna::HGeantKineAna(Text_t *name,Text_t *title, Char_t* filename, Char_t* evtgen) :
  HReconstructor(name,title)
{
    pFileName  = filename;
    pEvtGen    = evtgen;
...
void HGeantKineAna::showLeptonsFromPi0Decays(Char_t *swt)
{
...
Int_t HGeantKineAna::checkForPair(TObjArray& l,Char_t *swt)
{
    if (l.GetLast()==0)
    {
