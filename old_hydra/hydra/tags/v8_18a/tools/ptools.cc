...
// Modified by $Author: halo $ on $Date: 2008-05-09 17:07:52 $  
////////////////////////////////////////////////////////////////////////////////
...
Char_t * PTools::myexec(Char_t * in)
{
  // executes command in
...
TLatex* PTools::plotTopLegend(Char_t* label,Float_t x,Float_t y,Float_t size,Int_t color)
{
  // Thanks to Jochen Markert, GSI
    // coordinates in NDC!
    if(x<0||y<0)
