...
Int_t fillPidNtupleSim(TString inFile, Int_t nEvents=0, Int_t startEvt=0)
{
  // real or simulation
 ...
 TString paramFile2="/home/jacek/hydra/dev/params/allparams.root";
  ...
  TString inDir   = "/d/c2/hadeshyp/output/sim/";
  TString outDir = "/d/c2/jacek/jan04/postdst/sim/"; 
  ...
  HPidPerformaceTest *pidNtFiller = new  HPidPerformaceTest(pidNtFile.Data());
...
Int_t main(Int_t argc, Char_t **argv)
{
  ...
  {
    case 2:
      return fillPidNtupleSim(TString(argv[1]));
      break;
    case 3:
      return fillPidNtupleSim(TString(argv[1]),atoi(argv[2]));
      break;
    case 4:
      return fillPidNtupleSim(TString(argv[1]),atoi(argv[2]),atoi(argv[3]));
      break;
    default:
    break;
   }
