 ...
 * 
 * $Id: hdstproduction.cc,v 1.32 2008-07-23 11:47:58 halo Exp $
 *
 */
  ...
  EvalOptions:
   ...
   while (1)
   {
      option = getopt_long( current_argc, current_argv,
			    "1:2:c:d:e:f:hi:I:n:o:O:p:q:r:s:t:",
...
void HDstProduction::printHelp()
{
   ...
   cout << "\n"
	...
	<< " file or as aguments while calling the macro within CINT. The Short_t options\n"
