...
inline TIterator *HCategory::MakeReverseIterator(void) {
...
TObject *&HCategory::getNewSlot(HLocation &aLoc,Int_t* pIndex=0) { 
  AbstractMethod("getNewSlot");
  return gNullObjectP;
}

TObject *&HCategory::getSlot(HLocation &aLoc,Int_t* pIndex=0) {
...
TIterator *HCategory::MakeIterator(Option_t *opt="catIter",
