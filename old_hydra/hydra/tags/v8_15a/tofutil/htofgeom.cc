...
void HTofGeom::ExecuteEvent(Int_t event, Int_t px, Int_t py) {
  ...
  if(gTofDisplay->isZoom()) {
    ...
    case kButton1Motion:
      ...
      gVirtualX->DrawLine(px_start,py_start,px1,py_start);
      gVirtualX->DrawLine(px_start,py_start,px,py_start);
      gVirtualX->DrawLine(px1,py_start,px1,py1);
      gVirtualX->DrawLine(px,py_start,px,py);
      gVirtualX->DrawLine(px_start,py_start,px_start,py1);
      gVirtualX->DrawLine(px_start,py_start,px_start,py);
      gVirtualX->DrawLine(px_start,py1,px1,py1);
      gVirtualX->DrawLine(px_start,py,px,py);
      px1 = px;
      py1 = py;
      break;
