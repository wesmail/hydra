// $Id: hrichhistfac.h,v 1.5 2002-11-29 18:39:59 eberl Exp $
// Last update by Thomas Eberl: 02/11/29 13:11:19
//
...
public:
    ...
    static Char_t* getHMomvsBetaBasename(){return "Mom.vs.Beta_";};
