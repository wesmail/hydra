...
void HMdcAligner::setZones(Float_t* X=0, Float_t* Y=0,
...
void HMdcAligner::setHomogeneousDistribution(Int_t maxEntries=1000)
{
  //
...
void HMdcAligner::setSearchLimits(Float_t x, Float_t y, Float_t s=1.){ 
  //
...
void HMdcAligner::findRotXYBySampling(Int_t angleIter=1,Int_t iter=0){
  //
  //
...
void HMdcAligner::findRotXGeometrically(Int_t iter=0){
  //
  //
  //
...
void HMdcAligner::findRotYGeometrically(Int_t iter=0){
  //
  //
  //
...
void HMdcAligner::findRotZGeometrically(Int_t iter=0){
  //
  //  
  //
...
HGeomVector HMdcAligner::translationFinder(Int_t XYorBoth=-1,
...
HGeomVector HMdcAligner::translationFinderRW(Int_t XYorBoth=-1,
					   Int_t XLowLim=0, Int_t XUppLim=0,
					   Int_t YLowLim=0, Int_t YUppLim=0){
  //
...
Float_t* HMdcAligner::rotZFinder(Int_t noZones=0){
  //
...
Float_t* HMdcAligner::rotYXFinder(Int_t noZones, Int_t YorX=0){
  //
...
void HMdcAligner::minfitRot(Int_t fix, Double_t first, Double_t second=0){ 
  //
