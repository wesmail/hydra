...
/*
// This code doesn't do anything, so I commented it (MJ  Aug 27 2001)
...
void HShowerHist::calculate(HShowerCalPar* pCalPar, Int_t iMethod,
...
HShowerHistCell *pHistCell;
    ...
    for(loc[0] = 0; loc[0] < m_nSectors; loc[0]++)
    {
        for(loc[1] = 0; loc[1] < m_nModules; loc[1]++)
        {
            ...
            pHistCell->calculate(pCalPar, iMethod, fParam1, fParam2);
        }
    }
}
