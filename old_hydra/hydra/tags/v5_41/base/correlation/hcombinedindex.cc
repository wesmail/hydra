...
HCombinedIndex& HCombinedIndex::operator=(int val) {
...
HCombinedIndex& HCombinedIndex::operator+=(int val2) {
  int val1;
...
Bool_t HCombinedIndex::operator==(int val2) {
  int val1;
...
void HCombinedIndex::calcIndex(int val, int range, int index) {
