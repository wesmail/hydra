...
const Int_t kCalibrationEvent=9;
...
const Int_t MDC_OFFSET=STARTVALUE;
const Int_t RICH_OFFSET= STARTVALUE + 1*INCREMENT;
const Int_t SHOWER_OFFSET= STARTVALUE + 2*INCREMENT;
const Int_t TOF_OFFSET= STARTVALUE + 3*INCREMENT;
const Int_t START_OFFSET= STARTVALUE + 4*INCREMENT;
const Int_t TOFINO_OFFSET= STARTVALUE + 5*INCREMENT;
const Int_t SIMUL_OFFSET= STARTVALUE + 6*INCREMENT;
const Int_t CALO_OFFSET= STARTVALUE + 7*INCREMENT;
const Int_t MATCHU_OFFSET= STARTVALUE + 8*INCREMENT;
const Int_t PHYANA_OFFSET= STARTVALUE + 10*INCREMENT;
