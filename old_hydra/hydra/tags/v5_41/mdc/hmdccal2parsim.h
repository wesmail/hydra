...
public:
   ...
   void fillTime1Error(Int_t p0,
    ...
    {
	fillTime1(HMdcCal2ParAngleSim&);
	fillTime2(HMdcCal2ParAngleSim&);
	fillTime1Error(HMdcCal2ParAngleSim&);
	fillTime2Error(HMdcCal2ParAngleSim&);
    }
    */
...
public:
    ...
    void calcTimeDigitizer(Int_t ,Int_t ,Float_t,Float_t,Float_t,Float_t*,Float_t*);
    void calcTime2Digitizer(Int_t ,Int_t ,Float_t,Float_t,Float_t,Float_t*,Float_t*);
    void clear();
