...
# Date: 09 July 2001
# Last Modification: 07 August 2001
############################################################
...
MODULES="basedir \
	 base evtserver kickplane mdc mdctrackD mdctrackS \
	 online ora revt rich shower showertofino \
	 start tof tofino trigger phyana"
...
then
    ...
    export LD_LIBRARY_PATH=$LD_LIBRARY_PATH:$MYDEVHADDIR/lib:$HADDIR/lib
    export LD_LIBRARY_PATH=$LD_LIBRARY_PATH:/usr/local/openlink/odbcsdk/lib
    
    export PATH=$PATH:$HADDIR/exe
    ...
    echo " "
    echo ".-------------------------------------------------------------."
    echo "|            HADES analysis enviroment initialized            |"
    echo ".-------------------------------------------------------------."
