...
public:
  ...
  UInt4 getRunNr() const { //printf(" file number %i \n",
                           //       ((EvtHdr*)pHdr)->runNr);
                           return ((EvtHdr*)pHdr)->runNr; }
...
protected:
  ...
  static const size_t maxSubEvts = 20;
