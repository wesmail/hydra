//====================================================================
Char_t *file="/d/hades/nov99/n99_006.hld";
 //----------Another way: 
...
//Int_t mdcUnpacker=6;
//====================================================================
Char_t *lookup="/u/halo/anal/nov99/macros/Mdc/mdc_lookup.txt"; 
//====================================================================
// Float_t cutLeft=27.;
// Float_t cutRight=300.;

// Cut for time difference.
...
//  mdc.setModules(5,mod);
  ...
  rtdb->addEventFile(fileI);
//  rtdb->addEventFile("/d/hades/mdc/data/data_271199-2042.hld");
//  rtdb->addEventFile("/u/zumbruch/data/beamtime/et99/et99_0014.hld");
//  rtdb->addEventFile("/u/pechenov/Hydra/input/ht99_38.hld");
//  rtdb->addEventFile("/s/hades/ht99/ht99_61.hld");
...
//  source->addUnpacker(new HMdcUnpacker(6,kTRUE));
  source->addUnpacker(new HMdcUnpacker(mdcUnpacker,kTRUE));
...
//=========================================================
  trackFinder->setCut(cutLeft, cutRight);
  beamTest->setCut(cutLeft, cutRight);
