...
Int_t fillHypContExp(TString inputFile, Int_t nEvents=0, Int_t startEvt=0)
{
...
Int_t main(Int_t argc, Char_t **argv)
{
  ...
  {
    case 2:
      return fillHypContExp(TString(argv[1]));
      break;
    case 3:
      return fillHypContExp(TString(argv[1]),atoi(argv[2]));
      break;
    case 4:
      return fillHypContExp(TString(argv[1]),atoi(argv[2]),atoi(argv[3]));
      break;
    default:
    break;
   }
