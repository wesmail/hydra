...
// HHypPKpKmProjector
//
// HHypPKpKmProjector projects any P K+ K- data to the ntuple
//
////////////////////////////////////////////////////////////////////////

#warning "This code is not written in a way to be compatible with other hyp features"
#warning "Remark: This code is a 1:1 copy of HHypKpKmProjector!!!!"
...
ClassImp(HHypPKpKmProjector)

HHypPKpKmProjector::HHypPKpKmProjector(Char_t *name_i, Option_t par[])
  :HHypBaseAlgorithm(name_i,par)
{
    simuflag = 0;
}

HHypPKpKmProjector::~HHypPKpKmProjector()
{
}

Bool_t HHypPKpKmProjector::execute()
{
    ...
    while (mylist->CombIterator())
    {
	   ...
	   if(mylist->getProbAlg(icomb)<=0) continue;
	    ...
	    //	    if(proton1.E()==0 || proton2.E()==0) {cout<<"HHypPKpKmProjector::  empty particle"<<endl; continue;}
...
Bool_t HHypPKpKmProjector::init()
{
...
Bool_t HHypPKpKmProjector::reinit()
{
    return kTRUE;
}

Bool_t HHypPKpKmProjector::finalize()
{
    pkpkm->Write();
    return kTRUE;
}

Bool_t HHypPKpKmProjector::IsOpposit(Short_t sec1, Short_t sec2)
{
...
Bool_t HHypPKpKmProjector::SetParamFile(TString pFile)
{
    paramFile=pFile;
	return 0;
}

Float_t HHypPKpKmProjector::calcVertex(HPidTrackCand *p1, HPidTrackCand *p2,
