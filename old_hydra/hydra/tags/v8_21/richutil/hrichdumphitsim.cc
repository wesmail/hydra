// $Id: hrichdumphitsim.cc,v 1.5 2009-07-23 14:52:20 halo Exp $
// Last update by Thomas Eberl: 02/09/25 17:33:40
//
using namespace std;
...
HRichDumpHitSim::HRichDumpHitSim(const Text_t *name,const Text_t *title) :
