...
public:
    HRichPhotonCal(const Text_t *name,const Text_t *title, Float_t charMin,
    ...
    Bool_t centralpad(Int_t nRow, Int_t nCol, Int_t nSector);
    Bool_t checkIsolation(Int_t nRow, Int_t nCol, Int_t nSector);
