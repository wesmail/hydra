// $Id: hrichdiag.cc,v 1.8 2009-07-15 11:39:21 halo Exp $
// Last update by Thomas Eberl: 02/09/25 17:32:16
//
using namespace std;
#include "hrichdiag.h"
...
HRichDiag::HRichDiag(const Text_t *name,const Text_t *title,const Char_t* filename,Int_t n) :
