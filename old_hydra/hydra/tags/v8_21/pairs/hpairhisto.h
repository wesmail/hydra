// $Id: hpairhisto.h,v 1.4 2009-07-15 11:41:59 halo Exp $
...
public:
    ...
    static const Char_t* getHMomChrgvsPolarAngleBasename(){return "MomChrg_PolarAngle_";};
    //
    static TH2F* getHMomtChrgvsPolarAngle(const Char_t* c=NULL,const Char_t* b=NULL);
    static const Char_t* getHMomtChrgvsPolarAngleBasename(){return "MomtChrg_PolarAngle_";};
    //
    static TH2F* getHPolarHitChrgvsAzimuth(const Char_t* c=NULL,const Char_t* b=NULL);
    static const Char_t* getHPolarHitChrgvsAzimuthBasename(){return "Polar_Azimuth_";};
    //
    static TH2F* getHGeantMomKickMomDiff(const Char_t* c=NULL,const Char_t* b=NULL);
    static const Char_t* getHGeantMomKickMomDiffBasename(){return "MomentumGeant_DiffMomentumKickGeant_";};
    //
    ...
    static const Char_t* getHCorrCodeGeantPolarAngleBasename(){return "CorrCodeGeant_PolarAngle_";};
    //
    ...
    static const Char_t* getHInvMassMomtBasename(){return "InvMass_PairPt_";};
    //
    static TH2F* getHInvMassRapidity(const Char_t* c=NULL,const Char_t* b=NULL);
    static const Char_t* getHInvMassRapidityBasename(){return "InvMass_Rapidity_";};
    //
    static TH2F* getHInvMassOpang(const Char_t* c=NULL,const Char_t* b=NULL);
    static const Char_t* getHInvMassOpangBasename(){return "InvMass_Opang_";};
    //
    static TH2F* getHMomtOpang(const Char_t* c=NULL,const Char_t* b=NULL);
    static const Char_t* getHMomtOpangBasename(){return "PairPt_OpeningAngle_";};
    //
    static TH2F* getHMomtRapidity(const Char_t* c=NULL,const Char_t* b=NULL);
    static const Char_t* getHMomtRapidityBasename(){return "PairPt_Rapidity_";};
    //
    static TH2F* getHRapidityOpang(const Char_t* c=NULL,const Char_t* b=NULL);
    static const Char_t* getHRapidityOpangBasename(){return "Rapidity_OpeningAngle_";};
    //
    ...
    static const Char_t* getHRingXYBasename(){return "RingCenterX_Y_";};
    //
    ...
    static const Char_t* getHRingRadiusThetaBasename(){return "PolarAngle_RingRadius_";};
    //
    ...
    static const Char_t* getHRingAmplitudeThetaBasename(){return "PolarAngle_RingChargeSum_";};
    //
    ...
    static const Char_t* getHRingPadNrThetaBasename(){return "PolarAngle_RingPadNr_";};
    //
    ...
    static const Char_t* getHRingLocMax4ThetaBasename(){return "PolarAngle_RingLocMax4_";};
    //
    ...
    static const Char_t* getHRingPMThetaBasename(){return "PolarAngle_RingPatternMatrix_";};
    //
    ...
    static const Char_t* getHRingHTThetaBasename(){return "PolarAngle_RingHoughTrafo_";};
    //
    ...
    static const Char_t* getHRingCentroidThetaBasename(){return "PolarAngle_RingCentroid_";};
    //
    ...
    static const Char_t* getHRingAvChrgThetaBasename(){return "PolarAngle_RingAvChrg_";};
    // --
    static TH2F* getHRingAvChrgLocMax4(const Char_t* c=NULL,const Char_t* b=NULL);
    static const Char_t* getHRingAvChrgLocMax4Basename(){return "RingAvChrg_LocMax4_";};
    //
    static TH2F* getHRingAvChrgCentroid(const Char_t* c=NULL,const Char_t* b=NULL);
    static const Char_t* getHRingAvChrgCentroidBasename(){return "RingAvChrg_Centroid_";};
    //
    static TH2F* getHRingAvChrgPatMat(const Char_t* c=NULL,const Char_t* b=NULL);
    static const Char_t* getHRingAvChrgPatMatBasename(){return "RingAvChrg_PatMat_";};
    //
    static TH2F* getHRingAvChrgPadNr(const Char_t* c=NULL,const Char_t* b=NULL);
    static const Char_t* getHRingAvChrgPadNrBasename(){return "RingAvChrg_PadNr_";};
    //
    static TH2F* getHRingLocMax4Centroid(const Char_t* c=NULL,const Char_t* b=NULL);
    static const Char_t* getHRingLocMax4CentroidBasename(){return "LocMax4_Centroid_";};
    //
    static TH2F* getHRingLocMax4PatMat(const Char_t* c=NULL,const Char_t* b=NULL);
    static const Char_t* getHRingLocMax4PatMatBasename(){return "LocMax4_PatMat_";};
    //
    static TH2F* getHRingLocMax4PadNr(const Char_t* c=NULL,const Char_t* b=NULL);
    static const Char_t* getHRingLocMax4PadNrBasename(){return "LocMax4_PadNr_";};
    //
    static TH2F* getHRingCentroidPatMat(const Char_t* c=NULL,const Char_t* b=NULL);
    static const Char_t* getHRingCentroidPatMatBasename(){return "Centroid_PatMat_";};
    //
    static TH2F* getHRingCentroidPadNr(const Char_t* c=NULL,const Char_t* b=NULL);
    static const Char_t* getHRingCentroidPadNrBasename(){return "Centroid_PadNr_";};
    //
    static TH2F* getHRingPatMatPadNr(const Char_t* c=NULL,const Char_t* b=NULL);
    static const Char_t* getHRingPatMatPadNrBasename(){return "PatMat_PadNr_";};
    // ----
    static TH2F* getHRingParIdWeight(const Char_t* c=NULL,const Char_t* b=NULL);
    static const Char_t* getHRingParIdWeightBasename(){return "ParId_Weight_";};
    // ----
    static TH2F* getHWeightWeight(const Char_t* c=NULL,const Char_t* b=NULL);
    static const Char_t* getHWeightWeightBasename(){return "RICHWeight_MDCWeight_";};
    // ----
    ...
    static const Char_t* getHMomvsMomBasename(){return "Mom_Mom_";};
    //
    static TH2F* getHMdcRvsMdcZ(const Char_t* c=NULL,const Char_t* b=NULL);
    static const Char_t* getHMdcRvsMdcZBasename(){return "MdcR_MdcZ_";};
    //
    static TH2F* getHMdcRvsMdcChi2(const Char_t* c=NULL,const Char_t* b=NULL);
    static const Char_t* getHMdcRvsMdcChi2Basename(){return "MdcR_MdcChi2_";};
    //
    static TH2F* getHMomvsBeta(const Char_t* c=NULL,const Char_t* b=NULL);
    static const Char_t* getHMomvsBetaBasename(){return "Beta_Mom_";};
    //
    static TH2F* getHMomChrgvsBeta(const Char_t* c=NULL,const Char_t* b=NULL);
    static const Char_t* getHMomChrgvsBetaBasename(){return "Beta_MomChrg_";};
    //
    static TH2F* getHMomvsEnergy(const Char_t* c=NULL,const Char_t* b=NULL);
    static const Char_t* getHMomvsEnergyBasename(){return "Mom_Energy_";};
    //
    static TH2F* getHMomChrgvsEnergy(const Char_t* c=NULL,const Char_t* b=NULL);
    static const Char_t* getHMomChrgvsEnergyBasename(){return "MomChrg_Energy_";};
    //
    static TH2F* getHMassvsBeta(const Char_t* c=NULL,const Char_t* b=NULL);
    static const Char_t* getHMassvsBetaBasename(){return "Mass_Beta_";};
    //
    static TH2F* getHMassChrgvsBeta(const Char_t* c=NULL,const Char_t* b=NULL);
    static const Char_t* getHMassChrgvsBetaBasename(){return "MassChrg_Beta_";};
    //
    ...
    static const Char_t* getHDeflAnglevsMassBasename(){return "DeflectionAngle_Mass_";};
    //
    static TH2F* getHDeflAnglevsBeta(const Char_t* c=NULL,const Char_t* b=NULL);
    static const Char_t* getHDeflAnglevsBetaBasename(){return "DeflectionAngle_Beta_";};
    // 
    static TH2F* getHDeflAnglevsMom(const Char_t* c=NULL,const Char_t* b=NULL);
    static const Char_t* getHDeflAnglevsMomBasename(){return "DeflectionAngle_Mom_";};
    // 
