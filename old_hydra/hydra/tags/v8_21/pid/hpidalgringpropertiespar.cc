// @(#)$Id: hpidalgringpropertiespar.cc,v 1.11 2008-05-09 16:15:05 halo Exp $
...
HPidAlgRingPropertiesPar::HPidAlgRingPropertiesPar(const Char_t *name, const Char_t *title,
