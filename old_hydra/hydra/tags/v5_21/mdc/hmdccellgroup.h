...
class HMdcCellGroup : public HDataObject {
 protected:
 ...
 public:
  ...
  ClassDef(HMdcCellGroup,0) //A group of cells in layers
};
...
class HMdcCellGroup6 : public HMdcCellGroup {
 ...
 public:
  ...
  ~HMdcCellGroup6(void) {}
  ClassDef(HMdcCellGroup6,0) //Group of cells in 6 layers
};
...
class HMdcCellGroup12 : public HMdcCellGroup {
 ...
 public:
  ...
  ClassDef(HMdcCellGroup12,0) //group of cells in 12 layers.
};


//----------------------- Inlines ------------------------------
Int_t HMdcCellGroup::getNCells(Int_t layer) {
  return nCellsLookUp[pLayer[layer] & 0xFF];
}

Int_t HMdcCellGroup::getCell(Int_t layer,Int_t idx) {
  return ((pLayer[layer]>>8) & 0xFF)+cellPosLookUp[idx][pLayer[layer] & 0xFF];
}

Int_t HMdcCellGroup::getSignId(Int_t layer,Int_t idx) {
...
void HMdcCellGroup::setSignId(Int_t layer,Int_t cell,
