...
//  Char_t numTimes[12][300];
  ...
  Int_t nMods;
  Int_t mod;         // for nMods=1 mod-num.mod., for nMods>1 mod=-1
...
public: 
  ...
  Short_t getMaximum(){return maxClus;}
  void setNMods(Int_t m) {nMods=m;}
  Int_t getNMods() {return nMods;}
...
public: 
  ...
  Int_t addCluster(Short_t maxClus);
  void clear();
