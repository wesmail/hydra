...
// const Int_t  ciStringLength = 1000;
...
//     pdFile->AddEditString("and string as Char_t*", string, ciStringLength);
...
HSUDialog::HSUDialog(const Char_t *psTitle) :
...
{
// Add an edit box for a Float_t variable
HSUDialogFrame *pFrame = new HSUDialogFrame(this);
HSUEditFloat   *pEdit;
...
//
// It must be an array of Char_t* like:
//   {
...
//
// pStr must be a pointer to a string at least 255 B Long_t !
HSUDialogFrame *pFrame = new HSUDialogFrame(this);
...
void HSUDialog::AddOpenFileName(const Char_t *pName, TString *pStr,
                                const Char_t **paFileTypes)
{
// Like the previous function but work with TString instead of Char_t*
HSUDialogFrame *pFrame = new HSUDialogFrame(this);
HSUFileOpen    *pFileBox;
