// $Id: hrichpcasim.cc,v 1.5 2008-05-09 16:16:33 halo Exp $
...
HRichPCASim::HRichPCASim(Text_t *name,Text_t *title) :
...
HRichPCASim::HRichPCASim(Text_t *name,Text_t *title, Char_t* filename) :
  HReconstructor(name,title)
{
