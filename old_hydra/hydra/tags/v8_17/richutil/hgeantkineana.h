// $Id: hgeantkineana.h,v 1.10 2008-05-09 16:16:32 halo Exp $
...
public:
	...
	HGeantKineAna();
        ...
        HGeantKineAna(Text_t *name,Text_t *title,Char_t* filename,Char_t *evtgen);
	~HGeantKineAna();
