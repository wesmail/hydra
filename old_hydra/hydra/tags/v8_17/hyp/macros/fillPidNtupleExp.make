...
fillPidNtupleExp_h: fillPidNtupleExp_h.cc
	$(CXX) fillPidNtupleExp_h.cc $(CXXFLAGS) -c -o fillPidNtupleExp_h.o
	$(LD) fillPidNtupleExp_h.o -Wl,-rpath,$(RPATH)\
	 -L.  \
	-L$(HADDIR_MDCTRACKD_LIB) -lMdcTrackD \
	-L$(HADDIR_MDC_LIB) -lMdc \
	-L$(HADDIR_MDCUTIL_LIB) -lMdcUtil \
