...
HMdcClosePairCutsPar::HMdcClosePairCutsPar(const Char_t* name,const Char_t* title,
                       const Char_t* context,Int_t h,Int_t l,Int_t m,Int_t n) : HParSet(name,title,context) {
...
Bool_t HMdcClosePairCutsPar::writeline(Char_t *buf, Int_t l, Int_t t, Int_t p, Int_t ef) {
...
void HMdcClosePairCutsPar::readline (const Char_t* buf,Int_t *) {
  // writes one line to the buffer used by ascii file I/O
  Int_t  l,t,p,ef;
...
void HMdcClosePairCutsPar::printParam(void) {
  SEPERATOR_msg("#",60);
  INFO_msg(10,HMessageMgr::DET_MDC,"HMdcClosePairCutsPar:");
  INFO_msg(10,HMessageMgr::DET_MDC,"Format:");
  INFO_msg(10,HMessageMgr::DET_MDC,"levelbin thetabin phibin effbin  efficiency s/b mdcclustersizecut mdccontwirescut richintchargecut:");
