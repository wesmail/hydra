...
//    l->addBinary("field",   field);
    ...
    l->addBinary("corrScan0",    corrScan0);
    l->addBinary("corrScan1",    corrScan1);
    l->addBinary("corrScan2",    corrScan2);
...
//    if(!( l->fillBinary("field",field))) return kFALSE;
    ...
    if(!( l->fillBinary("corrScan0",corrScan0))){cout<<"no coorrScan0, but it is Ok"<<endl; }//return kFALSE;
    if(!( l->fillBinary("corrScan1",corrScan1))){cout<<"no coorrScan1, but it is Ok"<<endl; }// return kFALSE;
    if(!( l->fillBinary("corrScan2",corrScan2))){cout<<"no coorrScan2, but it is Ok"<<endl; }// return kFALSE;				
    return kTRUE;
}
