...
static TObjArray*  fitArray(TObjArray* array=0,TF1* fit=0,TString name="",Float_t min=0,Float_t max=0,Int_t markerstyle=8,Int_t markercolor=2,Float_t markersize=0.7);
static void        cleanHist(TH1* h,Int_t threshold=3,Int_t val=0);
static void        resetHist(TH1* h,Stat_t val=-99,Stat_t valerr=-99);
