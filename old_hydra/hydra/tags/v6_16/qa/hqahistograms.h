...
public:
  ...
  TH1F *trackingKick123_sys0[6];     //! KickPlane tracking MDC12-META
  TH1F *trackingSpline_sys0[6];      //! KickPlane tracking MDC12-META

  TH1F *trackingKick12M_sys1[6];     //! KickPlane tracking MDC12-META
  TH1F *trackingKick123_sys1[6];     //! KickPlane tracking MDC12-META
  TH1F *trackingSpline_sys1[6];      //! KickPlane tracking MDC12-META
