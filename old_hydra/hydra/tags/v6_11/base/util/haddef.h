...
const Int_t kCalibrationEventLow=2;   // there is a range of cal events
const Int_t kCalibrationEventHigh=6;
...
const Int_t KICK_OFFSET= STARTVALUE + 9*INCREMENT;    // 288
...
const Cat_t catTracks=  KICK_OFFSET;
