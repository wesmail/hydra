...
private:
  ...
  Bool_t readModGeomNames(HShowerGeomPar*,Int_t*);
  Bool_t readCompGeomNames(HShowerGeomPar*,Int_t*);
  Bool_t readOldGeom(HShowerGeomPar *pPar);
  Bool_t fillOldGeom(HShowerGeomPar *pPar);
