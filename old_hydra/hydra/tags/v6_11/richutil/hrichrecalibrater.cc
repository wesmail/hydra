// $Id: hrichrecalibrater.cc,v 1.3 2002-09-25 16:19:53 eberl Exp $
...
HRichReCalibrater::HRichReCalibrater(Text_t *name, Text_t *title,char * 
				       path ,char * pString,Float_t fNoiseThr): HReconstructor(name,title) {    
...
int HRichReCalibrater::getCol(int hardwarenumber){

    int x = (int) (*vec5)(hardwarenumber);
    return x;
}

int HRichReCalibrater::getRow(int hardwarenumber){
...
void HRichReCalibrater::meanAndSigma(int sIx, int col, int row, float charge){
