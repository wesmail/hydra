// $Id: hrichcorrelator.cc,v 1.17 2002-10-18 15:10:18 eberl Exp $
// Last update by Thomas Eberl: 02/10/18 15:07:39
//
///////////////////////////////////////////////////////////
// HRichCorrelator
//
...
HRichCorrelator::HRichCorrelator(Text_t *name,Text_t *title, char* filename, Bool_t style) :
  HReconstructor(name,title)
{
