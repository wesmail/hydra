// $Id: hrichcorrcounter.cc,v 1.5 2002-09-25 16:19:52 eberl Exp $
...
HRichCorrCounter::HRichCorrCounter(Text_t *name,Text_t *title, char* filename) :
  HReconstructor(name,title)
{
...
void HRichCorrCounter::calcOpeningAngleMDC(TObjArray *pArr,TH1F* hist)
{
	...
	if (ind1>-1)
	{
		...
		if (ind2>-1)
		{
			...
			if (rind1>-1 && rind2>-1 && rind1==rind2) // it is the same ring, a double ring
			{
