...
void TGo4TofinoOnlineSlots::StartMonitor()
{
  ...
  //------------------------TOFINO---------------------------------
    ...
    fxTGo4GUIRegistry->ReDirectObject("hTofinohits_raw",this,true);
...
{	
	...
	fxTGo4TofinoOnlineStatus->OverWriteLocalObject(fxdata);
	...
	if(fxTGo4TofinoOnline!=0)  UpdateGUI(fxdata->GetName());
}	
void TGo4TofinoOnlineSlots::UpdateGUI(const char *ObjName)
{
  TGo4LockGuard Global;

  TObject *Obj = fxTGo4TofinoOnlineStatus->GetObjectfromLocalList(ObjName);
