...
/*
#include "Go4HadesOnline/TGo4HadesOnlineSlots.h"
#include "Go4HadesOnline/TGo4HadesOnlinePanelSlots.h"
#include "Go4HadesOnline/TGo4HadesOnlinePanelStatus.h"
#include "Go4HadesOnline/TGo4HadesOnline.h"
#include "Go4HadesOnline/TGo4MdcOnlineSlots.h"
#include "Go4HadesOnline/TGo4MdcOnline.h"
#include "Go4HadesOnline/TGo4StartOnlineSlots.h"
#include "Go4HadesOnline/TGo4StartOnline.h"
#include "Go4HadesOnline/TGo4RichOnlineSlots.h"
#include "Go4HadesOnline/TGo4RichOnline.h"
#include "Go4HadesOnline/TGo4TofOnlineSlots.h"
#include "Go4HadesOnline/TGo4TofOnline.h"
#include "Go4HadesOnline/TGo4TofinoOnlineSlots.h"
#include "Go4HadesOnline/TGo4TofinoOnline.h"
#include "Go4HadesOnline/TGo4ShowerOnlineSlots.h"
#include "Go4HadesOnline/TGo4ShowerOnline.h"
#include "Go4HadesOnline/TGo4HadesConfig.h"
*/
...
void TGo4HadesOnlinePanel::openConfig()
{
	...
	if (!fxTGo4HadesConfigSlots){
	    fxTGo4HadesConfig= new TGo4HadesConfig(fxTGo4GUIRegistry->GetCentralWindow()); 
...
void TGo4HadesOnlinePanel::openMainMon()
{
	TGo4LockGuard glob;
...
void TGo4HadesOnlinePanel::DrawHis( HMonHistAddon * His )
{
    ...
    {
	if(fxTGo4HadesOnline)fxTGo4HadesOnline->DrawHis(His);
 	//if(fxTGo4MdcOnline)fxTGo4MdcOnline->DrawHis(His);
     }
    if (strcmp(His->GetName(),"hRichpulsheight") ==  0 )
    {
	if(fxTGo4HadesOnline)fxTGo4HadesOnline->DrawHis(His);
 	//if(fxTGo4RichOnline)fxTGo4RichOnline->DrawHis(His);
     }
    if (strcmp(His->GetName(),"hStartstrips_start_veto_raw") ==  0 )
    {
	if(fxTGo4HadesOnline)fxTGo4HadesOnline->DrawHis(His);
 	//if(fxTGo4StartOnline)fxTGo4StartOnline->DrawHis(His);
    }
    if (strcmp(His->GetName(),"hTofhits_raw") ==  0 )
    {
	if(fxTGo4HadesOnline)fxTGo4HadesOnline->DrawHis(His);
 	//if(fxTGo4TofOnline)fxTGo4TofOnline->DrawHis(His);
    }
