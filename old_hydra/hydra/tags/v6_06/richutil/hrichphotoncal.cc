...
inline Bool_t HRichPhotonCal::centralpad(Int_t nRow, Int_t nCol, Int_t nSector)
{
...
inline Float_t HRichPhotonCal::sumcharge(Int_t nRow, Int_t nCol, Int_t nSector) {
    sumCharge = 0;
    for (jRow = nRow-1; jRow < nRow+2; jRow++) {
	for (jCol = nCol-1; jCol < nCol+2; jCol++) {
...
inline Bool_t HRichPhotonCal::checkIsolation(Int_t nRow, Int_t nCol, Int_t nSector) {
