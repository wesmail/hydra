...
//
// The probability function for the clusters (size=2) is calculated by using
// energy deposited of the cluster. Two probability numbers are thus provided,
...
Int_t HTofClusterF::execute(void) {
  ...
  Float_t edep1, edep2, edepm, cledep, w1, w2;
  Float_t maxTd, maxXd;
  Int_t clsize = 0;
