...
{    
  ...
  while ((pHitD =(HMdcHit*)fIter1->Next()) != 0 && (pHitD->getChi2()>-0.1)){ 
    ...
    //next line has been change to get rid of the Dubna fitter results with
    //chi square=-1, that is, the results of the cluster finder  
    while ((pHitC =(HMdcHit*)fIter2->Next()) != 0 && (pHitC->getChi2()>-0.1)){ 	
	...
	if(usedC == kFALSE){  
	  ...
	  //next line has been change to get rid of the Dubna fitter results with
	  //chi square=-1, that is, the results of the cluster finder 
	  while ((pHitB =(HMdcHit*)fIter3->Next()) != 0 && (pHitB->getChi2()>-0.1)){ 	
		...
		//next line has been change to get rid of the Dubna fitter results with
		//chi square=-1, that is, the results of the cluster finder
		while ((pHitA =(HMdcHit*)fIter4->Next()) != 0 && (pHitA->getChi2()>-0.1)){ 	
...
{    
  ...
  //next line has been change to get rid of the Dubna fitter results with
  //chi square=-1, that is, the results of the cluster finder
  while ((pHitC =(HMdcHit*)fIter1->Next()) != 0 && (pHitC->getChi2()>-0.1)){ 
    ...
    //next line has been change to get rid of the Dubna fitter results with
    //chi square=-1, that is, the results of the cluster finder
    while ((pHitB =(HMdcHit*)fIter2->Next()) != 0 && (pHitB->getChi2()>-0.1)){ 	
	...
	if(usedB == kFALSE){  
	  ...
	  //next line has been change to get rid of the Dubna fitter results with
	  //chi square=-1, that is, the results of the cluster finder 
	  while ((pHitA =(HMdcHit*)fIter3->Next()) != 0 && (pHitA->getChi2()>-0.1)){ 	
...
{    
  ...
  //next line has been change to get rid of the Dubna fitter results with
  //chi square=-1, that is, the results of the cluster finder 
  while ((pHitB =(HMdcHit*)fIter1->Next()) != 0 && (pHitB->getChi2()>-0.1)){ 
    ...
    //next line has been change to get rid of the Dubna fitter results with
    //chi square=-1, that is, the results of the cluster finder
    while ((pHitA =(HMdcHit*)fIter2->Next()) != 0 && (pHitA->getChi2()>-0.1)){ 	
