// @(#)$Id: hpidalgringpropertiespar.h,v 1.4 2003-11-06 13:37:59 christ Exp $
...
class HPidAlgRingPropertiesPar : public HPidHistogramsCont
{
 ...
 public:
  ...
  Float_t getRichLeptonFraction()
    {
      //The numbers are just a futch factor to have a return value at all...
	return RichLeptonFraction;
    }
  Float_t getRichHadronFraction()
    {
	return RichHadronFraction;
    }

  void setRichLeptonFraction(Float_t lepeff)
    {
      //The numbers are just a futch factor to have a return value at all...
	RichLeptonFraction = lepeff;
    }
  void setRichHadronFraction(Float_t hadeff)
    {
	RichHadronFraction = hadeff;
    }
  ...
  Float_t RichLeptonFraction;
  Float_t RichHadronFraction;
