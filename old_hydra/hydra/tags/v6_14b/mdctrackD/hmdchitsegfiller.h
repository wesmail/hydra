...
class HMdcHitSegFiller : public TObject {
  ...
  public:
    ...
    void setFitParam(HMdcPlane* pl1, HMdcPlane* pl2, Double_t* par,
        HSymMat4* errMat,Double_t errTOSet);
    void calcSegPar(void);
    ...
    void fillSegPar(HMdcSeg* mdcSeg) {mdcSeg->setPar(z,r,theta,phi);}

    void propogErrToSeg(HSymMat4& errMatOut);
    void fillMdcSeg(HMdcSeg* mdcSeg);
