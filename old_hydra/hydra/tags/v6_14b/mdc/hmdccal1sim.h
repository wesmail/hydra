...
protected:
  ...
  Float_t angle1;      // impact angle1 in cell system
  Float_t angle2;      // impact angle2 in cell system
  Float_t minDist1;    // minimum distance to track1
  Float_t minDist2;    // minimum distance to track2
  Float_t error1;      // error of time1
  Float_t error2;      // error of time2
  Float_t tof1;        // tof of track1
  Float_t tof2;        // tof of track2
  Float_t wireOff1;    // signal time on the wire of track1
  Float_t wireOff2;    // signal time on the wire of track2

public:
    HMdcCal1Sim(void) : nTrack1(-99),nTrack2(-99),status1(0),status2(0)
	                ,angle1(-99),angle2(-99),minDist1(-99),minDist2(-99)
	                ,error1(-99),error2(-99),tof1(-99),tof2(-99)
  ...
  ClassDef(HMdcCal1Sim,3) // simulated cal1 hit on a MDC
};
