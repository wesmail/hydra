...
class HMdcFittersArray : public TObject {
  ...
  private:
    HMdcTrackFitter** fitterArr;  // array of point. to HMdcTrackFitterA(H) obj.
...
class HMdc12Fit : public HReconstructor {
  ...
  private:
    ...
    Bool_t fillArrays(HMdcClus * fClst, HMdcList12GroupCells& lCells);
