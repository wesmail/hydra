// $Id: htimelvl1evtfilter.h,v 1.2 2007-08-03 09:56:16 jurkovic Exp $
...
public:
	...
	HTimeLvl1EvtFilter();
        HTimeLvl1EvtFilter(Text_t *name,Text_t *title,TString opt, Int_t m=0,Float_t timecut=100., Float_t MultSmearing=0.);
	~HTimeLvl1EvtFilter();
