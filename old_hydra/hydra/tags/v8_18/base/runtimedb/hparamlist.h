...
protected:
  ...
  Char_t paramType;      // Basic type of the parameter
...
public:
  ...
  void setParamType(const Char_t t) { paramType=t; }
  void setNumParams(const Char_t n) { nParam=n; }
  const Char_t* getParamValue() { return paramValue.Data(); }
  const Char_t getParamType() { return paramType; }
...
public:
  ...
  const Char_t* getParamType() { return paramType.Data(); }
...
public:
  ...
  void add(const Text_t*,const Text_t*,const Char_t type='s',
           const Int_t n=1);
