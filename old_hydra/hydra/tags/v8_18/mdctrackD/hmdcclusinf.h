...
protected:
  ...
  Float_t sigma2;         // sigma1 - Long_t axis, sigma2 - Short_t axis
  Float_t alpha;          // alpha - angle between Long_t axis of cluster and X
...
public:
  ...
  ClassDef(HMdcClusInf,4) // information about clusters in MDC
};
