...
void HMdcClusSim::Streamer(TBuffer &R__b) {
   ...
   if (R__b.IsReading()) {
      ...
      R__b >> nTracks;
      R__b.ReadStaticArray((Int_t*)listTr);
      R__b.ReadStaticArray((Short_t*)nTimes);
      R__b.ReadStaticArray((UChar_t*)nLayers);
      if (R__v > 1) {
        R__b.ReadStaticArray((UChar_t*)nDigiTimes);
        R__b.ReadStaticArray((UChar_t*)trackStatus);
        if(R__v > 2) {
          R__b.ReadStaticArray((Float_t*)xGeant);
          R__b.ReadStaticArray((Float_t*)yGeant);
          R__b >> nNotFakeTracks;
          R__b >> ioSMatchStatus;
        } else {
          R__b >> xGeant[0];
      ...
      R__b.WriteArray((UChar_t*)nLayers, 10);
      R__b.WriteArray((UChar_t*)nDigiTimes, 5);
      R__b.WriteArray((UChar_t*)trackStatus, 5);
      R__b.WriteArray((Float_t*)xGeant, 5);
      R__b.WriteArray((Float_t*)yGeant, 5);
      R__b << nNotFakeTracks;
      R__b << ioSMatchStatus;
