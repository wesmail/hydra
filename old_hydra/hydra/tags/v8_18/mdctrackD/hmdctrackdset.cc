...
HReconstructor* HMdcTrackDSet::hMdcTrackFinder(Char_t* name, Char_t* title) {
...
HReconstructor* HMdcTrackDSet::hMdcClusterToHit(Char_t* name, Char_t* title) {
...
HReconstructor* HMdcTrackDSet::hMdc12Fit(Char_t* name, Char_t* title) {
  if(p12Fit) {
...
void HMdcTrackDSet::exitSetup(Char_t* funNm, Int_t npar, Char_t* use, Int_t inst) {
...
void HMdcTrackDSet::exitSetup(Char_t* funNm,Char_t* className) {
