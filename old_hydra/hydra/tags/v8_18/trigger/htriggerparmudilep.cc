...
//*-- Version: $Id: htriggerparmudilep.cc,v 1.9 2008-05-09 16:18:42 halo Exp $
...
HTriggerParMuDilep::HTriggerParMuDilep(const Char_t* name,const Char_t* title, const Char_t* context)
...
void HTriggerParMuDilep::readline(const Char_t *buf, Int_t *set)
{
...
// Bool_t HTriggerParMuDilep::writeline(Char_t *buf,Int_t s, Int_t m, Int_t c) {
