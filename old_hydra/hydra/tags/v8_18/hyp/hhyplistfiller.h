...
public:
  ...
  void setFilterType(Int_t t){typeDoFilter=t;};
...
private:
  ...
  Int_t				typeDoFilter;		//! type for "Double track rejection"/track cleaning
  TNtuple        *fillertest; //!  Debug Ntuple
  ...
  Bool_t DoFilter(void);// trackcleaner, fill is_valid[PidTrackCand_index] with true/false
