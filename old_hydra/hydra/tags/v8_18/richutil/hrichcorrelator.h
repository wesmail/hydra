// $Id: hrichcorrelator.h,v 1.14 2008-05-09 16:16:32 halo Exp $
// Last update by Thomas Eberl: 02/10/18 15:06:52
//
...
public:
    ...
    HRichCorrelator(Text_t *name,Text_t *title,Char_t* filename,Bool_t style=kFALSE);
    ~HRichCorrelator();
    ...
    ClassDef(HRichCorrelator,2) //ROOT extension
