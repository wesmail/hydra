...
//
//  "fiber=[0-9]"   - hit finder for fiber hodoscopes, add HHodoHitFFiber task
//  "diamond=[0-9]" - hit finder for diamond, add HHodoHitFDiamond task
//  "pionbar=[0-9]" - *NOT USED YET* hit finder for pion bar hodoscopes
//
//  "startcopymod=[0-9]" - adds a task which copies hit information to start hit category
//
///////////////////////////////////////////////////////////////////////////////
...
HTask* HHodoTaskSet::make(const Char_t *sel, Option_t* opt)
{
