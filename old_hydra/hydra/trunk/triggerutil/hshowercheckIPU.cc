// @(#)$Id: hshowercheckIPU.cc,v 1.6 2009-07-15 11:34:10 halo Exp $
...
HShowerCheckIPU::HShowerCheckIPU(const Text_t name[],const Text_t title[],
...
HCategory *pCat;
    ...
    // histograms
    const Char_t *sNames[] = { "hShowerIPUCorrXX", "hShowerIPUCorrYY", "hShowerIPUCorrPos",
