// $Id: hrichpairana.cc,v 1.10 2009-07-15 11:39:22 halo Exp $
...
HRichPairAna::HRichPairAna(const Text_t *name,const Text_t *title) :
...
Bool_t HRichPairAna::removeSingleRing()
{
    ...
    delete pArr;
    return kTRUE;
// # warning "removeSingleRing():end of non void function with no return reached!!! fix me."
}
