// $Id: hpaircutpar.cc,v 1.16 2009-01-21 17:12:44 kempter Exp $
...
//---------------------------------------------------------------------------- 
HPairCutPar::HPairCutPar(const Char_t* name,const Char_t* title,
...
Bool_t HPairCutPar::checkRecursive(HIterator* pIter)
{
    ...
    pIter->Reset();
    if (gHades->isReal() && gHades->getEmbeddingMode() == 0)
    {
	HPair* pPair = 0;
