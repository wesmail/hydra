...
class HMdcTrackFitInOut : public TObject {
  protected:
    ...
    Bool_t   calcInitValue;     // calculate param. initial value
    ...
    // For alignment check
    Int_t    exclLay[6][4];  // exclud layer from fit
  public:
    ...
    void   setCalcInitialValue(void)        {calcInitValue=kTRUE;}
    ...
    void   excludeLayer(Int_t s,Int_t m,Int_t l);
    ...
    Bool_t   getCalcInitValueFlag(void) const    {return calcInitValue;}
    ...
    HMdcCal2ParSim* getCal2ParSim(void)          {return fCal2ParSim;}
    HMdcCal2Par*    getCal2Par(void)             {return fCal2Par;}
