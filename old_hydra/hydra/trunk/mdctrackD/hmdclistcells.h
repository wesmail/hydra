...
class HMdcLayListCells : public TObject {
  ...
  public:
    ...
    void           clear(void) {memset(arr,0,arrSize);}
...
inline UChar_t HMdcLayListCells::getNClusters(Int_t cell) const {
  if(!boundsOk(cell) || nClust==0) return 0;
  return nClust[cell];
};

inline UChar_t HMdcLayListCells::getNRClusters(Int_t cell) const {
  if(!boundsOk(cell) || nRClust==0) return 0;
  return nRClust[cell];
};
...
class HMdcSecListCells : public TObject {
  ...
  public:
    ...
    Int_t          getNUniqueWires(Int_t seg,
    ...
    Int_t          getNUniqueWires(Int_t seg,HMdcList12GroupCells& listCells,
                                   Int_t& nLays) const;
    Int_t          getNUniqueWires2(Int_t seg,
                                   HMdcList12GroupCells& listCells) const;
    Int_t          getNUniqueWires2(Int_t seg,HMdcList12GroupCells& listCells,
                                   Int_t& nLays) const;
