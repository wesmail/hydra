...
HMdcWireOffset::HMdcWireOffset(const Text_t* name,const Text_t* title)
...
void HMdcWireOffset::setOutputRoot(const Char_t *c)
{
...
TDirectory *HMdcWireOffset::Mkdir(TDirectory *dirOld,const Char_t *c, Int_t i, Int_t p=1)    //! Makes new Dir, changes to Dir, returns pointer to new Dir
{
