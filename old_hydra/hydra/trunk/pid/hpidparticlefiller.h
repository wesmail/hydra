// @(#)$Id: hpidparticlefiller.h,v 1.12 2009-07-15 11:40:23 halo Exp $
...
{
public:
                        HPidParticleFiller(const Option_t par[]="");
                        HPidParticleFiller(const Text_t name[],const Text_t title[],
					   const Option_t par[] = "");
    ...
    virtual void        setParameters(const Option_t par[]);
