...
Int_t pidLepSim(TString inFile, Int_t nEvents=0, Int_t startEvt=0)
{
  // real or simulation
  Char_t *context="simulation"; 

  // parameter files
  TString paramFile1="/d/hades/jacek/hydra_dev_sarge/params/pidParams_HardCuts_aug04_sim_kick.root";
  TString paramFile2="";

  Bool_t ora_input = kTRUE;

  // input and output data files
  TString inDir   = "/d/hades10/data/jacek/aug04/dst/urqmdflat_c1c/";
  ...
  //
  // setting for aug04sim
  // RICHRINGCUTS,TOFPVSBETA,TOFINOPVSBETA,SHOWERSUMDIFFVSP
  // 
  
  //HPidAlgStandCuts *pPidAlgStandCuts = new HPidAlgStandCuts(pidNtFile);
  HPidAlgStandCuts *pPidAlgStandCuts = new HPidAlgStandCuts(pidNtFile,"RICHRINGCUTS,TOFPVSBETA,TOFINOPVSBETA,SHOWERSUMDIFFVSP");
