...
#ifndef HHYP_PPIP_PROJECTOR_H
#define HHYP_PPIP_PROJECTOR_H
...
class HHypPPipProjector:public HHypBaseAlgorithm
{
...
public:
  ...
  HHypPPipProjector(Char_t *name_i = NULL, Option_t par[] = NULL);
  
  virtual ~ HHypPPipProjector(void);
  ...
  ClassDef(HHypPPipProjector, 0)  // creates ntuples for PP reactions
};
