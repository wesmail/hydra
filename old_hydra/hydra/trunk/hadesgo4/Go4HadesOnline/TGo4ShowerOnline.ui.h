...
void TGo4ShowerOnline::ShowerDisplayLCD1( Float_t t ){
	ShowerLCDNumber1->display(t);
}

void TGo4ShowerOnline::ShowerDisplayLCD2( Float_t t ) {
	ShowerLCDNumber2->display(t);
}

void TGo4ShowerOnline::ShowerDisplayLCD3( Float_t t ) {
...
void TGo4ShowerOnline::DrawHis( HMonHistAddon* His ) {
	...
	if(ShowerTab->currentPageIndex()==SHW_TAB_CAL){
	 Int_t currentItem = ShowerSectorsCombo->currentItem();
...
void TGo4ShowerOnline::ShowerRawDisplay(Int_t *n)
{
...
void TGo4ShowerOnline::ShowerCalDisplay(Int_t *n)
{
...
void TGo4ShowerOnline::ShowerHitDisplay(Int_t *n)
{
...
void TGo4ShowerOnline::DrawSectors( Int_t n )
{
}
