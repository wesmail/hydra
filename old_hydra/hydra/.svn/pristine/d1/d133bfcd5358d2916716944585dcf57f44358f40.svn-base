...
protected:
 ...
 public:
  ...
  Bool_t          getCut(Char_t * cutID, Float_t & cutValue);//getting cut parameter cutID
  void            setCut(Char_t * cutID, Float_t cutValue);  //setting cut parameter
  void            registerCut(Char_t * cutID);               //called from algs in the init function
