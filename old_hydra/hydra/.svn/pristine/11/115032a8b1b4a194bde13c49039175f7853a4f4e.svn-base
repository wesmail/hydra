...
public:
  HGeomRotation();
  HGeomRotation(const HGeomRotation&);
...
inline HGeomRotation::HGeomRotation(const HGeomRotation& r) {
...
inline Double_t HGeomRotation::diff2(const HGeomRotation& r) const {
...
inline void HGeomRotation::print() {
