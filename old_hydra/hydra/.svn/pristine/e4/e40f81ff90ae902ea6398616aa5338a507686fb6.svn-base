...
HMdcDeDxHists::HMdcDeDxHists(const Text_t* name,const Text_t* title)
...
void HMdcDeDxHists::printStatus()
{
    ...
    SEPERATOR_msg("-",60);
    INFO_msg(10,HMessageMgr::DET_MDC,"HMdcDeDxHistsSetup:");
    /*
...
Int_t HMdcDeDxHists::execute(void)
{
	...
	while ((trkcand=(HMdcTrkCand *)trkcanditer->Next())!=0)
	{
	    ...
	    if(size==-1)
	    {
		Error("HMdcDeDxHists::execute()","Size of wire array not set properly!");
		exit(1);
	    }
