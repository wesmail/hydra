  ...
  if(pMatch->getARichInd(1)>-1)
    {
      ...
      //compare 0 and 1
      dist[0]=TMath::Power(abs(pRing0->getPhi()-fMdcPhi),2);
      dist[0]+=TMath::Power(abs(pRing0->getTheta()-fMdcTheta),2);

      dist[1]=TMath::Power(abs(pRing1->getPhi()-fMdcPhi),2);
      dist[1]+=TMath::Power(abs(pRing1->getTheta()-fMdcTheta),2);
  ...
  if(pMatch->getARichInd(2)>-1)
    {
      ...
      dist[2]=TMath::Power(abs(pRing2->getPhi()-fMdcPhi),2);
      dist[2]+=TMath::Power(abs(pRing2->getTheta()-fMdcTheta),2);
