...
public:
    HTofinoDigitPar(const Char_t* name ="TofinoDigitPar",
	      const Char_t* title  ="digitisation parameters for Tofino",
	      const Char_t* context="TofinoDigitParProduction");
    ~HTofinoDigitPar();
    ...
    Float_t calcDistance          (Int_t nSector, Int_t nCell, Float_t fY);
