// $Id: hpairdata.cc,v 1.16 2006-08-16 15:42:18 halo Exp $
// Author: Thomas.Eberl@ph.tum.de, last modified : 2006-06-28 13:41:27
//
// ---------------------------------------------------------------------------
...
":rampl2:rlocmax42:mom1:mom2:doubleHit:qspline1:qspline2:innerchisquare1"
":innerchisquare2:outerchisquare1:outerchisquare2:distancetovertex1"
":distancetovertex2:closestlepisfitted1:closestlepisfitted2"
":closesthadisfitted1:closesthadisfitted2:opangclosestlep1:opangclosestlep2"
":opangclosesthad1:opangclosesthad2:IOm_chi2_1:IOm_chi2_2:pairvertx:pairverty"
":pairvertz:pairdistx:pairdisty:pairdistz:pairdist:evtNr:DSflag:trigDec:evtVertX:evtVertY:evtVertZ:run";

const Int_t HPairData::DATAITEMS = 95;
// ---------------------------------------------------------------------------
HPairData::HPairData() 
{
    reset();
...
Float_t* HPairData::getArray(void) const
{
    ...
    arr[71]=(Float_t) bClosestLepIsFitted1;
    arr[72]=(Float_t) bClosestLepIsFitted2;
    arr[73]=(Float_t) bClosestHadIsFitted1;
    arr[74]=(Float_t) bClosestHadIsFitted2;

    arr[75]=fAngleToClosestLep1;
    arr[76]=fAngleToClosestLep2;
    arr[77]=fAngleToClosestHad1;
    arr[78]=fAngleToClosestHad2;
    ...
    arr[88]=(Float_t) nEvtNr;
    arr[89]=(Float_t) nDSflag;
    arr[90]=(Float_t) nTrigDec;
