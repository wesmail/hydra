// $Id: hrichcutpair.cc,v 1.4 2009-07-15 11:39:17 halo Exp $
...
HRichCutPair::HRichCutPair(const Text_t *name,const Text_t *title)
...
Bool_t HRichCutPair::switchTo(const Char_t *s, Bool_t clear)
{
    TString state(s);
...
void HRichCutPair::printCutList(const Char_t* s) {
    if (s) switchTo(s);
