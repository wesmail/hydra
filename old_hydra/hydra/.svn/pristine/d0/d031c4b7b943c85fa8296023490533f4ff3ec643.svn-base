...
class HMdcEff : public TObject {
  protected:
    ...
    Double_t errN1;
    Double_t n2m;         // num. of Double_t hits ( two fired close cell)
    Double_t errN2m;      // at calculation of eff. of N wires (from Nf to Nl)
    Double_t n2b;         // n2m = Double_t hits num.for pairs Nf:Nf+1 ... Nl-1:Nl
    Double_t errN2b;      // n2b = Double_t hits num.for pairs Nf-1:Nf and Nl:Nl+1
...
class HMdcEfficiencyLayer : public TObject {
  friend class HMdcEfficiency;
  friend class HMdcEfficiencyMod;
  protected:
    Short_t   sector;
    Short_t   module;
    Short_t   layer;
    ...
    Int_t*    n2;         // n2[cell number] num. Double_t hits (this cell and
...
class HMdcEfficiencyMod : public TObject {
  ...
  public:
    ...
    void  fillTimesCls(HMdcCal1* cal, Bool_t isGnt)    {fillTimes(cal,isGnt,3);}
    void  fillTimesSelCls(HMdcCal1* cal, Bool_t isGnt) {fillTimes(cal,isGnt,6);}
...
class HMdcEfficiencySec : public TObject {
  ...
  public:
    ...
    TCanvas* getCanvasProj(void) {
      return (TCanvas*)gROOT->FindObject(nameCanvProj);}
    TCanvas* getCanvasHits(void) {
      return (TCanvas*)gROOT->FindObject(nameCanvHits);}
...
public:
    ...
    static void savePDF(Char_t* fileName, Char_t* type="Pattern");
  ...
  private:  
    ...
    static void saveAs(Char_t* fileName, Char_t* type="Pattern");
    static void makePDF(Char_t* psFile);
