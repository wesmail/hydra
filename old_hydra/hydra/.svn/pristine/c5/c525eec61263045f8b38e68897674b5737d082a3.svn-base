// $Id: hpairgeantdata.cc,v 1.11 2005-10-26 10:25:03 eberl Exp $
// Author: Thomas.Eberl@ph.tum.de, last modified : 2005-10-26 12:24:14
...
Bool_t HPairGeantData::init(HPairSim* p)
{
    ...
    // in case of pluto events propagate the geant parent track and parend ID
    pKine1->getGenerator(fGgeninfo1,fGgeninfo1_1,fGgeninfo2_1);
    pKine2->getGenerator(fGgeninfo2,fGgeninfo1_2,fGgeninfo2_2);
