...
class HKickTrackF : public HReconstructor {
private:
...
protected:
  ...
  Double_t fMaxXPull[2]; //For low and high ghi (= 90 - theta)
  Double_t fGhiChange; //Frontier betw low and high ghi
  ...
  void setKickParIo(HRuntimeDb *rtdb);
public:
