...
HCategory* HRichDetector::buildSimMatrixCat(Text_t *classname,Float_t fillRate) {
...
HCategory *HRichDetector::buildCategory(Cat_t cat) {
 switch (cat) {
  ...
  case catRichGeantRaw : return buildSimMatrixCat("HGeantRichPhoton",1);
  case catRichGeantRaw+1 : return buildSimMatrixCat("HGeantRichDirect",1);
  default : return NULL;
 }
}
