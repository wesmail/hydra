...
public:
    HMdcWireStat(const char* name ="MdcWireStat",
                 const char* title  ="Mdc lookup table for wire stat",
                 const char* context="MdcWireStatProduction");
    ~HMdcWireStat();
    ...
    void    setEfficiency(Int_t sec,Int_t mod,Int_t lay,Int_t cell,Int_t eff) {efficiency[sec][mod]->SetBinContent(cell+1,lay+1,eff);}
