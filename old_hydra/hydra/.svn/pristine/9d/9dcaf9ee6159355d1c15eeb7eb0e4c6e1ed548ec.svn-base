...
//  RefHit (because it was supposed to contain position
//  of Reference Hit, which it is NOT doing. But as this
//  misleading name was fixed we didnt want to change it.)
//  NOW the parameter contains two time cuts
//  The first one is done by the unpacker BEFORE data is
//  copied to the raw category
//  The second is supposed to be used on the cal data by
//  the hitfinder before starting to find a hit.
//
/////////////////////////////////////////////////////////////
using namespace std;
