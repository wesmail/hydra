...
# C compiler flags
CC         := gcc
SO_C_FLAGS  = $(OPTLEVEL) -Wall -pipe -pthread -fPIC $(DEBUGOPT) $(CPP_FLAGS)
APP_C_FLAGS = $(OPTLEVEL) -Wall -pipe -pthread $(DEBUGOPT) $(CPP_FLAGS)

# C++ compiler flags
CXX          := g++
SO_CXX_FLAGS  = $(OPTLEVEL) -Wall -pipe -pthread -fPIC $(DEBUGOPT) $(CPP_FLAGS)
APP_CXX_FLAGS = $(OPTLEVEL) -Wall -pipe -pthread $(DEBUGOPT) $(CPP_FLAGS)
