...
void TGo4TofOnlineSlots::StartMonitor()
{
  ...
  //-------------------------Tof------------------------------------
    fxTGo4GUIRegistry->ReDirectObject("hTofhits_raw",this,true);
...
{	
	...
	fxTGo4TofOnlineStatus->OverWriteLocalObject(fxdata);
	...
	if(fxTGo4TofOnline!=0)  UpdateGUI(fxdata->GetName());
}	
void TGo4TofOnlineSlots::UpdateGUI(const char *ObjName)
{
  TGo4LockGuard Global;

  TObject *Obj = fxTGo4TofOnlineStatus->GetObjectfromLocalList(ObjName);
