...
Int_t HChannelListMaker::getPid (const Char_t* nomen)
{Int_t pid;
...
void HChannelListMaker::printChString (const Char_t* marker, Int_t idx, Int_t chN, FILE* otp)
{Int_t k;
...
void HChannelListMaker::typeChString (const Char_t* marker, Int_t idx, Int_t chN)
{Int_t k;
     ...
     Int_t* pNmb, Int_t* posPID, Int_t* nNmb, Int_t* negPID, Int_t* tNmb, Int_t* totPID)
{
 ...
 FILE*       otp;
 const Char_t*       chListMaker_file_name = "channelListMaker.txt";
