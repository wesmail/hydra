...
#define PID_NTUPLE_VARS_24 "p_n_corr_tracks:p_q_io_matching:p_mdc_inner_dedx:p_mdc_outer_dedx:p_shw_row:p_shw_col:p_angle_to_closest_lep:p_angle_to_closest_had:p_closest_lep_isfitted:p_closest_had_isfitted"
//#define PID_NTUPLE_VARS_25 "p_track_z_rk:p_track_z_kick:p_track_z_spline"
////////////////////////////////////////////////////////////////////////////////
// HPidPerformaceTest                                                         //
...
class HPidPerformaceTest : public HSUDummyRec{
    public:
        HPidPerformaceTest(const char *pOutFileName="pid_ntuple_out.root");
        ~HPidPerformaceTest();
    ...
    private:
	  ...
	  p_angle_to_closest_lep,p_angle_to_closest_had,p_closest_lep_isfitted,p_closest_had_isfitted
        };
