// @(#)$Id: hpidalgringpropertiespar.h,v 1.11 2006-08-16 16:13:34 halo Exp $
...
class HPidAlgRingPropertiesPar : public HPidHistogramsCont
{
 ...
 public:
  ...
  //This is not a nice thing - we assume that we always have three bins in polar angle
  //In priciple one should handle this dynamically - implementation pending
  Int_t getThetaBin(Float_t fKickTheta) const
    {
      if(fKickTheta<=45) return 0;
      if(fKickTheta<=90) return 1;
      return -1;
    }
