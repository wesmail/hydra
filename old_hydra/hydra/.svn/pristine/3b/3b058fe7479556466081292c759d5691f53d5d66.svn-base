...
void HQAHistograms::bookHistKick() {
  ...
  for(Int_t s=0; s<6; s++){//for TOFINO/SHOWER
    ...
    trackingKick12M_sys0[s]->SetXTitle("P [MeV]");
  ...
  for(Int_t s=0; s<6; s++){//for TOF
    ...
    trackingKick12M_sys1[s]->SetXTitle("P [MeV]");
  ...
  for(Int_t s=0; s<6; s++){ //for TOFINO/SHOWER
    ...
    trackingKick123_sys0[s]->SetXTitle("P [MeV]");
  ...
  for(Int_t s=0; s<6; s++){//for TOF
    ...
    trackingKick123_sys1[s]->SetXTitle("P [MeV]");
  ...
  for(Int_t s=0; s<6; s++){//for TOFINO/SHOWER
    ...
    trackingSpline_sys0[s]->SetXTitle("P [MeV]");
  ...
  for(Int_t s=0; s<6; s++){//for TOF
    ...
    trackingSpline_sys1[s]->SetXTitle("P [MeV]");
