...
void insertPidParamToOracle(){
    ...
    TString *pInFileName = new TString("/home/tachrist/hades/projects/current/phd/RichMdcCorrelation/output/Aug04/PreliminaryPidTrkFillerParAug04.root");
    ...
    TString *pDesc = new TString("Dummy pid trackfiller parameters delete me!");
