...
HTofinoCalPar::HTofinoCalPar(const Char_t* name,const Char_t* title,
...
//////////
void HTofinoCalPar::setCellClassName(const Char_t* pszName)
...
//reading and initializing  calibration parameters from ascii file (HAsciiKey format)
  ...
  Int_t sect, cell;
  Float_t slope, offset, deltaslope, deltaoffset, cfdthresh, len;
  Float_t adcthresh, adcpedestal;
  HLocation loc;
  HTofinoCalParCell *pCell;
...
//writing calibration parameters into ascii file (HAsciiKey format)
  ...
  Int_t iDistParamType;
  Int_t sect, cell;
  Float_t slope, offset, cfdthresh, adcthresh, adcpedestal;
  HLocation loc;
  HTofinoCalParCell* pCell;
...
void HTofinoCalPar::Print() {
  Int_t i, j;
  Float_t slope, offset, coordpos, cfdthresh, len;
