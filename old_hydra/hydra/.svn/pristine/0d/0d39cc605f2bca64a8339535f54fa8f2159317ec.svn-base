// $Id: hrichmon.cc,v 1.15 2009-07-15 11:39:22 halo Exp $
// Last update by Thomas Eberl: 03/07/14 13:52:52
//
using namespace std;
#include "hrichmon.h"
...
HRichMon::HRichMon(const Text_t *name,const Text_t *title) :
...
HRichMon::HRichMon(const Text_t *name,const Text_t *title,const Char_t *swt,const Char_t* geofilename) :
  HReconstructor(name,title)
{
...
void HRichMon::resetMemCharges(){
    for (Int_t i=0;i<nSec*nPads+1;i++){
	memCharges[i] = 0;
    }
}
...
void HRichMon::initWindow(){
    //gStyle->SetOptDate(1);
    window = new TCanvas("RICH_Evt_Monitor","RICH_Evt_Monitor",500,550);
    window->Draw("x3d");
...
void HRichMon::printWindow()
{
    ...
    eps+=".eps";
    gif+=".gif";
    eps.Prepend("/home/teberl/evts/nov01Sgen5c2c/");
    gif.Prepend("/home/teberl/evts/nov01Sgen5c2c/");
