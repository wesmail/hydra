...
HTofOfflineR::HTofOfflineR(const Text_t *name,const Text_t *title) : HReconstructor (name,title) {
  fHitTofCat=NULL;
  fRawTofCat=NULL;
  fCalTofinoCat=NULL;
  fRawTofinoCat=NULL;
...
void HTofOfflineR::setOutputAscii(const Char_t *c){
    if (fNameAsciiTofOfflineR) delete fNameAsciiTofOfflineR;
    fNameAsciiTofOfflineR = new Char_t[strlen(c)+1];
    strcpy(fNameAsciiTofOfflineR, c);
}

void HTofOfflineR::setOutputRoot(const Char_t *c){
    if (fNameRootTofOfflineR) delete fNameRootTofOfflineR;
