// $Id: hrichhistofiller.cc,v 1.16 2009-02-26 17:35:35 jurkovic Exp $
...
void HRichHistoFiller::fillHistos(TObjArray *subsets,Char_t * catIdentifier)
{
...
void HRichHistoFiller::makeCutCombinatorics(TObjArray* t,Int_t level,Char_t* catId)
{
