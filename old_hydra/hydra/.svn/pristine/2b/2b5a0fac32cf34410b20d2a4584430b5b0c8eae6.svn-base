...
class HMdcLookUpTbCell: public TObject {
  ...
  public:
    ...
    Short_t getNLines(void)        {return line;}
    Short_t getYBinMin(void)       {return yBinMin;}
    Short_t getYBinMax(void)       {return yBinMax;}
    Short_t getXBinMin(Short_t yb) {return xBinMin[yb];}
    Short_t getXBinMax(Short_t yb) {return xBinMax[yb];}
