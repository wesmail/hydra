...
HRpcCalPar::HRpcCalPar(const char* name,const char* title,
		       const char* context)
...
void HRpcCalPar::readline(const char *buf, Int_t *set) {
...
Bool_t HRpcCalPar::writeline(char *buf, Int_t sec, Int_t col, Int_t cell) {
