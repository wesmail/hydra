...
void HMdcTaskSet::getSetupContainer()
{
    ...
    // retrieves the pointer to the sub setuo objects.
...
void HMdcTaskSet::printOptions()
{
    ...
    printf("#################################### HMdcTasKSet ###########################################\n");
    printf("* SELECTION : rtdb               -- init from HMdcSetup                                    *\n");
    printf("*             no selection       -- init from OptionString                                 *\n");
    printf("* -----------------------------------------------------------------------------------------*\n");
    printf("* OPTIONS   :                                                                              *\n");
    printf("* -----------------------------------------------------------------------------------------*\n");
    printf("* real  (default),simulation or                                                            *\n");
    printf("* merge                          -- real, simulation or merged data                        *\n");
