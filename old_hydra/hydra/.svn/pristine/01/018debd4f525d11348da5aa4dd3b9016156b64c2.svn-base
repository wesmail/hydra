...
//Histograms for studying residuals in projections 
  ...
  fResTof5Y = new TH1F*[fMetaHistNum]; 
  ...
  for(Int_t index=0;index<fMetaHistNum;index++){
    ...
    sprintf(tmp,"%s%i%s%i","fResTof0X_",index,"_Sector_",sector);
    fResTof0X[index] = new TH1F(tmp,title,Tbin,Tmin,Tmax);
    sprintf(tmp,"%s%i%s%i","fResTof0Y_",index,"_Sector_",sector);
    fResTof0Y[index] = new TH1F(tmp,title,Tbin,Tmin,Tmax);
    sprintf(tmp,"%s%i%s%i","fResTof1X_",index,"_Sector_",sector);
    fResTof1X[index] = new TH1F(tmp,title,Tbin,Tmin,Tmax);
    sprintf(tmp,"%s%i%s%i","fResTof1Y_",index,"_Sector_",sector);
    fResTof1Y[index] = new TH1F(tmp,title,Tbin,Tmin,Tmax);
    sprintf(tmp,"%s%i%s%i","fResTof2X_",index,"_Sector_",sector);
    fResTof2X[index] = new TH1F(tmp,title,Tbin,Tmin,Tmax);
    sprintf(tmp,"%s%i%s%i","fResTof2Y_",index,"_Sector_",sector);
    fResTof2Y[index] = new TH1F(tmp,title,Tbin,Tmin,Tmax);
    sprintf(tmp,"%s%i%s%i","fResTof3X_",index,"_Sector_",sector);
    fResTof3X[index] = new TH1F(tmp,title,Tbin,Tmin,Tmax);
    sprintf(tmp,"%s%i%s%i","fResTof3Y_",index,"_Sector_",sector);
    fResTof3Y[index] = new TH1F(tmp,title,Tbin,Tmin,Tmax);
    sprintf(tmp,"%s%i%s%i","fResTof4X_",index,"_Sector_",sector);
    fResTof4X[index] = new TH1F(tmp,title,Tbin,Tmin,Tmax);
    sprintf(tmp,"%s%i%s%i","fResTof4Y_",index,"_Sector_",sector);
    fResTof4Y[index] = new TH1F(tmp,title,Tbin,Tmin,Tmax);
    sprintf(tmp,"%s%i%s%i","fResTof5X_",index,"_Sector_",sector);
    fResTof5X[index] = new TH1F(tmp,title,Tbin,Tmin,Tmax);
    sprintf(tmp,"%s%i%s%i","fResTof5Y_",index,"_Sector_",sector);
    fResTof5Y[index] = new TH1F(tmp,title,Tbin,Tmin,Tmax);
    sprintf(tmp,"%s%i%s%i","fResTof6X_",index,"_Sector_",sector);
    fResTof6X[index] = new TH1F(tmp,title,Tbin,Tmin,Tmax);
    sprintf(tmp,"%s%i%s%i","fResTof6Y_",index,"_Sector_",sector);
    fResTof6Y[index] = new TH1F(tmp,title,Tbin,Tmin,Tmax);
    sprintf(tmp,"%s%i%s%i","fResTof7X_",index,"_Sector_",sector);
    fResTof7X[index] = new TH1F(tmp,title,Tbin,Tmin,Tmax);
    sprintf(tmp,"%s%i%s%i","fResTof7Y_",index,"_Sector_",sector);
    fResTof7Y[index] = new TH1F(tmp,title,Tbin,Tmin,Tmax);
  }
  //binning
  ...
  sprintf(tmp,"%s%s%i","fAllResTof0X","_Sector_",sector);
  fAllResTof0X = new TH1F(tmp,title,TbinA,TminA,TmaxA);
  sprintf(tmp,"%s%s%i","fAllResTof0Y","_Sector_",sector);
  fAllResTof0Y = new TH1F(tmp,title,TbinA,TminA,TmaxA);
  sprintf(tmp,"%s%s%i","fAllResTof1X","_Sector_",sector);
  fAllResTof1X = new TH1F(tmp,title,TbinA,TminA,TmaxA);
  sprintf(tmp,"%s%s%i","fAllResTof1Y","_Sector_",sector);
  fAllResTof1Y = new TH1F(tmp,title,TbinA,TminA,TmaxA);
  sprintf(tmp,"%s%s%i","fAllResTof2X","_Sector_",sector);
  fAllResTof2X = new TH1F(tmp,title,TbinA,TminA,TmaxA);
  sprintf(tmp,"%s%s%i","fAllResTof2Y","_Sector_",sector);
  fAllResTof2Y = new TH1F(tmp,title,TbinA,TminA,TmaxA);
  sprintf(tmp,"%s%s%i","fAllResTof3X","_Sector_",sector);
  fAllResTof3X = new TH1F(tmp,title,TbinA,TminA,TmaxA);
  sprintf(tmp,"%s%s%i","fAllResTof3Y","_Sector_",sector);
  fAllResTof3Y = new TH1F(tmp,title,TbinA,TminA,TmaxA);
  sprintf(tmp,"%s%s%i","fAllResTof4X","_Sector_",sector);
  fAllResTof4X = new TH1F(tmp,title,TbinA,TminA,TmaxA);
  sprintf(tmp,"%s%s%i","fAllResTof4Y","_Sector_",sector);
  fAllResTof4Y = new TH1F(tmp,title,TbinA,TminA,TmaxA);
  sprintf(tmp,"%s%s%i","fAllResTof5X","_Sector_",sector);
  fAllResTof5X = new TH1F(tmp,title,TbinA,TminA,TmaxA);
  sprintf(tmp,"%s%s%i","fAllResTof5Y","_Sector_",sector);
  fAllResTof5Y = new TH1F(tmp,title,TbinA,TminA,TmaxA);
  sprintf(tmp,"%s%s%i","fAllResTof6X","_Sector_",sector);
  fAllResTof6X = new TH1F(tmp,title,TbinA,TminA,TmaxA);
  sprintf(tmp,"%s%s%i","fAllResTof6Y","_Sector_",sector);
  fAllResTof6Y = new TH1F(tmp,title,TbinA,TminA,TmaxA);
  sprintf(tmp,"%s%s%i","fAllResTof7X","_Sector_",sector);
  fAllResTof7X = new TH1F(tmp,title,TbinA,TminA,TmaxA);
  sprintf(tmp,"%s%s%i","fAllResTof7Y","_Sector_",sector);
  fAllResTof7Y = new TH1F(tmp,title,TbinA,TminA,TmaxA);
...
void HMdcMetaAligner::setSlopeCut(Float_t SlopeCut=0.1)
{  
  //
...
void HMdcMetaAligner::setParContainers(void)
{
  ...
  if(!fTofGeomPar){
    fTofGeomPar=(HTofGeomPar*)gHades->getSetup()->createDetGeomPar("Tof");
  }      
}
...
void HMdcMetaAligner::setGeomAuxParSim(Int_t ind=0, Float_t eu1=0, Float_t eu2=0, 
				   Float_t eu3=0, Float_t tr1=0, 
				   Float_t tr2=0, Float_t tr3=0){
  //
...
void HMdcMetaAligner::setMetaGeomAuxParSim(Int_t ind=0, Float_t eu1=0, Float_t eu2=0, 
				   Float_t eu3=0, Float_t tr1=0, 
				   Float_t tr2=0, Float_t tr3=0)
{
  //
					       ...
					       HGeomVector traM)
{
  ...
  //  
  // Two methods are defined. One suposes target at (0,0,0)
  // (fTar =kTRUE) and the other uses the hit slopes.
  //
...
Int_t HMdcMetaAligner::isInsideMetaWindow(Int_t sector,
  ...
  if (pHitT->getSector() == sector) {
    if (tofModule == 0){
      fAllResTof0X->Fill(xTof-proj.getX());
      fAllResTof0Y->Fill(yTof-proj.getY());	
    }	    
    if (tofModule == 1){
      fAllResTof1X->Fill(xTof-proj.getX());
      fAllResTof1Y->Fill(yTof-proj.getY());	
    }	    
    if (tofModule == 2){
      fAllResTof2X->Fill(xTof-proj.getX());
      fAllResTof2Y->Fill(yTof-proj.getY());	
    }	    
    if (tofModule == 3){
      fAllResTof3X->Fill(xTof-proj.getX());
      fAllResTof3Y->Fill(yTof-proj.getY());	
    }	    
    if (tofModule == 4){
      fAllResTof4X->Fill(xTof-proj.getX());
      fAllResTof4Y->Fill(yTof-proj.getY());	
    }	    
    if (tofModule == 5){
      fAllResTof5X->Fill(xTof-proj.getX());
      fAllResTof5Y->Fill(yTof-proj.getY());	
    }	    
    if (tofModule == 6){
      fAllResTof6X->Fill(xTof-proj.getX());
      fAllResTof6Y->Fill(yTof-proj.getY());	
    }	    
    if (tofModule == 7){
      fAllResTof7X->Fill(xTof-proj.getX());
      fAllResTof7Y->Fill(yTof-proj.getY());	
    }
...
{   
  ...
  if(fMinOff==kTRUE){ //if  no minimization is performed  
    fillHistograms(0);  
...
void HMdcMetaAligner::fillMetaHistograms (Int_t Mindex, Int_t select = 0){ 
  //
  ...
  for (Int_t i=0;i<entries;i++) { 
    ...
    if(det==0) fResTof0X[Mindex]->Fill(lHit->getX()-projMP.getX());
    if(det==0) fResTof0Y[Mindex]->Fill(lHit->getY()-projMP.getY());
    if(det==1) fResTof1X[Mindex]->Fill(lHit->getX()-projMP.getX());
    if(det==1) fResTof1Y[Mindex]->Fill(lHit->getY()-projMP.getY());
    if(det==2) fResTof2X[Mindex]->Fill(lHit->getX()-projMP.getX());
    if(det==2) fResTof2Y[Mindex]->Fill(lHit->getY()-projMP.getY());
    if(det==3) fResTof3X[Mindex]->Fill(lHit->getX()-projMP.getX());
    if(det==3) fResTof3Y[Mindex]->Fill(lHit->getY()-projMP.getY());
    if(det==4) fResTof4X[Mindex]->Fill(lHit->getX()-projMP.getX());
    if(det==4) fResTof4Y[Mindex]->Fill(lHit->getY()-projMP.getY());
    if(det==5) fResTof5X[Mindex]->Fill(lHit->getX()-projMP.getX());
    if(det==5) fResTof5Y[Mindex]->Fill(lHit->getY()-projMP.getY());
    if(det==6) fResTof6X[Mindex]->Fill(lHit->getX()-projMP.getX());
    if(det==6) fResTof6Y[Mindex]->Fill(lHit->getY()-projMP.getY());
    if(det==7) fResTof7X[Mindex]->Fill(lHit->getX()-projMP.getX());
    if(det==7) fResTof7Y[Mindex]->Fill(lHit->getY()-projMP.getY());
  }
}

void HMdcMetaAligner::fillHistograms (Int_t index, Int_t select = 0){ 
  //
  // Performs the graphical output from obtained parameters
  //   
...
void HMdcMetaAligner::minfit(Int_t fix, HGeomVector fE, HGeomVector fT){ 
  ...
  //FIXING 
  if(fix == 1) {    //fixing angles
    minuit->FixParameter(0);     
    minuit->FixParameter(1); 
    minuit->FixParameter(2);
  }
  if(fix == 2) {    //fixing translations
    minuit->FixParameter(3);     
    minuit->FixParameter(4); 
    minuit->FixParameter(5); 
  }
  //FIXING
  if(fUseSlopeCut)    //when cut in slopes, fixing the Z translation
    minuit->FixParameter(5); 
...
8  rotmat[2][2]=(cos(segu)); 
  */
  ...
  Int_t detector = pAlign->getDetector();
