...
// Last update by Laura Fabbietti: 23/02/2000 13:15:42
//
#ifndef HRICHTRACK_H
#define HRICHTRACK_H
#pragma interface
...
class HRichTrack : public HDataObject {
public:
    HRichTrack() {}
    ~ HRichTrack() {}
    Int_t clear();
    ...
    Int_t  Compare(TObject *obj) { // HRichTrack is sorted by the pad address
       if ( m_Address >= ((HRichTrack*)obj)->m_Address ) return 1;
       else return -1;
    }
