// $Id: hpairhisto.cc,v 1.3 2008-05-09 16:14:32 halo Exp $
...
TH1*  HPairHisto::getHistoByBaseName(const Char_t* suppliedname,const Char_t* add)
{
    TH1 *h=0;
...
TH1F* HPairHisto::getHCorrCodeGeant(const Char_t * c,const Char_t *b)
{
    TString *s=0;
...
TH2F* HPairHisto::getHMomCorrCodeGeant(const Char_t * c,const Char_t *b)
{
    TString *s=0;
...
TH2F* HPairHisto::getHCorrCodeGeantPolarAngle(const Char_t * c,const Char_t *b)
{
    TString *s=0;
...
TH2F* HPairHisto::getHPartCorrCodeGeant(const Char_t * c,const Char_t *b)
{
    TString *s=0;
...
TH2F* HPairHisto::getHGeantMomKickMomDiff(const Char_t * c,const Char_t *b)
{
    TString *s=0;
...
TH1F* HPairHisto::getHPseudoRapidity(const Char_t * c,const Char_t *b)
{
    TString *s=0;
...
TH1F* HPairHisto::getHRapidity(const Char_t * c,const Char_t *b)
{
    TString *s=0;
...
TH1F* HPairHisto::getHBeta(const Char_t * c,const Char_t *b)
{
    TString *s=0;
...
TH1F* HPairHisto::getHKickPull(const Char_t * c,const Char_t *b)
{
    TString *s=0;
...
TH2F* HPairHisto::getHMomChrgvsPolarAngle(const Char_t * c,const Char_t *b)
{
    TString *s=0;
...
TH2F* HPairHisto::getHMomtChrgvsPolarAngle(const Char_t * c,const Char_t *b)
{
    TString *s=0;
...
TH2F* HPairHisto::getHPolarHitChrgvsAzimuth(const Char_t * c,const Char_t *b)
{
    TString *s=0;
...
TH1F* HPairHisto::getHOpeningAngle(const Char_t * c,const Char_t *b)
{
    TString *s=0;
...
TH1F* HPairHisto::getHOpeningAngleVarBin(const Char_t * c,const Char_t *b)
{
    TString *s=0;
    if (b==NULL) s=new TString(getHOpeningAngleBasename());
    else s=new TString(b);
...
TH1F* HPairHisto::getHPolarAngle(const Char_t * c,const Char_t *b)
{
    TString *s=0;
...
TH1F* HPairHisto::getHAzimuthalAngle(const Char_t * c,const Char_t *b)
{
    TString *s=0;
...
TH1F* HPairHisto::getHInvMass(const Char_t * c,const Char_t *b)
{
    TString *s=0;
...
TH1F* HPairHisto::getHInvMassVarBin(const Char_t * c,const Char_t *b)
{
    TString *s=0;
    if (b==NULL) s=new TString(getHInvMassBasename());
    else s=new TString(b);
...
TH1F* HPairHisto::getHTof(const Char_t * c,const Char_t *b)
{
    TString *s=0;
...
TH2F* HPairHisto::getHRingXY(const Char_t * c,const Char_t *b)
{
    TString *s=0;
...
TH1F* HPairHisto::getHRingRadius(const Char_t * c,const Char_t *b)
{
    TString *s=0;
...
TH2F* HPairHisto::getHRingRadiusTheta(const Char_t * c,const Char_t *b)
{
    TString *s=0;
...
TH2F* HPairHisto::getHInvMassMomt(const Char_t * c,const Char_t *b)
{
    TString *s=0;
...
TH2F* HPairHisto::getHMomtRapidity(const Char_t * c,const Char_t *b)
{
    TString *s=0;
...
TH2F* HPairHisto::getHInvMassRapidity(const Char_t * c,const Char_t *b)
{
    TString *s=0;
...
TH2F* HPairHisto::getHInvMassOpang(const Char_t * c,const Char_t *b)
{
    TString *s=0;
...
TH2F* HPairHisto::getHMomtOpang(const Char_t * c,const Char_t *b)
{
    TString *s=0;
...
TH2F* HPairHisto::getHRapidityOpang(const Char_t * c,const Char_t *b)
{
    TString *s=0;
...
TH1F* HPairHisto::getHRingAmplitude(const Char_t * c,const Char_t *b)
{
    TString *s=0;
...
TH2F* HPairHisto::getHRingAmplitudeTheta(const Char_t * c,const Char_t *b)
{
    TString *s=0;
...
TH1F* HPairHisto::getHRingPadNr(const Char_t * c,const Char_t *b)
{
    TString *s=0;
...
TH2F* HPairHisto::getHRingPadNrTheta(const Char_t * c,const Char_t *b)
{
    TString *s=0;
...
TH1F* HPairHisto::getHRingLocMax4(const Char_t * c,const Char_t *b)
{
    TString *s=0;
...
TH2F* HPairHisto::getHRingLocMax4Theta(const Char_t * c,const Char_t *b)
{
    TString *s=0;
...
TH1F* HPairHisto::getHRingPM(const Char_t * c,const Char_t *b)
{
    TString *s=0;
...
TH2F* HPairHisto::getHRingPMTheta(const Char_t * c,const Char_t *b)
{
    TString *s=0;
...
TH1F* HPairHisto::getHRingHT(const Char_t * c,const Char_t *b)
{
    TString *s=0;
...
TH2F* HPairHisto::getHRingHTTheta(const Char_t * c,const Char_t *b)
{
    TString *s=0;
...
TH1F* HPairHisto::getHRingCentroid(const Char_t * c,const Char_t *b)
{
    TString *s=0;
...
TH2F* HPairHisto::getHRingCentroidTheta(const Char_t * c,const Char_t *b)
{
    TString *s=0;
...
TH1F* HPairHisto::getHRingAvChrg(const Char_t * c,const Char_t *b)
{
    TString *s=0;
...
TH2F* HPairHisto::getHRingAvChrgTheta(const Char_t * c,const Char_t *b)
{
    TString *s=0;
...
//--------------------------------
TH2F* HPairHisto::getHRingAvChrgLocMax4(const Char_t * c,const Char_t *b)
{
    TString *s=0;
...
TH2F* HPairHisto::getHRingAvChrgCentroid(const Char_t * c,const Char_t *b)
{
    TString *s=0;
...
TH2F* HPairHisto::getHRingAvChrgPatMat(const Char_t * c,const Char_t *b)
{
    TString *s=0;
...
TH2F* HPairHisto::getHRingAvChrgPadNr(const Char_t * c,const Char_t *b)
{
    TString *s=0;
...
TH2F* HPairHisto::getHRingLocMax4Centroid(const Char_t * c,const Char_t *b)
{
    TString *s=0;
...
TH2F* HPairHisto::getHRingLocMax4PatMat(const Char_t * c,const Char_t *b)
{
    TString *s=0;
...
TH2F* HPairHisto::getHRingLocMax4PadNr(const Char_t * c,const Char_t *b)
{
    TString *s=0;
...
TH2F* HPairHisto::getHRingCentroidPatMat(const Char_t * c,const Char_t *b)
{
    TString *s=0;
...
TH2F* HPairHisto::getHRingCentroidPadNr(const Char_t * c,const Char_t *b)
{
    TString *s=0;
...
TH2F* HPairHisto::getHRingPatMatPadNr(const Char_t * c,const Char_t *b)
{
    TString *s=0;
...
TH2F* HPairHisto::getHRingParIdWeight(const Char_t * c,const Char_t *b)
{
    TString *s=0;
...
TH2F* HPairHisto::getHWeightWeight(const Char_t * c,const Char_t *b)
{
    TString *s=0;
...
//----------------------------
TH1F* HPairHisto::getHParId(const Char_t * c,const Char_t *b)
{
    TString *s=0;
...
//----------------------------
TH1F* HPairHisto::getHMom(const Char_t * c,const Char_t *b)
{
    TString *s=0;
...
TH1F* HPairHisto::getHMomt(const Char_t * c,const Char_t *b)
{
    TString *s=0;
...
TH2F* HPairHisto::getHMomvsMom(const Char_t * c,const Char_t *b)
{
    TString *s=0;
...
TH2F* HPairHisto::getHMdcRvsMdcZ(const Char_t * c,const Char_t *b)
{
    TString *s=0;
...
TH2F* HPairHisto::getHMdcRvsMdcChi2(const Char_t * c,const Char_t *b)
{
    TString *s=0;
...
TH2F* HPairHisto::getHMomvsBeta(const Char_t * c,const Char_t *b)
{
    TString *s=0;
...
TH2F* HPairHisto::getHMomChrgvsBeta(const Char_t * c,const Char_t *b)
{
    TString *s=0;
...
TH2F* HPairHisto::getHMomvsEnergy(const Char_t * c,const Char_t *b)
{
    TString *s=0;
...
TH2F* HPairHisto::getHMomChrgvsEnergy(const Char_t * c,const Char_t *b)
{
    TString *s=0;
...
TH2F* HPairHisto::getHMassvsBeta(const Char_t * c,const Char_t *b)
{
    TString *s=0;
...
TH2F* HPairHisto::getHMassChrgvsBeta(const Char_t * c,const Char_t *b)
{
    TString *s=0;
...
TH1F* HPairHisto::getHMass(const Char_t * c,const Char_t *b)
{
    TString *s=0;
...
TH1F* HPairHisto::getHDeflAngle(const Char_t * c,const Char_t *b)
{
    TString *s=0;
...
TH2F* HPairHisto::getHDeflAnglevsMass(const Char_t * c,const Char_t *b)
{
    TString *s=0;
...
TH2F* HPairHisto::getHDeflAnglevsBeta(const Char_t * c,const Char_t *b)
{
    TString *s=0;
...
TH2F* HPairHisto::getHDeflAnglevsMom(const Char_t * c,const Char_t *b)
{
    TString *s=0;
...
//--------------------------------------------------------------------
TH1F* HPairHisto::getHMult(const Char_t * c,const Char_t *b)
{
    TString *s=0;
