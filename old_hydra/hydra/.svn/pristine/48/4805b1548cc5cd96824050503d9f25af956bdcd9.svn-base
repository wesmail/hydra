// File: hrichpaircreator.cc
//
// Author: Thomas Eberl <Thomas.Eberl@physik.tu-muenchen.de>
// Last update by Thomas Eberl: 02/05/10 14:30:15
//
...
//  	cout<<"track2: "<<h->getIndTrk2()<<" : "<<hj->getRichTheta()-hj->getMdcTheta()<<endl;
	...
	if(HRichCut::NbRingsPerMDCUNLIKEPair(h)==1 &&
	   !HRichCut::isOpangGreaterThan(h,6.)     &&
...
Int_t HRichPairCreator::fillRingPadNr(HDiHitMatch *h,Int_t *tup,Int_t max,Char_t* title)
{
	...
	if (h1) h1->Fill(track1->getRingPadNr());
    }
	...
	s.Append(title);
	TH1F* h1 = ((TH1F*)(pHistArray->FindObject(s.Data())));
	if (h1) h1->Fill(track2->getRingPadNr());
    }
    return ret_val;
}
...
Int_t HRichPairCreator::fillRingAmplitude(HDiHitMatch *h,Int_t *tup,Int_t max,Char_t* title)
{
	...
	s.Append(title);
	TH1F* h1 = ((TH1F*)(pHistArray->FindObject(s.Data())));
	if (h1) h1->Fill(track1->getRingAmplitude());
    }
	...
	s.Append(title);
	TH1F* h1 = ((TH1F*)(pHistArray->FindObject(s.Data())));
	if (h1) h1->Fill(track2->getRingAmplitude());
    }
    return ret_val;
}
...
Int_t HRichPairCreator::fillRingLocMax4(HDiHitMatch *h,Int_t *tup,Int_t max,Char_t* title)
{
	...
	s.Append(title);
	TH1F* h1 = ((TH1F*)(pHistArray->FindObject(s.Data())));
	if (h1) h1->Fill(track1->getRingLocalMax4());
    }
	...
	s.Append(title);
	TH1F* h1 = ((TH1F*)(pHistArray->FindObject(s.Data())));
	if (h1) h1->Fill(track2->getRingLocalMax4());
    }
    return ret_val;
}
...
Int_t HRichPairCreator::fillRingPM(HDiHitMatch *h,Int_t *tup,Int_t max,Char_t* title)
{
	...
	s.Append(title);
	TH1F* h1 = ((TH1F*)(pHistArray->FindObject(s.Data())));
	if (h1) h1->Fill(track1->getRingPatMat());
    }
	...
	s.Append(title);
	TH1F* h1 = ((TH1F*)(pHistArray->FindObject(s.Data())));
	if (h1) h1->Fill(track2->getRingPatMat());
    }
    return ret_val;
}
...
Int_t HRichPairCreator::fillRingHT(HDiHitMatch *h,Int_t *tup,Int_t max,Char_t* title)
{
	...
	s.Append(title);
	TH1F* h1 = ((TH1F*)(pHistArray->FindObject(s.Data())));
	if (h1) h1->Fill(track1->getRingHouTra());
    }
	...
	s.Append(title);
	TH1F* h1 = ((TH1F*)(pHistArray->FindObject(s.Data())));
	if (h1) h1->Fill(track2->getRingHouTra());
    }
    return ret_val;
}
