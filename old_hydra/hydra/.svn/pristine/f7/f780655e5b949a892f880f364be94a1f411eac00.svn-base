...
//*-- Version: $Id: hmatchushower.h,v 1.10 2005-10-16 02:11:42 wuestenf Exp $
...
public:
  ...
  ClassDef(HMatchUShower,1)   // Datacontainer holding all Matching unit information from SHOWERxs
};
