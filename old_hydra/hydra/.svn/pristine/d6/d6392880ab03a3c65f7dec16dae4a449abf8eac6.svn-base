// $Id: hpairevtfilter.h,v 1.1 2006-04-12 16:34:50 eberl Exp $
// Author: Thomas.Eberl@ph.tum.de, last modified : 2006-04-12 18:24:19
//
// --------------------------------------------------------------------------  
...
protected:
    ...
    ClassDef(HPairEvtFilter,0) //Event filter of the pair module
