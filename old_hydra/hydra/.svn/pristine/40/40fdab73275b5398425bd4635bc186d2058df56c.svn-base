// @(#)$Id: hpidgeanttrackset.h,v 1.7 2005-04-27 12:35:30 wojcik Exp $
...
public:
   ...
   enum
    ...
    Int_t           getGeantParentID(Int_t i=0) {return ParentIds[i];}
    Int_t           getGeantParentTrackID(Int_t i=0) {return Parents[i];}
