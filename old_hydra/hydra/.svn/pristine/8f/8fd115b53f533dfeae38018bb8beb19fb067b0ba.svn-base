...
public:
    HMdcTdcThreshold(const char* name="MdcTdcThreshold",
                  const char* title="threshold parameters for Mdc",
                  const char* context="MdcTdcThresholdProduction",
                  Int_t n=6);
    ~HMdcTdcThreshold();
    ...
    Bool_t write_thresholds(char*, Int_t, Int_t);
