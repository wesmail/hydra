...
protected:
  ...
  Char_t readOutSide;  // Side from which the wire is read out (first letter
                       ...
                       // ='0' for geant data and don't connected wires
...
protected:
  ...
  Double_t parA;            // Parameters of the MDC layer plane in sector
  Double_t parB;            // coor.sys.:  parA*x+parB*y+z=parD
  Double_t parD;            //
...
public:
  ...
  Bool_t setSecTrans(void);
  void getMdcPlanePar(Double_t& a,Double_t& b,Double_t& d) {
  ...
  Float_t getCatDist(void) const {return 2.*halfCatDist;}
  Float_t getHalfCatDist(void) const {return halfCatDist;}
  Float_t getPitch(void) const {return pitch;}
  Float_t getHalfPitch(void) const {return halfPitch;}
  Float_t getCosWireOr(void) const {return cosWireOr;}
  Float_t getSinWireOr(void) const {return sinWireOr;}
  Float_t getTanWireOr(void) const {return sinWireOr/cosWireOr;}
  Float_t getWireOffSet(void) const {return wireOffSet;}
  Int_t calcCellNum(Float_t x, Float_t y) const;
  ...
  inline Double_t getImpact(Double_t xP1,Double_t yP1,Double_t zP1,Double_t xP2,
  ...
  Bool_t getDriftDist(Double_t xP1,Double_t yP1,Double_t zP1,
      Double_t xP2, Double_t yP2, Double_t zP2,
      Int_t cell, Double_t &alphaDrDist, Double_t &driftDist);
  Float_t HMdcSizesCellsLayer::getXSign(Double_t xP1, Double_t yP1,
...
protected:
  ...
  Double_t tfSysRSec[12];
  Double_t parA;           // Parameters of the MDC plane in sector coor.sys.:
  Double_t parB;           // parA*x+parB*y+z=parD
  Double_t parD;           //
...
//----------------------- Inlines ------------------------------
void HMdcSizesCellsLayer::calcIntersection(Double_t x1,Double_t y1,Double_t z1,
      Double_t x2, Double_t y2, Double_t z2,
      Double_t& x, Double_t& y, Double_t& z) const {
...
void HMdcSizesCellsLayer::transTo(Double_t& x, Double_t& y, Double_t& z) const {
...
Double_t HMdcSizesCellsLayer::getDist(Double_t xP1,Double_t yP1,Double_t zP1,
    Double_t xP2, Double_t yP2, Double_t zP2, Int_t cell) {
...
void HMdcSizesCellsLayer::getYZinWireSys(Double_t x, Double_t y,
...
Double_t HMdcSizesCellsLayer::getDistToZero(Double_t y1,Double_t z1,
    Double_t y2, Double_t z2) {
...
Double_t HMdcSizesCellsLayer::getImpactToZero(Double_t y1,Double_t z1,
    Double_t y2, Double_t z2, Double_t &alpha) {
...
Double_t HMdcSizesCellsLayer::getImpact(Double_t xP1,Double_t yP1,Double_t zP1,
...
Bool_t HMdcSizesCellsLayer::getImpact(Double_t xP1,Double_t yP1,Double_t zP1,
    Double_t xP2, Double_t yP2, Double_t zP2, Int_t cell,
...
void HMdcSizesCellsMod::calcIntersection(Double_t x1, Double_t y1, Double_t z1,
      Double_t x2, Double_t y2, Double_t z2,
      Double_t& x, Double_t& y, Double_t& z) const {
...
void HMdcSizesCellsMod::transTo(Double_t& x, Double_t& y, Double_t& z) const {
...
void HMdcSizesCellsMod::transFrom(Double_t& x, Double_t& y, Double_t& z) const {
...
void HMdcSizesCellsMod::transFromZ0(Double_t& x,Double_t& y,Double_t& z) const {
...
void HMdcSizesCellsMod::transFromZ0(Float_t& x,Float_t& y,Float_t& z) const {
  // transform. point x,y on the mdc plane (z=0) from mdc coor.sys. 
  // to sector coor.sys.
  Double_t pmtx=x;
  Double_t pmty=y;
...
void HMdcSizesCellsMod::calcInterTrMod(Double_t x1, Double_t y1, Double_t z1,
      Double_t x2, Double_t y2, Double_t z2,
      Double_t& x, Double_t& y) const {
  Double_t dX=x2-x1;
  Double_t dY=y2-y1;
