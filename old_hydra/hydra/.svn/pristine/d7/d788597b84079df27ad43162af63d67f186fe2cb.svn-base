// $Id: hrichutilfunc.cc,v 1.20 2009-07-15 11:39:22 halo Exp $
...
Int_t HRichUtilFunc::isPi0DalitzLep(Int_t trk,HLinearCategory* cat, const Char_t *style)
{
...
Int_t HRichUtilFunc::isPi0DalitzLep(HGeantKine* kine,HLinearCategory* cat,const Char_t *style)
{
...
HParSet* HRichUtilFunc::getParamContainer(const Char_t * contname)
{
