...
public:
  ...
  // Shower histograms
  TH2F *shoHit_rowVsCol_m0;    //! showerHit: Mod 0, fired pads/event
  TH2F *shoHit_rowVsCol_m1;    //! showerHit: Mod 1, fired pads/event
  TH2F *shoHit_rowVsCol_m2;    //! showerHit: Mod 2, fired pads/event

  TH2F *shoHit_avgCharge_m0;   //! showerHit: Mod 0, average charge on loc. max.
  TH2F *shoHit_avgCharge_m1;   //! showerHit: Mod 1, average charge on loc. max.
  TH2F *shoHit_avgCharge_m2;   //! showerHit: Mod 2, average charge on loc. max.
