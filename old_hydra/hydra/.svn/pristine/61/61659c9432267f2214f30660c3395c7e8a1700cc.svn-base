...
//  virtual TClass *getClass(void)=0;
  ...
  virtual TObject *&getNewSlot(HLocation &aLoc,Int_t* pIndex=0)=0;
  virtual TObject *&getSlot(HLocation &aLoc,Int_t* pIndex=0)=0;
  virtual HDataObject *getObject(HLocation &aLoc)=0;
  virtual HDataObject *getObject(Int_t index) {return NULL;}
