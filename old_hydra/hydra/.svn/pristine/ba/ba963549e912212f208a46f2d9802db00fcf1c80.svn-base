...
public:
 ...
 // ---- general parameters ----
    ...
    TArrayF fExp1Nor;//coefficients of the 2 exponential functions used to describe the photon charge distribution
     TArrayF fExp1exp;
    TArrayF fExp2Nor;
    TArrayF fExp2exp;
...
public:
    ...
    Float_t * getExp1Nor() { return &fExp1Nor[0]; }
    Float_t * getExp1exp() { return &fExp1exp[0]; }
    Float_t * getExp2Nor() { return &fExp2Nor[0]; }
    Float_t * getExp2exp() { return &fExp2exp[0];}
