// @(#)$Id: hpidcandidate.h,v 1.1 2002-10-30 10:55:33 halo Exp $
...
public:
    ...
    HPidTrackCand*      getCandidate(HCategory *pCat = NULL);
...
HCategory* buildPidCandidateCategory(const char sClassName[]); // make the PidCandidate cat.
...
inline Int_t HPidCandidate::getValueIndex(UInt_t uiAlg, UInt_t uiPart) const
{
    ...
    {
        Error("getValueIndex", "Out of bounds");
        return -1;
    }
...
// Get vector for values for the specific algorithm INDEX
    ...
    {
        Error("getValuesVector", "Out of bounds");
        return NULL;
    }
