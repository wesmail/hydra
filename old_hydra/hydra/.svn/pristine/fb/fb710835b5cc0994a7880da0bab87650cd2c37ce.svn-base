...
class HDetSetOut : public TObject {
 ...
 public:
  ...
  ClassDef(HDetSetOut,0) // Output of the detector set "evaluation"
...
class HDetSet : public TNamed {
 ...
 public:
  ...
  ClassDef(HDetSet,1) // Detector set class
...
class HShowerDetSet : public HDetSet {
 ...
 public:
  ...
  ClassDef(HShowerDetSet,1) // Shower detector set
...
class HMdcDetSet : public HDetSet {
 ...
 public:
  ...
  ClassDef(HMdcDetSet,1) //MDC detector set
...
class HTofDetSet : public HDetSet {
 ...
 public:
  ...
  ClassDef(HTofDetSet,1) // TOF detector set
...
class HRichDetSet : public HDetSet {
 ...
 public:
  ...
  ClassDef(HRichDetSet,1) //RICH detector set
