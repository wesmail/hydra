...
void HMdcDigitizer::printStatus()
{
    ...
    printf ("--------------------------------------------------------------------------------------------\n");
    printf ("HMdcDigiSetup:\n");
    printf ("tdcModeDigi       =  %i :  1 = two leading edges, 2 = leading and trailing edge\n",getTdcMode());
    printf ("NtupleDigi        =  %i :  0 = noNtuple, 1 = digitizer.root\n",                    (Int_t)getNTuple());
    printf ("useTofDigi        =  %i :  0 = NoTof in cal1, 1 = Tof in cal1 \n\n",               (Int_t)getTofUse());
    printf ("useErrorDigi      =  %i :  0 = NoErr in cal1, 1 = Err in cal1 \n\n",               (Int_t)getErrorUse());
    printf ("useWireOffset     =  %i :  1 = add wireOffset to drift time, 0 = don't add wireOffsets \n",(Int_t)getWireOffsetUse());
