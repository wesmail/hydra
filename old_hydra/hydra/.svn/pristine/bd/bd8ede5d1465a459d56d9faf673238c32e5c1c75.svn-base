...
protected:
  ...
  HCategory* muemuCat;     //!< pointer to the matchu category (muleptons)
  HCategory* richCatHit;    //!< pointer to the rich hit category
  ...
  HIterator* itermuemu;    //!< iterator
  HIterator* iterrichhit;   //!< iterator
