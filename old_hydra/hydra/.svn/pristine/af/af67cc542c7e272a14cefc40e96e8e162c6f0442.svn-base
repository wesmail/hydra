...
// Last update by Thomas Eberl: 02/03/27 15:43:44
//
#ifndef HHITMATCH_H
#define HHITMATCH_H
...
protected:
    ...
    Int_t   fClusterNWires; // number of contributing wires to segment
    Int_t   fClusterNMerged; // number of merged clusters in cluster 
...
virtual HHitMatch& operator=(const HHitMatch& source);
    ...
    void setMdcClusterNWires(Int_t nw){fClusterNWires=nw;};
    void setMdcClusterNMerged(Int_t mc){fClusterNMerged=mc;};
    ...
    Int_t  getMdcClusterNWires(void){return fClusterNWires;};
    Int_t  getMdcClusterNMerged(void){return fClusterNMerged;};
