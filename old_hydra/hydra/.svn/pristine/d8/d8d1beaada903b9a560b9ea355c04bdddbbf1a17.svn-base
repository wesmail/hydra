...
HMdcIdealTracking::HMdcIdealTracking(Text_t *name,Text_t *title) : 
...
Bool_t HMdcIdealTracking::init(void) {
  ...
  pGeantKineCat = gHades->getCurrentEvent()->getCategory(catGeantKine);
  if(pGeantKineCat == 0) {
  ...
  pMdcCal1Cat=HMdcGetContainers::getCatMdcCal1();
  if(pMdcCal1Cat) {
