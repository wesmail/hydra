...
const Cat_t catShowerGeantRaw=197;    // RICH needs 2 categories, skip 1 !
const Cat_t catTofGeantRaw=198;
const Cat_t catStartGeantRaw=199;
const Cat_t catCaloGeantRaw=200;
