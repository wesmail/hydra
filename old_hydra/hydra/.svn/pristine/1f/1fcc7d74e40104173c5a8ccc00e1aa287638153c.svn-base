...
// Cut for drift time:
 Float_t cutTime1L=0.;
 Float_t cutTime1R=0.;//200.;
 Float_t cutTime2L=0.;
 Float_t cutTime2R=0.;//200.;
 Float_t cutLeft=0.;//20.;       // cutLeft < driftTime1-driftTime2 < cutRight
 Float_t cutRight=0.;//200.;      // If cutLeft=cutRight=0. the cut will be ignore
//====================================================================
...
void printClusters(){
 for(Int_t sec=0; sec<6; sec++) {
  if(indMod[sec][0]+indMod[sec][1])  mdcEff->printClusters(sec);
 }
}
