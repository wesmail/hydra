...
Bool_t HTofHistAction::importFromFile(const Char_t *filename) {

//-------------------------------------------------------------------
//
//                 importFromFile(Char_t *filename)
//
...
Int_t HTofHistAction::getNextTrueIndex() {
...
// to avoid Double_t deleting of the same object.
...
// Process mouse Double_t clicking in file view container
