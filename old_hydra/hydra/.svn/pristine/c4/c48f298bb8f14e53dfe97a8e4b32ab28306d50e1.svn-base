...
public:
    ...
    static HMdcSizesCellsCell* getObject(Int_t sc,Int_t md,Int_t lr,Int_t cl);
    static HMdcSizesCellsCell* getExObject(Int_t sc,Int_t md,Int_t lr,Int_t cl);
...
public:
    ...
    Bool_t isSet(void) {return set;}
    
    ClassDef(HMdcCalcSizesCells,0)
};
