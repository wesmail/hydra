...
// --- Zero all histogram pointers
  ...
  //---- Shower histograms
  shoHit_rowVsCol_m0 = 0;
  shoHit_rowVsCol_m1 = 0;
  shoHit_rowVsCol_m2 = 0;

  shoHit_avgCharge_m0 = 0;
  shoHit_avgCharge_m1 = 0;
  shoHit_avgCharge_m2 = 0;
...
void HQAHistograms::bookHistShower() {
  ...
  shoHit_rowVsCol_m0 = new TH2F("shoHit_rowVsCol_m0" ,"showerHit: Mod 0, fired pads/event",32,0,32,32,0,32);
  shoHit_rowVsCol_m0->SetXTitle("row");
  shoHit_rowVsCol_m0->SetYTitle("column");
  histList->Add(shoHit_rowVsCol_m0,"shower--logz");

  shoHit_rowVsCol_m1 = new TH2F("shoHit_rowVsCol_m1" ,"showerHit: Mod 1, fired pads/event",32,0,32,32,0,32);
  shoHit_rowVsCol_m1->SetXTitle("row");
  shoHit_rowVsCol_m1->SetYTitle("column");
  histList->Add(shoHit_rowVsCol_m1,"shower--logz");

  shoHit_rowVsCol_m2 = new TH2F("shoHit_rowVsCol_m2" ,"showerHit: Mod 2, fired pads/event",32,0,32,32,0,32);
  shoHit_rowVsCol_m2->SetXTitle("row");
  shoHit_rowVsCol_m2->SetYTitle("column");
  histList->Add(shoHit_rowVsCol_m2,"shower--logz");

  shoHit_avgCharge_m0 = new TH2F("shoHit_avgCharge_m0" ,"showerHit: Mod 0, average charge on loc. max.",32,0,32,32,0,32);
  shoHit_avgCharge_m0->SetXTitle("row");
  shoHit_avgCharge_m0->SetYTitle("column");
  histList->Add(shoHit_avgCharge_m0,"shower--logz");

  shoHit_avgCharge_m1 = new TH2F("shoHit_avgCharge_m1" ,"showerHit: Mod 1, average charge on loc. max.",32,0,32,32,0,32);
  shoHit_avgCharge_m1->SetXTitle("row");
  shoHit_avgCharge_m1->SetYTitle("column");
  histList->Add(shoHit_avgCharge_m1,"shower--logz");

  shoHit_avgCharge_m2 = new TH2F("shoHit_avgCharge_m2" ,"showerHit: Mod 2, average charge on loc. max.",32,0,32,32,0,32);
  shoHit_avgCharge_m2->SetXTitle("row");
  shoHit_avgCharge_m2->SetYTitle("column");
  histList->Add(shoHit_avgCharge_m2,"shower--logz");

  //shoHit = new TH2F("showSum1" ,"Average Sum around Loc. max. mod1 ",32,0,32,32,0,32);
  //shoHit = new TH2F("showLMFreq1" ,"Fire Frequency per entries  mod1 ",32,0,32,32,0,32);
