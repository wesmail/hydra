...
//     xl = cos(fSectors[i].getPhi())*x - sin(fSectors[i].getPhi())*y;
//     yl = sin(fSectors[i].getPhi())*x + cos(fSectors[i].getPhi())*y;
...
//     x = xl;
     ...
     // xl += fSectors[i].getSectorShift(1);
     // yl += fSectors[i].getSectorShift(0);
     // zl += fSectors[i].getSectorShift(2);
