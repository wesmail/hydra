...
public:
   ...
   inline HMetaMatch& operator=(HMetaMatch& met);
      void setTofCl(Short_t cl) {isTofCluster=cl;} 
   ...
   void setTofHitInd(const Short_t tof) {tofHitInd=tof;}
    void setTofClusterSize(const Char_t clsz) {tofClusterSize=clsz;}
   ...
   Short_t getTofCl() const {return isTofCluster;}
   ...
   ClassDef(HMetaMatch,3)
};

inline HMetaMatch& HMetaMatch::operator=(HMetaMatch& met)
{
