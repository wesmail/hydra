// @(#)root/test:$Name: not supported by cvs2svn $:$Id: hhistory.cxx,v 1.3 2004-04-04 20:06:12 sadovski Exp $
...
private:
   ...
   TGCompositeFrame *fF4btn1, *fF4btn2;
      ...
      : TGMainFrame(p, w, h)
{
   ...
   fTxt3->Resize(120, fTxt3->GetDefaultHeight());
