...
protected:
   ...
   typedef struct {
    ...
    static Bool_t kIgnoreRICH;             //! switch to ignore RICH hits for double hit counting
    static Bool_t kIgnoreInnerMDC;         //! switch to ignore InnerMDC hits for double hit counting
    static Bool_t kIgnoreOuterMDC;         //! switch to ignore OuterMDC hits for double hit counting
    static Bool_t kIgnoreMETA;             //! switch to ignore META hits for double hit counting
    ...
    Bool_t kIgnoreRICHBackup;             //! switch to ignore RICH hits for double hit counting
    Bool_t kIgnoreInnerMDCBackup;         //! switch to ignore InnerMDC hits for double hit counting
    Bool_t kIgnoreOuterMDCBackup;         //! switch to ignore OuterMDC hits for double hit counting
    Bool_t kIgnoreMETABackup;             //! switch to ignore META hits for double hit counting
