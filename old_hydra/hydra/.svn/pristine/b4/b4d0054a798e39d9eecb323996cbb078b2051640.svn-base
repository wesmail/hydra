...
class HPidPDFBuilderExp : public HReconstructor 
{
 public:
  ...
  // default settings: 
  HPidPDFBuilderExp(const Char_t* Extension = "",const Char_t* OutputFile = "CandidateProperties");
  ~HPidPDFBuilderExp();
