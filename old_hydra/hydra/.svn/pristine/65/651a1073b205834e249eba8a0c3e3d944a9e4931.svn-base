// $Id: hrichcorrelatorsim.cc,v 1.21 2008-05-09 16:16:32 halo Exp $
...
HRichCorrelatorSim::HRichCorrelatorSim(Text_t *name,Text_t *title, Char_t* filename, Bool_t style) :
