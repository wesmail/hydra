...
#ifndef HHYP_HARDCUTSTOFINOdEdX_H
#define HHYP_HARDCUTSTOFINOdEdX_H
...
class HHypHardCutsTOFINOdEdXAlg:public HHypBaseAlgorithm
{
...
//    HPidAlgHardCutsTOFINOdEdXPar  *pidParams2; //hard cut par container for hadrons
...
public:
  ...
  HHypHardCutsTOFINOdEdXAlg(Char_t *name_i = NULL, Option_t par[] = NULL);

  virtual ~ HHypHardCutsTOFINOdEdXAlg(void);
  ...
  ClassDef(HHypHardCutsTOFINOdEdXAlg, 0)  //Hard (banana) cuts, lepton hard cut
};
