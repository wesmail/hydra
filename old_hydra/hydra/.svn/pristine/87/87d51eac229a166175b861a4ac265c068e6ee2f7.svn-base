...
if(counter >= 460) {
  ...
  continue;
      ...
      clus=(isGeant) ? (HMdcClus*)(new(clus) HMdcClusSim) : new(clus) HMdcClus;
  ...
  while(nClusters>1) {
    ...
    if(nomerg || nClusters==1) break;
  }
  for(Int_t loc2c1=counter-1; loc2c1>loc2FirstCl; loc2c1--) {
    locClus[2]=loc2c1;
    HMdcClus* clus1=(HMdcClus*)fClusCat->getObject(locClus);
    if(clus1->getStatus()) break;
    counter--;
  }
