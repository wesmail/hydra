// $Id: hrichrecalibrater.cc,v 1.4 2008-05-09 16:16:33 halo Exp $
...
HRichReCalibrater::HRichReCalibrater(Text_t *name, Text_t *title,Char_t * 
				       path ,Char_t * pString,Float_t fNoiseThr): HReconstructor(name,title) {    
