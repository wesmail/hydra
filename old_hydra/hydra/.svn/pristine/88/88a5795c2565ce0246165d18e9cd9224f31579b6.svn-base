...
TGo4ShowerOnlineStatus::TGo4ShowerOnlineStatus(Text_t *Name, Text_t * Title)
			:TGo4Status(Name)
{
	...
	TGo4ShowerOnlineStatus::~TGo4ShowerOnlineStatus()
{

}
void TGo4ShowerOnlineStatus::OverWriteLocalObject(TNamed * fxData_Local)
{
...
TObjArray *TGo4ShowerOnlineStatus::GetLocalListStatus()
{
  	TGo4LockGuard Global;	
  	return(LocalListContent);
}

TObject* TGo4ShowerOnlineStatus::GetObjectfromLocalList(const char *Object)
{
  	TGo4LockGuard Global;
  	return(LocalListContent->FindObject(Object));
	
}
ClassImp(TGo4ShowerOnlineStatus)
