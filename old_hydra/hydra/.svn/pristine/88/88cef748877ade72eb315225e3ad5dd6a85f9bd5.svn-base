...
Bool_t HShowerHitFPar::writeAscii(HParHadAsciiFileIo* pHadAsciiFile)
{
  ...
  nSectors = mydata.WriteInt("sectors", nSectors); 
  nModules = mydata.WriteInt("modules", nModules); 
  nThreshold = mydata.WriteInt("threshold", nThreshold); 
