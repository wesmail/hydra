...
CXXFLAGS += -DUSEORA -I$(ADSM_BASE)/Linux \
		-I$(HADDIR_HYP)
...
all:  $(MAIN).cc
	...
	-L$(HADDIR_BASE_LIB) -lRFIOtsm \
	-o fillHypDst

fillHypDst_h: fillHypDst_h.cc
	$(CXX) fillHypDst_h.cc $(CXXFLAGS) -c -o fillHypDst_h.o
	$(LD) fillHypDst_h.o -Wl,-rpath,$(RPATH)\
	 -L.  \
	-L$(HADDIR_HYP_LIB) -lHyp \
	-L$(HADDIR_MDCTRACKD_LIB) -lMdcTrackD \
	-L$(HADDIR_MDC_LIB) -lMdc \
