...
// $Id: hmetaaligner.cc,v 1.1 2001-11-29 03:53:50 jaskula Exp $
...
const static char *g_sapMetaAlignerParamsNames[kMETA_ALIGNER_PARAMS]
                        = { "dX", "dY", "dZ", "rotX", "rotY", "rotZ" };
const static char *g_sapMinuitMethods[]
...
HMetaAligner::HMetaAligner(const char *pFileName, Int_t iSector, Int_t iSystem,
                            const char *pParamFile, Int_t iRunId)
                        : TObject()
{
...
Bool_t HMetaAligner::loadParameters(const char *pParamFileName, Int_t iRunId)
{
...
Bool_t HMetaAligner::getShowerGeom(const char *pParamFile, Int_t iRunId)
{
...
Bool_t HMetaAligner::getTofGeom(const char *pParamFile, Int_t iRunId)
{
...
HTofGeomPar     *pTofGeom;
    ...
    if((pTofGeom = (HTofGeomPar *)m_pRTDB->getContainer("TofGeomPar"))
                        == NULL)
    {
        pTofGeom = (HTofGeomPar *)gHades->getSetup()
                        ->createDetGeomPar("Tof");
    }
...
Bool_t HMetaAligner::openNTuple(const char *pFileName)
{
...
Bool_t HMetaAligner::runFit(Bool_t bUseTukay, const char *pOut, Int_t iMethod)
{
...
Int_t           iVP, iNP;
    ...
    if((m_iMethod < 0)
        || (m_iMethod >= (Int_t)(sizeof(g_sapMinuitMethods) / sizeof(char *))))
    {
...
Bool_t HMetaAligner::contFit(Bool_t bUseTukay, const char *pOut, Int_t iMethod)
{
...
void HMetaAligner::print(const char *pFileName) const
{
...
void HMetaAligner::printLine(const char *pFileName) const
{
...
void HMetaAligner::printHtmlRow(const char *pFileName) const
{
...
void HMetaAligner::writeResults(const char *pFileName)
{
