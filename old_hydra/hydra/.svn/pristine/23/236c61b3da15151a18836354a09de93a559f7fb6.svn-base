...
public:
    ...
    Short_t *xBinMin;
    Short_t *xBinMax;
    Short_t getYBinMin(){return yBinMin;}
    Short_t getYBinMax(){return yBinMax;}
    HMdcLookUpTbCell(Short_t yBinMinT, Short_t yBinMaxT);
    ~HMdcLookUpTbCell();
    void addLine(Short_t nc1, Short_t nc2);
...
class HMdcLookUpTb : public HParSet {
  protected: 
    ...
    Bool_t isContainer;
  public:
    HMdcLookUpTb(Int_t nBinX=319, Bool_t isCoilOff=kFALSE);
    ~HMdcLookUpTb();
