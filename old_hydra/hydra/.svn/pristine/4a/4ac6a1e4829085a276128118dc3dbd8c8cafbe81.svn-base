  ...
  while(fConstTukey>0.4){
	...
	if(fabs(t)<fConstTukey && accepted){
	  ...
	  */
	  ...
	  if(fConstTukey<4.1 && fConstTukey>0.9 && iternum==2){
	    ...
	    fTarTuk[(Int_t)fConstTukey-1]->Fill(ztar);
	    fTarTukW[(Int_t)fConstTukey-1]->Fill(ztar,weigth);
	    ...
	    fDisCTuk[(Int_t)fConstTukey-1]->Fill(x,y,z);
