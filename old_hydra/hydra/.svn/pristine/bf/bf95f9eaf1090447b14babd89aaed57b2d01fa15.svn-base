...
HMonHistAddon::HMonHistAddon (const char* name   ="",
			      const char* title  ="",
...
void HMonHistAddon::draw(Bool_t allowHiddenZero=1){Error("HMonHistAddon::draw()" ,"virtual function called!");}
void HMonHistAddon::reset(Int_t level,Int_t count){Error("HMonHistAddon::reset()","virtual function called!");}
void HMonHistAddon::add(HMonHistAddon*)           {Error("HMonHistAddon::add()"  ,"virtual function called!");}
TH1* HMonHistAddon::getP(Int_t s=0,Int_t m=0)     {Error("HMonHistAddon::getP()" ,"virtual function called!"); return(0);}
...
HMonHist::HMonHist(const char* name   ="",
		   const char* title  ="",
		   Int_t active=0,Int_t resetable=0,
		   Int_t nbinsX=0,Float_t xlo=0,Float_t xup=0)
...
void HMonHist::draw(Bool_t allowHiddenZero=1)
{
    h->Draw();
}
...
HMonHist2::HMonHist2(const char* name   ="",
			   const char* title  ="",
			   Int_t active=0,Int_t resetable=0,
			   Int_t nbinsX=0,Float_t xlo=0,Float_t xup=0,
			   Int_t nbinsY=0,Float_t ylo=0,Float_t yup=0)
...
void HMonHist2::draw(Bool_t allowHiddenZero=1)
{
    h->Draw();
}
