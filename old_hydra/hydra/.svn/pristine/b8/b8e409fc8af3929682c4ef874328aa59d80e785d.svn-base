...
int fillHypDst(void)
{
  ...
  {
    cout << "Here is put some \"standard\" HPidTrackCleaner, you should modify this to YOUR needs!"<<endl;
#warning "Here is put some \"standard\" HPidTrackCleaner, you should modify this to YOUR needs!"
