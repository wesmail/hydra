...
int pidLepExp(TString inFile, Int_t nEvents=0, Int_t startEvt=0)
{
  // real or simulation
  char *context="real"; 

  // parameter files
  TString paramFile1="/d/hades/jacek/hydra_dev/params/pidParams_HardCuts_Nov02_KICK.root";
  TString paramFile2="/d/hades/jacek/hydra_dev/params/pidParams_HardCuts_Nov02_KICK.root";

  // input and output data files
  TString inDir   = "/d/hades08/data/nov02_lep/exp/kick/lvl2/";
