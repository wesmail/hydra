 ...
 * 
 * $Id: hdstproduction.cc,v 1.19 2007-02-13 10:46:31 slang Exp $
 *
 */
...
void HDstProduction::setupRootInput()
{
   ...
   while ((filename = (TObjString*)file->Next()))
   {
	 ...
	 while ((filename = (TObjString*)local_file->Next()))
	 {
	    ...
	    {
	       Error( "setupRootInput", "Broken/invalid .root input file!" );
	       terminate( 2 );
	    }
	    delete root_file;
	    ...
	    {
	       Error( "setupRootInput", "Adding input file failed!" );
	       terminate( 2 );
	    }
	 }
	 delete local_files;
