...
Bool_t HShowerHitFinder::initParameters() {
	...
	HShowerGeometry *pGeom =((HShowerGeomPar*)rtdb->
			             getContainer("ShowerGeomPar"))->pOldGeom;
	if (!pGeom) {
		pGeom =  (HShowerGeometry*)rtdb->
				getContainer("ShowerGeometry");
		((HShowerGeomPar*)rtdb->getContainer("ShowerGeomPar"))->pOldGeom=pGeom;
	}
		setGeometry(pGeom);
