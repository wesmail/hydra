// $Id: hpairdata.cc,v 1.10 2005-11-18 14:13:52 sudol Exp $
...
Bool_t HPairData::init(HPair* p)
{
    ...
    IOm_chi2_1 = pTrackData1->qIOMatching[p1->getMomAlg()];
    IOm_chi2_2 = pTrackData1->qIOMatching[p2->getMomAlg()];
