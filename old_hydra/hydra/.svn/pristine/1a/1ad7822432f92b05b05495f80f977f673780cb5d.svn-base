...
//======================================
 ...
 HHypMultiChannelFiller::HHypMultiChannelFiller(Text_t *inputDir, Text_t *inputFileName):
...
void HHypMultiChannelFiller::printMatrix (FILE* otp, Char_t* name, Int_t nLin, Int_t nCol, Double_t *P)
 {Int_t i,j,n;
  fprintf (otp,"%s (%i,%i)\n",name,nLin,nCol);
  for (i = 0; i < nLin; i++)
   {for (j = 0; j < nCol; j++)
