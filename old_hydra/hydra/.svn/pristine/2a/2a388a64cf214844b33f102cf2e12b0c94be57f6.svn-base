...
class HPidTofRec : public HReconstructor {
 ...
 protected:
  ...
  Bool_t bTrackAlg[nMomAlgs];      // Switch ON Tracking algorythms
 ...
 public:    
  ...
  void setQualityRichParams(Float_t RingPatMat, Float_t RingPadNr, Float_t Centroid, Float_t RingAmplitude) {
    ...
    fRichQparams[3] = RingAmplitude;
  }
  void setOutputDir(char *fdir) {sDir = fdir;}
  void setOutputFile(char *ffile) {sFile = ffile;}
